...
/**
 * Implementation of {@link org.cdao.jasper.ContinuousCharacter}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#ContinuousCharacter)</p>
 * <br>
 */
public class ContinuousCharacterImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.ContinuousCharacter {
	...
	private java.util.ArrayList has__Datum_asContinuousStateDatum;
	...
	ContinuousCharacterImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static ContinuousCharacterImpl getContinuousCharacter(Resource resource, Model model) throws JastorException {
		return new ContinuousCharacterImpl(resource, model);
	}
	    
	static ContinuousCharacterImpl createContinuousCharacter(Resource resource, Model model) throws JastorException { 
		ContinuousCharacterImpl impl = new ContinuousCharacterImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, ContinuousCharacter.TYPE)))
			impl._model.add(impl._resource, RDF.type, ContinuousCharacter.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.ContinuousCharacter.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		has__Datum = null;
		has__Datum_asContinuousStateDatum = null;
		belongs__to = null;
	...
	private void initBelongs__to__Character__State__Data__Matrix() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Character_State_Data_Matrix properties in ContinuousCharacter model not a Resource", stmt.getObject());
	...
	private void initHas__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Datum properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Datum_asContinuousStateDatum() throws JastorException {
		this.has__Datum_asContinuousStateDatum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__DatumProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Datum properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.ContinuousStateDatum.TYPE)) {
				org.cdao.jasper.ContinuousStateDatum has__Datum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
				this.has__Datum_asContinuousStateDatum.add(has__Datum);
			}
		}
	}

	public java.util.Iterator getHas__Datum_asContinuousStateDatum() throws JastorException {
		if (has__Datum_asContinuousStateDatum == null)
			initHas__Datum_asContinuousStateDatum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Datum_asContinuousStateDatum,_resource,has__DatumProperty,true);
	}

	public void addHas__Datum(org.cdao.jasper.ContinuousStateDatum has__Datum) throws JastorException {
		if (this.has__Datum_asContinuousStateDatum == null)
			initHas__Datum_asContinuousStateDatum();
		if (this.has__Datum_asContinuousStateDatum.contains(has__Datum)) {
			this.has__Datum_asContinuousStateDatum.remove(has__Datum);
			this.has__Datum_asContinuousStateDatum.add(has__Datum);
			return;
		}
		this.has__Datum_asContinuousStateDatum.add(has__Datum);
	...
	public org.cdao.jasper.ContinuousStateDatum addHas__Datum_asContinuousStateDatum() throws JastorException {
		org.cdao.jasper.ContinuousStateDatum has__Datum = org.cdao.jasper.CDAOFactory.createContinuousStateDatum(_model.createResource(),_model);
		if (this.has__Datum_asContinuousStateDatum == null)
			initHas__Datum_asContinuousStateDatum();
		this.has__Datum_asContinuousStateDatum.add(has__Datum);
		_model.add(_model.createStatement(_resource,has__DatumProperty,has__Datum.resource()));
	...
	public org.cdao.jasper.ContinuousStateDatum addHas__Datum_asContinuousStateDatum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.ContinuousStateDatum has__Datum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
		if (this.has__Datum_asContinuousStateDatum == null)
			initHas__Datum_asContinuousStateDatum();
		if (this.has__Datum_asContinuousStateDatum.contains(has__Datum))
	...
	public void removeHas__Datum(org.cdao.jasper.ContinuousStateDatum has__Datum) throws JastorException {
		if (this.has__Datum_asContinuousStateDatum == null)
			initHas__Datum_asContinuousStateDatum();
		if (!this.has__Datum_asContinuousStateDatum.contains(has__Datum))
			return;
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in ContinuousCharacter model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in ContinuousCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in ContinuousCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in ContinuousCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in ContinuousCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in ContinuousCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in ContinuousCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Continuous__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Continuous_Datum properties in ContinuousCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof ContinuousCharacterListener))
			throw new IllegalArgumentException("ThingListener must be instance of ContinuousCharacterListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((ContinuousCharacterListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__DatumAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Datum);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.ContinuousStateDatum.TYPE)) {
					org.cdao.jasper.ContinuousStateDatum _has__Datum_asContinuousStateDatum = null;
					try {
						_has__Datum_asContinuousStateDatum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Datum_asContinuousStateDatum == null) {
					...
					if (!has__Datum_asContinuousStateDatum.contains(_has__Datum_asContinuousStateDatum))
						has__Datum_asContinuousStateDatum.add(_has__Datum_asContinuousStateDatum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Datum_asContinuousStateDatum;
						synchronized (listeners) {
							consumersForHas__Datum_asContinuousStateDatum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Datum_asContinuousStateDatum.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__DatumAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Datum_asContinuousStateDatum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.ContinuousCharacterImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.hasAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_exclude);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Continuous__Datum.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__Continuous__DatumAdded(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Continuous__Datum);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(belongs__to__Character__State__Data__MatrixProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Datum);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.ContinuousStateDatum.TYPE)) {
					...
					if (has__Datum_asContinuousStateDatum != null) {
						boolean found = false;
						for (int i=0;i<has__Datum_asContinuousStateDatum.size();i++) {
							org.cdao.jasper.ContinuousStateDatum __item = (org.cdao.jasper.ContinuousStateDatum) has__Datum_asContinuousStateDatum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Datum_asContinuousStateDatum = __item;
								break;
							}
						}
						if (found)
							has__Datum_asContinuousStateDatum.remove(_has__Datum_asContinuousStateDatum);
						else {
							try {
								_has__Datum_asContinuousStateDatum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum_asContinuousStateDatum.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Datum_asContinuousStateDatum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Continuous__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Continuous__Datum.iterator();iter.hasNext();){
							ContinuousCharacterListener listener=(ContinuousCharacterListener)iter.next();
							listener.has__Continuous__DatumRemoved(org.cdao.jasper.ContinuousCharacterImpl.this,_has__Continuous__Datum);
						}
					}
				}
				return;
