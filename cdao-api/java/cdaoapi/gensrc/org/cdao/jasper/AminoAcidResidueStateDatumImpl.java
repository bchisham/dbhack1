...
/**
 * Implementation of {@link org.cdao.jasper.AminoAcidResidueStateDatum}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#AminoAcidResidueStateDatum)</p>
 * <br>
 */
public class AminoAcidResidueStateDatumImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.AminoAcidResidueStateDatum {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Amino__Acid__StateProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Amino_Acid_State");
	private java.util.ArrayList has__Amino__Acid__State_asAminoAcidResidue;
	private java.util.ArrayList has__Amino__Acid__State_asGeneric__State;
	private static com.hp.hpl.jena.rdf.model.Property belongs__to__Amino__Acid__CharacterProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Amino_Acid_Character");
	private org.cdao.jasper.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character;
 

	AminoAcidResidueStateDatumImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static AminoAcidResidueStateDatumImpl getAminoAcidResidueStateDatum(Resource resource, Model model) throws JastorException {
		return new AminoAcidResidueStateDatumImpl(resource, model);
	}
	    
	static AminoAcidResidueStateDatumImpl createAminoAcidResidueStateDatum(Resource resource, Model model) throws JastorException { 
		AminoAcidResidueStateDatumImpl impl = new AminoAcidResidueStateDatumImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, AminoAcidResidueStateDatum.TYPE)))
			impl._model.add(impl._resource, RDF.type, AminoAcidResidueStateDatum.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__Amino__Acid__StateProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,belongs__to__Amino__Acid__CharacterProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.AminoAcidResidueStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		precedes = null;
		exclude = null;
		has__Amino__Acid__State_asAminoAcidResidue = null;
		has__Amino__Acid__State_asGeneric__State = null;
		belongs__to__Amino__Acid__Character = null;
	}
	...
	public org.cdao.jasper.Character getBelongs__to__Character() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Character getProperty() in org.cdao.AminoAcidResidueStateDatum model not Resource", stmt.getObject());
	...
	private void initHomologous__to() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#homologous_to properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__State() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_State properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Coordinate() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Coordinate properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jasper.TU getBelongs__to__TU() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__TU getProperty() in org.cdao.AminoAcidResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Amino__Acid__State_asAminoAcidResidue() throws JastorException {
		this.has__Amino__Acid__State_asAminoAcidResidue = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Amino__Acid__StateProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Amino_Acid_State properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.AminoAcidResidue.TYPE)) {
				org.cdao.jasper.AminoAcidResidue has__Amino__Acid__State = org.cdao.jasper.CDAOFactory.getAminoAcidResidue(resource,_model);
				this.has__Amino__Acid__State_asAminoAcidResidue.add(has__Amino__Acid__State);
			}
		}
	}

	public java.util.Iterator getHas__Amino__Acid__State_asAminoAcidResidue() throws JastorException {
		if (has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Amino__Acid__State_asAminoAcidResidue,_resource,has__Amino__Acid__StateProperty,true);
	}

	public void addHas__Amino__Acid__State(org.cdao.jasper.AminoAcidResidue has__Amino__Acid__State) throws JastorException {
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		if (this.has__Amino__Acid__State_asAminoAcidResidue.contains(has__Amino__Acid__State)) {
			this.has__Amino__Acid__State_asAminoAcidResidue.remove(has__Amino__Acid__State);
			this.has__Amino__Acid__State_asAminoAcidResidue.add(has__Amino__Acid__State);
			return;
		}
		this.has__Amino__Acid__State_asAminoAcidResidue.add(has__Amino__Acid__State);
		_model.add(_model.createStatement(_resource,has__Amino__Acid__StateProperty,has__Amino__Acid__State.resource()));
	}
	
	public org.cdao.jasper.AminoAcidResidue addHas__Amino__Acid__State_asAminoAcidResidue() throws JastorException {
		org.cdao.jasper.AminoAcidResidue has__Amino__Acid__State = org.cdao.jasper.CDAOFactory.createAminoAcidResidue(_model.createResource(),_model);
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		this.has__Amino__Acid__State_asAminoAcidResidue.add(has__Amino__Acid__State);
		_model.add(_model.createStatement(_resource,has__Amino__Acid__StateProperty,has__Amino__Acid__State.resource()));
		return has__Amino__Acid__State;
	}
	
	public org.cdao.jasper.AminoAcidResidue addHas__Amino__Acid__State_asAminoAcidResidue(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.AminoAcidResidue has__Amino__Acid__State = org.cdao.jasper.CDAOFactory.getAminoAcidResidue(resource,_model);
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		if (this.has__Amino__Acid__State_asAminoAcidResidue.contains(has__Amino__Acid__State))
	...
	public void removeHas__Amino__Acid__State(org.cdao.jasper.AminoAcidResidue has__Amino__Acid__State) throws JastorException {
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		if (!this.has__Amino__Acid__State_asAminoAcidResidue.contains(has__Amino__Acid__State))
			return;
		if (!_model.contains(_resource, has__Amino__Acid__StateProperty, has__Amino__Acid__State.resource()))
			return;
		this.has__Amino__Acid__State_asAminoAcidResidue.remove(has__Amino__Acid__State);
		_model.removeAll(_resource, has__Amino__Acid__StateProperty, has__Amino__Acid__State.resource());
	}
		
	private void initHas__Amino__Acid__State_asGeneric__State() throws JastorException {
		this.has__Amino__Acid__State_asGeneric__State = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Amino__Acid__StateProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Generic__State.TYPE)) {
				org.cdao.jasper.Generic__State has__Amino__Acid__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
				this.has__Amino__Acid__State_asGeneric__State.add(has__Amino__Acid__State);
			}
		}
	}

	public java.util.Iterator getHas__Amino__Acid__State_asGeneric__State() throws JastorException {
		if (has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Amino__Acid__State_asGeneric__State,_resource,has__Amino__Acid__StateProperty,true);
	}

	public void addHas__Amino__Acid__State(org.cdao.jasper.Generic__State has__Amino__Acid__State) throws JastorException {
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		if (this.has__Amino__Acid__State_asGeneric__State.contains(has__Amino__Acid__State)) {
			this.has__Amino__Acid__State_asGeneric__State.remove(has__Amino__Acid__State);
			this.has__Amino__Acid__State_asGeneric__State.add(has__Amino__Acid__State);
			return;
		}
		this.has__Amino__Acid__State_asGeneric__State.add(has__Amino__Acid__State);
	...
	public org.cdao.jasper.Generic__State addHas__Amino__Acid__State_asGeneric__State() throws JastorException {
		org.cdao.jasper.Generic__State has__Amino__Acid__State = org.cdao.jasper.CDAOFactory.createGeneric__State(_model.createResource(),_model);
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		this.has__Amino__Acid__State_asGeneric__State.add(has__Amino__Acid__State);
		_model.add(_model.createStatement(_resource,has__Amino__Acid__StateProperty,has__Amino__Acid__State.resource()));
	...
	public org.cdao.jasper.Generic__State addHas__Amino__Acid__State_asGeneric__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Generic__State has__Amino__Acid__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		if (this.has__Amino__Acid__State_asGeneric__State.contains(has__Amino__Acid__State))
	...
	public void removeHas__Amino__Acid__State(org.cdao.jasper.Generic__State has__Amino__Acid__State) throws JastorException {
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		if (!this.has__Amino__Acid__State_asGeneric__State.contains(has__Amino__Acid__State))
			return;
	...
	public org.cdao.jasper.AminoAcidResidueCharacter getBelongs__to__Amino__Acid__Character() throws JastorException {
		if (belongs__to__Amino__Acid__Character != null)
			return belongs__to__Amino__Acid__Character;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, belongs__to__Amino__Acid__CharacterProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Amino__Acid__Character getProperty() in org.cdao.AminoAcidResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		belongs__to__Amino__Acid__Character = org.cdao.jasper.CDAOFactory.getAminoAcidResidueCharacter(resource,_model);
		return belongs__to__Amino__Acid__Character;
	}

	public void setBelongs__to__Amino__Acid__Character(org.cdao.jasper.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character) throws JastorException {
		if (_model.contains(_resource,belongs__to__Amino__Acid__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Amino__Acid__CharacterProperty,null);
		}
		this.belongs__to__Amino__Acid__Character = belongs__to__Amino__Acid__Character;
		if (belongs__to__Amino__Acid__Character != null) {
			_model.add(_model.createStatement(_resource,belongs__to__Amino__Acid__CharacterProperty, belongs__to__Amino__Acid__Character.resource()));
		}			
	}
		
	public org.cdao.jasper.AminoAcidResidueCharacter setBelongs__to__Amino__Acid__Character() throws JastorException {
		if (_model.contains(_resource,belongs__to__Amino__Acid__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Amino__Acid__CharacterProperty,null);
		}
		org.cdao.jasper.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character = org.cdao.jasper.CDAOFactory.createAminoAcidResidueCharacter(_model.createResource(),_model);
		this.belongs__to__Amino__Acid__Character = belongs__to__Amino__Acid__Character;
		_model.add(_model.createStatement(_resource,belongs__to__Amino__Acid__CharacterProperty, belongs__to__Amino__Acid__Character.resource()));
		return belongs__to__Amino__Acid__Character;
	}
	
	public org.cdao.jasper.AminoAcidResidueCharacter setBelongs__to__Amino__Acid__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,belongs__to__Amino__Acid__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Amino__Acid__CharacterProperty,null);
		}
		org.cdao.jasper.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character = org.cdao.jasper.CDAOFactory.getAminoAcidResidueCharacter(resource,_model);
		this.belongs__to__Amino__Acid__Character = belongs__to__Amino__Acid__Character;
		_model.add(_model.createStatement(_resource,belongs__to__Amino__Acid__CharacterProperty, belongs__to__Amino__Acid__Character.resource()));
		return belongs__to__Amino__Acid__Character;
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof AminoAcidResidueStateDatumListener))
			throw new IllegalArgumentException("ThingListener must be instance of AminoAcidResidueStateDatumListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((AminoAcidResidueStateDatumListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(belongs__to__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.belongs__to__CharacterChanged(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.homologous__toAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__StateAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__CoordinateAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__TUProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.belongs__to__TUChanged(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.hasAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_exclude);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Amino__Acid__StateProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jasper.AminoAcidResidue.TYPE)) {
					org.cdao.jasper.AminoAcidResidue _has__Amino__Acid__State_asAminoAcidResidue = null;
					try {
						_has__Amino__Acid__State_asAminoAcidResidue = org.cdao.jasper.CDAOFactory.getAminoAcidResidue(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Amino__Acid__State_asAminoAcidResidue == null) {
					...
					if (!has__Amino__Acid__State_asAminoAcidResidue.contains(_has__Amino__Acid__State_asAminoAcidResidue))
						has__Amino__Acid__State_asAminoAcidResidue.add(_has__Amino__Acid__State_asAminoAcidResidue);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Amino__Acid__State_asAminoAcidResidue;
						synchronized (listeners) {
							consumersForHas__Amino__Acid__State_asAminoAcidResidue = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asAminoAcidResidue.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asAminoAcidResidue);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Generic__State.TYPE)) {
					org.cdao.jasper.Generic__State _has__Amino__Acid__State_asGeneric__State = null;
					try {
						_has__Amino__Acid__State_asGeneric__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Amino__Acid__State_asGeneric__State == null) {
					...
					if (!has__Amino__Acid__State_asGeneric__State.contains(_has__Amino__Acid__State_asGeneric__State))
						has__Amino__Acid__State_asGeneric__State.add(_has__Amino__Acid__State_asGeneric__State);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Amino__Acid__State_asGeneric__State;
						synchronized (listeners) {
							consumersForHas__Amino__Acid__State_asGeneric__State = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asGeneric__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateAdded(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asGeneric__State);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(belongs__to__Amino__Acid__CharacterProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				belongs__to__Amino__Acid__Character = null;
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.belongs__to__Amino__Acid__CharacterChanged(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this);
					}
				}
				return;
			}
...
//				return;
			...
			if (stmt.getPredicate().equals(homologous__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.homologous__toRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__StateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__StateRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__CoordinateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__CoordinateRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Amino__Acid__StateProperty)) {
				...
				if (_model.contains(resource,RDF.type,org.cdao.jasper.AminoAcidResidue.TYPE)) {
					...
					if (has__Amino__Acid__State_asAminoAcidResidue != null) {
						boolean found = false;
						for (int i=0;i<has__Amino__Acid__State_asAminoAcidResidue.size();i++) {
							org.cdao.jasper.AminoAcidResidue __item = (org.cdao.jasper.AminoAcidResidue) has__Amino__Acid__State_asAminoAcidResidue.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Amino__Acid__State_asAminoAcidResidue = __item;
								break;
							}
						}
						if (found)
							has__Amino__Acid__State_asAminoAcidResidue.remove(_has__Amino__Acid__State_asAminoAcidResidue);
						else {
							try {
								_has__Amino__Acid__State_asAminoAcidResidue = org.cdao.jasper.CDAOFactory.getAminoAcidResidue(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asAminoAcidResidue.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asAminoAcidResidue);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Generic__State.TYPE)) {
					...
					if (has__Amino__Acid__State_asGeneric__State != null) {
						boolean found = false;
						for (int i=0;i<has__Amino__Acid__State_asGeneric__State.size();i++) {
							org.cdao.jasper.Generic__State __item = (org.cdao.jasper.Generic__State) has__Amino__Acid__State_asGeneric__State.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Amino__Acid__State_asGeneric__State = __item;
								break;
							}
						}
						if (found)
							has__Amino__Acid__State_asGeneric__State.remove(_has__Amino__Acid__State_asGeneric__State);
						else {
							try {
								_has__Amino__Acid__State_asGeneric__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asGeneric__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateRemoved(org.cdao.jasper.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asGeneric__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Amino__Acid__CharacterProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (belongs__to__Amino__Acid__Character != null && belongs__to__Amino__Acid__Character.resource().equals(resource))
						belongs__to__Amino__Acid__Character = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
