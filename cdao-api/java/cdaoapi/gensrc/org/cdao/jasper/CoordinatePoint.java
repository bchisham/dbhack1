...
/**
 * Interface for CoordinatePoint ontology class<br>
 ...
 * <br>
 */
public interface CoordinatePoint extends org.cdao.jasper.DatumCoordinate, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#CoordinatePoint");
	

	/**
	 * The Jena Property for has__Point__Coordinate__Value 
	 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Point_Coordinate_Value)</p>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__Point__Coordinate__ValueProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Point_Coordinate_Value");
	...
	/**
	 * Iterates through the 'has__Point__Coordinate__Value' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link java.math.BigInteger}
	 * @see			#has__Point__Coordinate__ValueProperty
	 */
	public java.util.Iterator getHas__Point__Coordinate__Value() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Add a 'has__Point__Coordinate__Value' property value
	 * @param		{@link java.math.BigInteger}, the value to add
	 * @see			#has__Point__Coordinate__ValueProperty
	 */
	public void addHas__Point__Coordinate__Value(java.math.BigInteger has__Point__Coordinate__Value) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Remove a 'has__Point__Coordinate__Value' property value. This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		{@link java.math.BigInteger}, the value to remove
	 * @see			#has__Point__Coordinate__ValueProperty
	 */
	public void removeHas__Point__Coordinate__Value(java.math.BigInteger has__Point__Coordinate__Value) throws com.ibm.adtech.jastor.JastorException;
