...
/**
 * Implementation of {@link org.cdao.jasper.Lineage}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#Lineage)</p>
 * <br>
 */
public class LineageImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.Lineage {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Lineage__nodeProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Lineage_node");
	private java.util.ArrayList has__Lineage__node;
 

	LineageImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static LineageImpl getLineage(Resource resource, Model model) throws JastorException {
		return new LineageImpl(resource, model);
	}
	    
	static LineageImpl createLineage(Resource resource, Model model) throws JastorException { 
		LineageImpl impl = new LineageImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Lineage.TYPE)))
			impl._model.add(impl._resource, RDF.type, Lineage.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__Lineage__nodeProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.Lineage.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in Lineage model not a Resource", stmt.getObject());
	...
	private void initHas_asDirectedEdge() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.DirectedEdge.TYPE)) {
				org.cdao.jasper.DirectedEdge has = org.cdao.jasper.CDAOFactory.getDirectedEdge(resource,_model);
	...
	public void addHas(org.cdao.jasper.DirectedEdge has) throws JastorException {
	...
	public org.cdao.jasper.DirectedEdge addHas_asDirectedEdge() throws JastorException {
		org.cdao.jasper.DirectedEdge has = org.cdao.jasper.CDAOFactory.createDirectedEdge(_model.createResource(),_model);
		if (this.has_asDirectedEdge == null)
			initHas_asDirectedEdge();
		this.has_asDirectedEdge.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.DirectedEdge addHas_asDirectedEdge(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.DirectedEdge has = org.cdao.jasper.CDAOFactory.getDirectedEdge(resource,_model);
		if (this.has_asDirectedEdge == null)
			initHas_asDirectedEdge();
		if (this.has_asDirectedEdge.contains(has))
	...
	public void removeHas(org.cdao.jasper.DirectedEdge has) throws JastorException {
		if (this.has_asDirectedEdge == null)
			initHas_asDirectedEdge();
		if (!this.has_asDirectedEdge.contains(has))
			return;
	...
	private void initSubtree__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#subtree_of properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in Lineage model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in Lineage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in Lineage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in Lineage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in Lineage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in Lineage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in Lineage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jasper.Node getHas__Root() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Root getProperty() in org.cdao.Lineage model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__Lineage__node() throws JastorException {
		this.has__Lineage__node = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Lineage__nodeProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Lineage_node properties in Lineage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.Node has__Lineage__node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
				this.has__Lineage__node.add(has__Lineage__node);
			}
		}
	}

	public java.util.Iterator getHas__Lineage__node() throws JastorException {
		if (has__Lineage__node == null)
			initHas__Lineage__node();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Lineage__node,_resource,has__Lineage__nodeProperty,true);
	}

	public void addHas__Lineage__node(org.cdao.jasper.Node has__Lineage__node) throws JastorException {
		if (this.has__Lineage__node == null)
			initHas__Lineage__node();
		if (this.has__Lineage__node.contains(has__Lineage__node)) {
			this.has__Lineage__node.remove(has__Lineage__node);
			this.has__Lineage__node.add(has__Lineage__node);
			return;
		}
		this.has__Lineage__node.add(has__Lineage__node);
		_model.add(_model.createStatement(_resource,has__Lineage__nodeProperty,has__Lineage__node.resource()));
	}
	
	public org.cdao.jasper.Node addHas__Lineage__node() throws JastorException {
		org.cdao.jasper.Node has__Lineage__node = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.has__Lineage__node == null)
			initHas__Lineage__node();
		this.has__Lineage__node.add(has__Lineage__node);
		_model.add(_model.createStatement(_resource,has__Lineage__nodeProperty,has__Lineage__node.resource()));
		return has__Lineage__node;
	}
	
	public org.cdao.jasper.Node addHas__Lineage__node(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Node has__Lineage__node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		if (this.has__Lineage__node == null)
			initHas__Lineage__node();
		if (this.has__Lineage__node.contains(has__Lineage__node))
	...
	public void removeHas__Lineage__node(org.cdao.jasper.Node has__Lineage__node) throws JastorException {
		if (this.has__Lineage__node == null)
			initHas__Lineage__node();
		if (!this.has__Lineage__node.contains(has__Lineage__node))
			return;
		if (!_model.contains(_resource, has__Lineage__nodeProperty, has__Lineage__node.resource()))
			return;
		this.has__Lineage__node.remove(has__Lineage__node);
		_model.removeAll(_resource, has__Lineage__nodeProperty, has__Lineage__node.resource());
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof LineageListener))
			throw new IllegalArgumentException("ThingListener must be instance of LineageListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((LineageListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasAdded(org.cdao.jasper.LineageImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.DirectedEdge.TYPE)) {
					org.cdao.jasper.DirectedEdge _has_asDirectedEdge = null;
					try {
						_has_asDirectedEdge = org.cdao.jasper.CDAOFactory.getDirectedEdge(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asDirectedEdge == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asDirectedEdge.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasAdded(org.cdao.jasper.LineageImpl.this,_has_asDirectedEdge);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asNode.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasAdded(org.cdao.jasper.LineageImpl.this,_has_asNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Edge.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asEdge.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasAdded(org.cdao.jasper.LineageImpl.this,_has_asEdge);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.subtree__ofAdded(org.cdao.jasper.LineageImpl.this,_subtree__of);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.RootedTree.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of_asRootedTree.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.subtree__ofAdded(org.cdao.jasper.LineageImpl.this,_subtree__of_asRootedTree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.LineageImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.LineageImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.LineageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.LineageImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.LineageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.LineageImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.LineageImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.LineageImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.LineageImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.LineageImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.LineageImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.LineageImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__RootProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__RootChanged(org.cdao.jasper.LineageImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Lineage__nodeProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.Node _has__Lineage__node = null;
					try {
						_has__Lineage__node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Lineage__node == null) {
					...
					if (!has__Lineage__node.contains(_has__Lineage__node))
						has__Lineage__node.add(_has__Lineage__node);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Lineage__node;
						synchronized (listeners) {
							consumersForHas__Lineage__node = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Lineage__node.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.has__Lineage__nodeAdded(org.cdao.jasper.LineageImpl.this,_has__Lineage__node);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.LineageImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.DirectedEdge.TYPE)) {
					...
					if (has_asDirectedEdge != null) {
						...
						for (int i=0;i<has_asDirectedEdge.size();i++) {
							org.cdao.jasper.DirectedEdge __item = (org.cdao.jasper.DirectedEdge) has_asDirectedEdge.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asDirectedEdge.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.LineageImpl.this,_has_asDirectedEdge);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asNode.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.LineageImpl.this,_has_asNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Edge.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asEdge.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.LineageImpl.this,_has_asEdge);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subtree__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.subtree__ofRemoved(org.cdao.jasper.LineageImpl.this,_subtree__of);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.RootedTree.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of_asRootedTree.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.subtree__ofRemoved(org.cdao.jasper.LineageImpl.this,_subtree__of_asRootedTree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.LineageImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.LineageImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.LineageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.LineageImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.LineageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						LineageListener listener=(LineageListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.LineageImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.LineageImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.LineageImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.LineageImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.LineageImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.LineageImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.LineageImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.LineageImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Lineage__nodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Lineage__node != null) {
						boolean found = false;
						for (int i=0;i<has__Lineage__node.size();i++) {
							org.cdao.jasper.Node __item = (org.cdao.jasper.Node) has__Lineage__node.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Lineage__node = __item;
								break;
							}
						}
						if (found)
							has__Lineage__node.remove(_has__Lineage__node);
						else {
							try {
								_has__Lineage__node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Lineage__node.iterator();iter.hasNext();){
							LineageListener listener=(LineageListener)iter.next();
							listener.has__Lineage__nodeRemoved(org.cdao.jasper.LineageImpl.this,_has__Lineage__node);
						}
					}
				}
				return;
