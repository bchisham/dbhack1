...
/**
 * Interface for CoordinateSystem ontology class<br>
 ...
 * 	description : A reference to an external coordinate system.  Coordinates for data must refer to some such external coordinate system. <br>
 * <br>
 */
public interface CoordinateSystem extends com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#CoordinateSystem");
