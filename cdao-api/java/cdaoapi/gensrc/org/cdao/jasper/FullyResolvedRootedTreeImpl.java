...
/**
 * Implementation of {@link org.cdao.jasper.FullyResolvedRootedTree}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#FullyResolvedRootedTree)</p>
 * <br>
 */
public class FullyResolvedRootedTreeImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.FullyResolvedRootedTree {
	...
	private java.util.ArrayList has_asDichotomy;
	private java.util.ArrayList has_asEdge;
	private java.util.ArrayList has_asTerminalNode;
	private java.util.ArrayList has_asNode;
	private static com.hp.hpl.jena.rdf.model.Property subtree__ofProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#subtree_of");
	...
	private static com.hp.hpl.jena.rdf.model.Property has__RootProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Root");
	private org.cdao.jasper.Node has__Root;
 

	FullyResolvedRootedTreeImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static FullyResolvedRootedTreeImpl getFullyResolvedRootedTree(Resource resource, Model model) throws JastorException {
		return new FullyResolvedRootedTreeImpl(resource, model);
	}
	    
	static FullyResolvedRootedTreeImpl createFullyResolvedRootedTree(Resource resource, Model model) throws JastorException { 
		FullyResolvedRootedTreeImpl impl = new FullyResolvedRootedTreeImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, FullyResolvedRootedTree.TYPE)))
			impl._model.add(impl._resource, RDF.type, FullyResolvedRootedTree.TYPE);
		impl.addSuperTypes();
	...
	void addSuperTypes() {
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.Network.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.Network.TYPE));     
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.Tree.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.Tree.TYPE));     
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.BifurcatingTree.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.BifurcatingTree.TYPE));     
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.RootedTree.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.RootedTree.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.FullyResolvedRootedTree.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.Network.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.Tree.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.BifurcatingTree.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.RootedTree.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public void clearCache() {
		has = null;
		has_asDichotomy = null;
		has_asEdge = null;
		has_asTerminalNode = null;
		has_asNode = null;
		subtree__of = null;
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
	...
	private void initHas_asDichotomy() throws JastorException {
		this.has_asDichotomy = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, hasProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Dichotomy.TYPE)) {
				org.cdao.jasper.Dichotomy has = org.cdao.jasper.CDAOFactory.getDichotomy(resource,_model);
				this.has_asDichotomy.add(has);
			}
		}
	}

	public java.util.Iterator getHas_asDichotomy() throws JastorException {
		if (has_asDichotomy == null)
			initHas_asDichotomy();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has_asDichotomy,_resource,hasProperty,true);
	}

	public void addHas(org.cdao.jasper.Dichotomy has) throws JastorException {
		if (this.has_asDichotomy == null)
			initHas_asDichotomy();
		if (this.has_asDichotomy.contains(has)) {
			this.has_asDichotomy.remove(has);
			this.has_asDichotomy.add(has);
			return;
		}
		this.has_asDichotomy.add(has);
	...
	public org.cdao.jasper.Dichotomy addHas_asDichotomy() throws JastorException {
		org.cdao.jasper.Dichotomy has = org.cdao.jasper.CDAOFactory.createDichotomy(_model.createResource(),_model);
		if (this.has_asDichotomy == null)
			initHas_asDichotomy();
		this.has_asDichotomy.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.Dichotomy addHas_asDichotomy(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Dichotomy has = org.cdao.jasper.CDAOFactory.getDichotomy(resource,_model);
		if (this.has_asDichotomy == null)
			initHas_asDichotomy();
		if (this.has_asDichotomy.contains(has))
	...
	public void removeHas(org.cdao.jasper.Dichotomy has) throws JastorException {
		if (this.has_asDichotomy == null)
			initHas_asDichotomy();
		if (!this.has_asDichotomy.contains(has))
			return;
	...
	private void initHas_asEdge() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Edge.TYPE)) {
				org.cdao.jasper.Edge has = org.cdao.jasper.CDAOFactory.getEdge(resource,_model);
	...
	public void addHas(org.cdao.jasper.Edge has) throws JastorException {
	...
	public org.cdao.jasper.Edge addHas_asEdge() throws JastorException {
		org.cdao.jasper.Edge has = org.cdao.jasper.CDAOFactory.createEdge(_model.createResource(),_model);
		if (this.has_asEdge == null)
			initHas_asEdge();
		this.has_asEdge.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.Edge addHas_asEdge(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Edge has = org.cdao.jasper.CDAOFactory.getEdge(resource,_model);
		if (this.has_asEdge == null)
			initHas_asEdge();
		if (this.has_asEdge.contains(has))
	...
	public void removeHas(org.cdao.jasper.Edge has) throws JastorException {
		if (this.has_asEdge == null)
			initHas_asEdge();
		if (!this.has_asEdge.contains(has))
			return;
	...
	private void initHas_asTerminalNode() throws JastorException {
		this.has_asTerminalNode = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, hasProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.TerminalNode.TYPE)) {
				org.cdao.jasper.TerminalNode has = org.cdao.jasper.CDAOFactory.getTerminalNode(resource,_model);
				this.has_asTerminalNode.add(has);
			}
		}
	}

	public java.util.Iterator getHas_asTerminalNode() throws JastorException {
		if (has_asTerminalNode == null)
			initHas_asTerminalNode();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has_asTerminalNode,_resource,hasProperty,true);
	}

	public void addHas(org.cdao.jasper.TerminalNode has) throws JastorException {
		if (this.has_asTerminalNode == null)
			initHas_asTerminalNode();
		if (this.has_asTerminalNode.contains(has)) {
			this.has_asTerminalNode.remove(has);
			this.has_asTerminalNode.add(has);
			return;
		}
		this.has_asTerminalNode.add(has);
	...
	public org.cdao.jasper.TerminalNode addHas_asTerminalNode() throws JastorException {
		org.cdao.jasper.TerminalNode has = org.cdao.jasper.CDAOFactory.createTerminalNode(_model.createResource(),_model);
		if (this.has_asTerminalNode == null)
			initHas_asTerminalNode();
		this.has_asTerminalNode.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.TerminalNode addHas_asTerminalNode(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.TerminalNode has = org.cdao.jasper.CDAOFactory.getTerminalNode(resource,_model);
		if (this.has_asTerminalNode == null)
			initHas_asTerminalNode();
		if (this.has_asTerminalNode.contains(has))
	...
	public void removeHas(org.cdao.jasper.TerminalNode has) throws JastorException {
		if (this.has_asTerminalNode == null)
			initHas_asTerminalNode();
		if (!this.has_asTerminalNode.contains(has))
			return;
	...
	private void initHas_asNode() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
				org.cdao.jasper.Node has = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
	...
	public void addHas(org.cdao.jasper.Node has) throws JastorException {
	...
	public org.cdao.jasper.Node addHas_asNode() throws JastorException {
		org.cdao.jasper.Node has = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.has_asNode == null)
			initHas_asNode();
		this.has_asNode.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.Node addHas_asNode(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Node has = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		if (this.has_asNode == null)
			initHas_asNode();
		if (this.has_asNode.contains(has))
	...
	public void removeHas(org.cdao.jasper.Node has) throws JastorException {
		if (this.has_asNode == null)
			initHas_asNode();
		if (!this.has_asNode.contains(has))
			return;
	...
	private void initSubtree__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#subtree_of properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.Network subtree__of = org.cdao.jasper.CDAOFactory.getNetwork(resource,_model);
	...
	public void addSubtree__of(org.cdao.jasper.Network subtree__of) throws JastorException {
	...
	public org.cdao.jasper.Network addSubtree__of() throws JastorException {
		org.cdao.jasper.Network subtree__of = org.cdao.jasper.CDAOFactory.createNetwork(_model.createResource(),_model);
		if (this.subtree__of == null)
			initSubtree__of();
		this.subtree__of.add(subtree__of);
		_model.add(_model.createStatement(_resource,subtree__ofProperty,subtree__of.resource()));
	...
	public org.cdao.jasper.Network addSubtree__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Network subtree__of = org.cdao.jasper.CDAOFactory.getNetwork(resource,_model);
		if (this.subtree__of == null)
			initSubtree__of();
		if (this.subtree__of.contains(subtree__of))
	...
	public void removeSubtree__of(org.cdao.jasper.Network subtree__of) throws JastorException {
		if (this.subtree__of == null)
			initSubtree__of();
		if (!this.subtree__of.contains(subtree__of))
			return;
	...
	private void initSubtree__of_asRootedTree() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#subtree_of properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.RootedTree.TYPE)) {
				org.cdao.jasper.RootedTree subtree__of = org.cdao.jasper.CDAOFactory.getRootedTree(resource,_model);
	...
	public void addSubtree__of(org.cdao.jasper.RootedTree subtree__of) throws JastorException {
	...
	public org.cdao.jasper.RootedTree addSubtree__of_asRootedTree() throws JastorException {
		org.cdao.jasper.RootedTree subtree__of = org.cdao.jasper.CDAOFactory.createRootedTree(_model.createResource(),_model);
		if (this.subtree__of_asRootedTree == null)
			initSubtree__of_asRootedTree();
		this.subtree__of_asRootedTree.add(subtree__of);
		_model.add(_model.createStatement(_resource,subtree__ofProperty,subtree__of.resource()));
	...
	public org.cdao.jasper.RootedTree addSubtree__of_asRootedTree(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.RootedTree subtree__of = org.cdao.jasper.CDAOFactory.getRootedTree(resource,_model);
		if (this.subtree__of_asRootedTree == null)
			initSubtree__of_asRootedTree();
		if (this.subtree__of_asRootedTree.contains(subtree__of))
	...
	public void removeSubtree__of(org.cdao.jasper.RootedTree subtree__of) throws JastorException {
		if (this.subtree__of_asRootedTree == null)
			initSubtree__of_asRootedTree();
		if (!this.subtree__of_asRootedTree.contains(subtree__of))
			return;
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in FullyResolvedRootedTree model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in FullyResolvedRootedTree model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jasper.Node getHas__Root() throws JastorException {
		if (has__Root != null)
			return has__Root;
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Root getProperty() in org.cdao.FullyResolvedRootedTree model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		has__Root = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		return has__Root;
	}

	public void setHas__Root(org.cdao.jasper.Node has__Root) throws JastorException {
	...
	public org.cdao.jasper.Node setHas__Root() throws JastorException {
		if (_model.contains(_resource,has__RootProperty)) {
			_model.removeAll(_resource,has__RootProperty,null);
		}
		org.cdao.jasper.Node has__Root = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		this.has__Root = has__Root;
		_model.add(_model.createStatement(_resource,has__RootProperty, has__Root.resource()));
		return has__Root;
	}
	
	public org.cdao.jasper.Node setHas__Root(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,has__RootProperty)) {
			_model.removeAll(_resource,has__RootProperty,null);
		}
		org.cdao.jasper.Node has__Root = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		this.has__Root = has__Root;
		_model.add(_model.createStatement(_resource,has__RootProperty, has__Root.resource()));
		return has__Root;
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof FullyResolvedRootedTreeListener))
			throw new IllegalArgumentException("ThingListener must be instance of FullyResolvedRootedTreeListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((FullyResolvedRootedTreeListener)listener);
		}
	}
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Dichotomy.TYPE)) {
					org.cdao.jasper.Dichotomy _has_asDichotomy = null;
					try {
						_has_asDichotomy = org.cdao.jasper.CDAOFactory.getDichotomy(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asDichotomy == null) {
					...
					if (!has_asDichotomy.contains(_has_asDichotomy))
						has_asDichotomy.add(_has_asDichotomy);
					if (listeners != null) {
						java.util.ArrayList consumersForHas_asDichotomy;
						synchronized (listeners) {
							consumersForHas_asDichotomy = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas_asDichotomy.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asDichotomy);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Edge.TYPE)) {
					org.cdao.jasper.Edge _has_asEdge = null;
					try {
						_has_asEdge = org.cdao.jasper.CDAOFactory.getEdge(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asEdge == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asEdge.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asEdge);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.TerminalNode.TYPE)) {
					org.cdao.jasper.TerminalNode _has_asTerminalNode = null;
					try {
						_has_asTerminalNode = org.cdao.jasper.CDAOFactory.getTerminalNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asTerminalNode == null) {
					...
					if (!has_asTerminalNode.contains(_has_asTerminalNode))
						has_asTerminalNode.add(_has_asTerminalNode);
					if (listeners != null) {
						java.util.ArrayList consumersForHas_asTerminalNode;
						synchronized (listeners) {
							consumersForHas_asTerminalNode = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas_asTerminalNode.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asTerminalNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
					org.cdao.jasper.Node _has_asNode = null;
					try {
						_has_asNode = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asNode == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asNode.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asNode);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subtree__ofProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.Network _subtree__of = null;
					try {
						_subtree__of = org.cdao.jasper.CDAOFactory.getNetwork(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (subtree__of == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.subtree__ofAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_subtree__of);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.RootedTree.TYPE)) {
					org.cdao.jasper.RootedTree _subtree__of_asRootedTree = null;
					try {
						_subtree__of_asRootedTree = org.cdao.jasper.CDAOFactory.getRootedTree(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (subtree__of_asRootedTree == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of_asRootedTree.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.subtree__ofAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_subtree__of_asRootedTree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__RootProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__RootChanged(org.cdao.jasper.FullyResolvedRootedTreeImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Dichotomy.TYPE)) {
					...
					if (has_asDichotomy != null) {
						boolean found = false;
						for (int i=0;i<has_asDichotomy.size();i++) {
							org.cdao.jasper.Dichotomy __item = (org.cdao.jasper.Dichotomy) has_asDichotomy.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asDichotomy = __item;
								break;
							}
						}
						if (found)
							has_asDichotomy.remove(_has_asDichotomy);
						else {
							try {
								_has_asDichotomy = org.cdao.jasper.CDAOFactory.getDichotomy(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asDichotomy.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asDichotomy);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Edge.TYPE)) {
					...
					if (has_asEdge != null) {
						...
						for (int i=0;i<has_asEdge.size();i++) {
							org.cdao.jasper.Edge __item = (org.cdao.jasper.Edge) has_asEdge.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asEdge = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asEdge.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asEdge);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.TerminalNode.TYPE)) {
					...
					if (has_asTerminalNode != null) {
						boolean found = false;
						for (int i=0;i<has_asTerminalNode.size();i++) {
							org.cdao.jasper.TerminalNode __item = (org.cdao.jasper.TerminalNode) has_asTerminalNode.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asTerminalNode = __item;
								break;
							}
						}
						if (found)
							has_asTerminalNode.remove(_has_asTerminalNode);
						else {
							try {
								_has_asTerminalNode = org.cdao.jasper.CDAOFactory.getTerminalNode(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asTerminalNode.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asTerminalNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
					...
					if (has_asNode != null) {
						...
						for (int i=0;i<has_asNode.size();i++) {
							org.cdao.jasper.Node __item = (org.cdao.jasper.Node) has_asNode.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asNode = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asNode.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has_asNode);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (subtree__of != null) {
						...
						for (int i=0;i<subtree__of.size();i++) {
							org.cdao.jasper.Network __item = (org.cdao.jasper.Network) subtree__of.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_subtree__of = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.subtree__ofRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_subtree__of);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.RootedTree.TYPE)) {
					...
					if (subtree__of_asRootedTree != null) {
						...
						for (int i=0;i<subtree__of_asRootedTree.size();i++) {
							org.cdao.jasper.RootedTree __item = (org.cdao.jasper.RootedTree) subtree__of_asRootedTree.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubtree__of_asRootedTree.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.subtree__ofRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_subtree__of_asRootedTree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							FullyResolvedRootedTreeListener listener=(FullyResolvedRootedTreeListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.FullyResolvedRootedTreeImpl.this,_exclude);
						}
					}
				}
				return;
