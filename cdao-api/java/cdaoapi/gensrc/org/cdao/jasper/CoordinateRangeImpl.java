...
/**
 * Implementation of {@link org.cdao.jasper.CoordinateRange}
 ...
 * <br>
 */
public class CoordinateRangeImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.CoordinateRange {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Range__End__ValueProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Range_End_Value");
	private java.util.ArrayList has__Range__End__Value;
	private static com.hp.hpl.jena.rdf.model.Property has__Range__Start__ValueProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Range_Start_Value");
	private java.util.ArrayList has__Range__Start__Value;
 

	CoordinateRangeImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static CoordinateRangeImpl getCoordinateRange(Resource resource, Model model) throws JastorException {
		return new CoordinateRangeImpl(resource, model);
	}
	    
	static CoordinateRangeImpl createCoordinateRange(Resource resource, Model model) throws JastorException { 
		CoordinateRangeImpl impl = new CoordinateRangeImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, CoordinateRange.TYPE)))
			impl._model.add(impl._resource, RDF.type, CoordinateRange.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__Range__End__ValueProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,has__Range__Start__ValueProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.CoordinateRange.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		precedes = null;
		exclude = null;
		has__Range__End__Value = null;
		has__Range__Start__Value = null;
	}
	...
	public org.cdao.jasper.CoordinateSystem getHas__Coordinate__System() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Coordinate__System getProperty() in org.cdao.CoordinateRange model not Resource", stmt.getObject());
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in CoordinateRange model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in CoordinateRange model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Range__End__Value() throws JastorException {
		has__Range__End__Value = new java.util.ArrayList();
		
		StmtIterator it = _model.listStatements(_resource, has__Range__End__ValueProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Range_End_Value properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.math.BigInteger","http://www.w3.org/2001/XMLSchema#integer");
			if (obj != null)
				has__Range__End__Value.add(obj);
		}
	}

	public java.util.Iterator getHas__Range__End__Value() throws JastorException {
		if (has__Range__End__Value == null)
			initHas__Range__End__Value();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Range__End__Value,_resource,has__Range__End__ValueProperty,false);
	}

	public void addHas__Range__End__Value(java.math.BigInteger has__Range__End__Value) throws JastorException {
		if (this.has__Range__End__Value == null)
			initHas__Range__End__Value();
		if (this.has__Range__End__Value.contains(has__Range__End__Value))
			return;
		if (_model.contains(_resource, has__Range__End__ValueProperty, createLiteral(has__Range__End__Value)))
			return;
		this.has__Range__End__Value.add(has__Range__End__Value);
		_model.add(_resource, has__Range__End__ValueProperty, createLiteral(has__Range__End__Value));
	}
	
	public void removeHas__Range__End__Value(java.math.BigInteger has__Range__End__Value) throws JastorException {
		if (this.has__Range__End__Value == null)
			initHas__Range__End__Value();
		if (!this.has__Range__End__Value.contains(has__Range__End__Value))
			return;
		if (!_model.contains(_resource, has__Range__End__ValueProperty, createLiteral(has__Range__End__Value)))
			return;
		this.has__Range__End__Value.remove(has__Range__End__Value);
		_model.removeAll(_resource, has__Range__End__ValueProperty, createLiteral(has__Range__End__Value));
	}


	private void initHas__Range__Start__Value() throws JastorException {
		has__Range__Start__Value = new java.util.ArrayList();
		
		StmtIterator it = _model.listStatements(_resource, has__Range__Start__ValueProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Range_Start_Value properties in CoordinateRange model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.math.BigInteger","http://www.w3.org/2001/XMLSchema#integer");
			if (obj != null)
				has__Range__Start__Value.add(obj);
		}
	}

	public java.util.Iterator getHas__Range__Start__Value() throws JastorException {
		if (has__Range__Start__Value == null)
			initHas__Range__Start__Value();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Range__Start__Value,_resource,has__Range__Start__ValueProperty,false);
	}

	public void addHas__Range__Start__Value(java.math.BigInteger has__Range__Start__Value) throws JastorException {
		if (this.has__Range__Start__Value == null)
			initHas__Range__Start__Value();
		if (this.has__Range__Start__Value.contains(has__Range__Start__Value))
			return;
		if (_model.contains(_resource, has__Range__Start__ValueProperty, createLiteral(has__Range__Start__Value)))
			return;
		this.has__Range__Start__Value.add(has__Range__Start__Value);
		_model.add(_resource, has__Range__Start__ValueProperty, createLiteral(has__Range__Start__Value));
	}
	
	public void removeHas__Range__Start__Value(java.math.BigInteger has__Range__Start__Value) throws JastorException {
		if (this.has__Range__Start__Value == null)
			initHas__Range__Start__Value();
		if (!this.has__Range__Start__Value.contains(has__Range__Start__Value))
			return;
		if (!_model.contains(_resource, has__Range__Start__ValueProperty, createLiteral(has__Range__Start__Value)))
			return;
		this.has__Range__Start__Value.remove(has__Range__Start__Value);
		_model.removeAll(_resource, has__Range__Start__ValueProperty, createLiteral(has__Range__Start__Value));
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof CoordinateRangeListener))
			throw new IllegalArgumentException("ThingListener must be instance of CoordinateRangeListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((CoordinateRangeListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(has__Coordinate__SystemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Coordinate__SystemChanged(org.cdao.jasper.CoordinateRangeImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.CoordinateRangeImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.CoordinateRangeImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.CoordinateRangeImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.hasAdded(org.cdao.jasper.CoordinateRangeImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.CoordinateRangeImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.CoordinateRangeImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.CoordinateRangeImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.CoordinateRangeImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.CoordinateRangeImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.CoordinateRangeImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.CoordinateRangeImpl.this,_exclude);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Range__End__ValueProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				//Object obj = literal.getValue();
				...
				if (obj != null && !has__Range__End__Value.contains(obj))
					has__Range__End__Value.add(obj);
				java.util.ArrayList consumersForHas__Range__End__Value;
				if (listeners != null) {
					synchronized (listeners) {
						consumersForHas__Range__End__Value = (java.util.ArrayList) listeners.clone();
					}
					for(java.util.Iterator iter=consumersForHas__Range__End__Value.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Range__End__ValueAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.math.BigInteger)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Range__Start__ValueProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
					return;
				com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
				//Object obj = literal.getValue();
				...
				if (obj != null && !has__Range__Start__Value.contains(obj))
					has__Range__Start__Value.add(obj);
				java.util.ArrayList consumersForHas__Range__Start__Value;
				if (listeners != null) {
					synchronized (listeners) {
						consumersForHas__Range__Start__Value = (java.util.ArrayList) listeners.clone();
					}
					for(java.util.Iterator iter=consumersForHas__Range__Start__Value.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Range__Start__ValueAdded(org.cdao.jasper.CoordinateRangeImpl.this,(java.math.BigInteger)obj);
					}
				}
				return;
			}
...
//				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.CoordinateRangeImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.CoordinateRangeImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Range__End__ValueProperty)) {
				...
				Object obj = Util.fixLiteral(true,literal,"java.math.BigInteger","http://www.w3.org/2001/XMLSchema#integer");
				if (has__Range__End__Value != null) {
					if (has__Range__End__Value.contains(obj))
						has__Range__End__Value.remove(obj);
				}
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Range__End__ValueRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.math.BigInteger)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Range__Start__ValueProperty)) {
				...
				Object obj = Util.fixLiteral(true,literal,"java.math.BigInteger","http://www.w3.org/2001/XMLSchema#integer");
				if (has__Range__Start__Value != null) {
					if (has__Range__Start__Value.contains(obj))
						has__Range__Start__Value.remove(obj);
				}
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateRangeListener listener=(CoordinateRangeListener)iter.next();
						listener.has__Range__Start__ValueRemoved(org.cdao.jasper.CoordinateRangeImpl.this,(java.math.BigInteger)obj);
					}
				}
				return;
			}
