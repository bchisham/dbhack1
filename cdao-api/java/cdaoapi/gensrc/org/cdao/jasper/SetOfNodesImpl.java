...
/**
 * Implementation of {@link org.cdao.jasper.SetOfNodes}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#SetOfNodes)</p>
 * <br>
 */
public class SetOfNodesImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.SetOfNodes {
	

	private static com.hp.hpl.jena.rdf.model.Property has__ElementProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Element");
	private java.util.ArrayList has__Element;
	private java.util.ArrayList has__Element_asNode;
	private java.util.ArrayList has__Element_asCharacter;
	private java.util.ArrayList has__Element_asSetOfCharacters;
	...
	SetOfNodesImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static SetOfNodesImpl getSetOfNodes(Resource resource, Model model) throws JastorException {
		return new SetOfNodesImpl(resource, model);
	}
	    
	static SetOfNodesImpl createSetOfNodes(Resource resource, Model model) throws JastorException { 
		SetOfNodesImpl impl = new SetOfNodesImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, SetOfNodes.TYPE)))
			impl._model.add(impl._resource, RDF.type, SetOfNodes.TYPE);
		impl.addSuperTypes();
	...
	void addSuperTypes() {
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.SetOfThings.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.SetOfThings.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__ElementProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.SetOfNodes.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.SetOfThings.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public void clearCache() {
		has__Element = null;
		has__Element_asNode = null;
		has__Element_asCharacter = null;
		has__Element_asSetOfCharacters = null;
		belongs__to = null;
	...
	private void initHas__Element() throws JastorException {
		this.has__Element = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__ElementProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Element properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				com.ibm.adtech.jastor.Thing has__Element = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
				this.has__Element.add(has__Element);
			}
		}
	}

	public java.util.Iterator getHas__Element() throws JastorException {
		if (has__Element == null)
			initHas__Element();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Element,_resource,has__ElementProperty,true);
	}

	public void addHas__Element(com.ibm.adtech.jastor.Thing has__Element) throws JastorException {
		if (this.has__Element == null)
			initHas__Element();
		if (this.has__Element.contains(has__Element)) {
			this.has__Element.remove(has__Element);
			this.has__Element.add(has__Element);
			return;
		}
		this.has__Element.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	}
	
	public com.ibm.adtech.jastor.Thing addHas__Element() throws JastorException {
		com.ibm.adtech.jastor.Thing has__Element = com.ibm.adtech.jastor.ThingFactory.createThing(_model.createResource(),_model);
		if (this.has__Element == null)
			initHas__Element();
		this.has__Element.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public com.ibm.adtech.jastor.Thing addHas__Element(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		com.ibm.adtech.jastor.Thing has__Element = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
		if (this.has__Element == null)
			initHas__Element();
		if (this.has__Element.contains(has__Element))
	...
	public void removeHas__Element(com.ibm.adtech.jastor.Thing has__Element) throws JastorException {
		if (this.has__Element == null)
			initHas__Element();
		if (!this.has__Element.contains(has__Element))
			return;
		if (!_model.contains(_resource, has__ElementProperty, has__Element.resource()))
			return;
		this.has__Element.remove(has__Element);
		_model.removeAll(_resource, has__ElementProperty, has__Element.resource());
	}
		
	private void initHas__Element_asNode() throws JastorException {
		this.has__Element_asNode = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__ElementProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
				org.cdao.jasper.Node has__Element = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
				this.has__Element_asNode.add(has__Element);
			}
		}
	}

	public java.util.Iterator getHas__Element_asNode() throws JastorException {
		if (has__Element_asNode == null)
			initHas__Element_asNode();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Element_asNode,_resource,has__ElementProperty,true);
	}

	public void addHas__Element(org.cdao.jasper.Node has__Element) throws JastorException {
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		if (this.has__Element_asNode.contains(has__Element)) {
			this.has__Element_asNode.remove(has__Element);
			this.has__Element_asNode.add(has__Element);
			return;
		}
		this.has__Element_asNode.add(has__Element);
	...
	public org.cdao.jasper.Node addHas__Element_asNode() throws JastorException {
		org.cdao.jasper.Node has__Element = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		this.has__Element_asNode.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public org.cdao.jasper.Node addHas__Element_asNode(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Node has__Element = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		if (this.has__Element_asNode.contains(has__Element))
	...
	public void removeHas__Element(org.cdao.jasper.Node has__Element) throws JastorException {
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		if (!this.has__Element_asNode.contains(has__Element))
			return;
	...
	private void initHas__Element_asCharacter() throws JastorException {
		this.has__Element_asCharacter = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__ElementProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Element properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Character.TYPE)) {
				org.cdao.jasper.Character has__Element = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
				this.has__Element_asCharacter.add(has__Element);
			}
		}
	}

	public java.util.Iterator getHas__Element_asCharacter() throws JastorException {
		if (has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Element_asCharacter,_resource,has__ElementProperty,true);
	}

	public void addHas__Element(org.cdao.jasper.Character has__Element) throws JastorException {
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		if (this.has__Element_asCharacter.contains(has__Element)) {
			this.has__Element_asCharacter.remove(has__Element);
			this.has__Element_asCharacter.add(has__Element);
			return;
		}
		this.has__Element_asCharacter.add(has__Element);
	...
	public org.cdao.jasper.Character addHas__Element_asCharacter() throws JastorException {
		org.cdao.jasper.Character has__Element = org.cdao.jasper.CDAOFactory.createCharacter(_model.createResource(),_model);
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		this.has__Element_asCharacter.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public org.cdao.jasper.Character addHas__Element_asCharacter(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Character has__Element = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		if (this.has__Element_asCharacter.contains(has__Element))
	...
	public void removeHas__Element(org.cdao.jasper.Character has__Element) throws JastorException {
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		if (!this.has__Element_asCharacter.contains(has__Element))
			return;
	...
	private void initHas__Element_asSetOfCharacters() throws JastorException {
		this.has__Element_asSetOfCharacters = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__ElementProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Element properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.SetOfCharacters.TYPE)) {
				org.cdao.jasper.SetOfCharacters has__Element = org.cdao.jasper.CDAOFactory.getSetOfCharacters(resource,_model);
				this.has__Element_asSetOfCharacters.add(has__Element);
			}
		}
	}

	public java.util.Iterator getHas__Element_asSetOfCharacters() throws JastorException {
		if (has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Element_asSetOfCharacters,_resource,has__ElementProperty,true);
	}

	public void addHas__Element(org.cdao.jasper.SetOfCharacters has__Element) throws JastorException {
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		if (this.has__Element_asSetOfCharacters.contains(has__Element)) {
			this.has__Element_asSetOfCharacters.remove(has__Element);
			this.has__Element_asSetOfCharacters.add(has__Element);
			return;
		}
		this.has__Element_asSetOfCharacters.add(has__Element);
	...
	public org.cdao.jasper.SetOfCharacters addHas__Element_asSetOfCharacters() throws JastorException {
		org.cdao.jasper.SetOfCharacters has__Element = org.cdao.jasper.CDAOFactory.createSetOfCharacters(_model.createResource(),_model);
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		this.has__Element_asSetOfCharacters.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public org.cdao.jasper.SetOfCharacters addHas__Element_asSetOfCharacters(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.SetOfCharacters has__Element = org.cdao.jasper.CDAOFactory.getSetOfCharacters(resource,_model);
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		if (this.has__Element_asSetOfCharacters.contains(has__Element))
	...
	public void removeHas__Element(org.cdao.jasper.SetOfCharacters has__Element) throws JastorException {
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		if (!this.has__Element_asSetOfCharacters.contains(has__Element))
			return;
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in SetOfNodes model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof SetOfNodesListener))
			throw new IllegalArgumentException("ThingListener must be instance of SetOfNodesListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((SetOfNodesListener)listener);
		}
	}
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(has__ElementProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					com.ibm.adtech.jastor.Thing _has__Element = null;
					try {
						_has__Element = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
					...
					if (!has__Element.contains(_has__Element))
						has__Element.add(_has__Element);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Element;
						synchronized (listeners) {
							consumersForHas__Element = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Element.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jasper.SetOfNodesImpl.this,_has__Element);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
					org.cdao.jasper.Node _has__Element_asNode = null;
					try {
						_has__Element_asNode = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Element_asNode == null) {
					...
					if (!has__Element_asNode.contains(_has__Element_asNode))
						has__Element_asNode.add(_has__Element_asNode);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Element_asNode;
						synchronized (listeners) {
							consumersForHas__Element_asNode = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Element_asNode.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jasper.SetOfNodesImpl.this,_has__Element_asNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Character.TYPE)) {
					org.cdao.jasper.Character _has__Element_asCharacter = null;
					try {
						_has__Element_asCharacter = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Element_asCharacter == null) {
					...
					if (!has__Element_asCharacter.contains(_has__Element_asCharacter))
						has__Element_asCharacter.add(_has__Element_asCharacter);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Element_asCharacter;
						synchronized (listeners) {
							consumersForHas__Element_asCharacter = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Element_asCharacter.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jasper.SetOfNodesImpl.this,_has__Element_asCharacter);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.SetOfCharacters.TYPE)) {
					org.cdao.jasper.SetOfCharacters _has__Element_asSetOfCharacters = null;
					try {
						_has__Element_asSetOfCharacters = org.cdao.jasper.CDAOFactory.getSetOfCharacters(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Element_asSetOfCharacters == null) {
					...
					if (!has__Element_asSetOfCharacters.contains(_has__Element_asSetOfCharacters))
						has__Element_asSetOfCharacters.add(_has__Element_asSetOfCharacters);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Element_asSetOfCharacters;
						synchronized (listeners) {
							consumersForHas__Element_asSetOfCharacters = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Element_asSetOfCharacters.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jasper.SetOfNodesImpl.this,_has__Element_asSetOfCharacters);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.SetOfNodesImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.SetOfNodesImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.SetOfNodesImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.hasAdded(org.cdao.jasper.SetOfNodesImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.SetOfNodesImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.SetOfNodesImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.SetOfNodesImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.SetOfNodesImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.SetOfNodesImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.SetOfNodesImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.SetOfNodesImpl.this,_exclude);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__ElementProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Element != null) {
						boolean found = false;
						for (int i=0;i<has__Element.size();i++) {
							com.ibm.adtech.jastor.Thing __item = (com.ibm.adtech.jastor.Thing) has__Element.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Element = __item;
								break;
							}
						}
						if (found)
							has__Element.remove(_has__Element);
						else {
							try {
								_has__Element = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has__Element);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Node.TYPE)) {
					...
					if (has__Element_asNode != null) {
						boolean found = false;
						for (int i=0;i<has__Element_asNode.size();i++) {
							org.cdao.jasper.Node __item = (org.cdao.jasper.Node) has__Element_asNode.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Element_asNode = __item;
								break;
							}
						}
						if (found)
							has__Element_asNode.remove(_has__Element_asNode);
						else {
							try {
								_has__Element_asNode = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asNode.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has__Element_asNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Character.TYPE)) {
					...
					if (has__Element_asCharacter != null) {
						boolean found = false;
						for (int i=0;i<has__Element_asCharacter.size();i++) {
							org.cdao.jasper.Character __item = (org.cdao.jasper.Character) has__Element_asCharacter.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Element_asCharacter = __item;
								break;
							}
						}
						if (found)
							has__Element_asCharacter.remove(_has__Element_asCharacter);
						else {
							try {
								_has__Element_asCharacter = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asCharacter.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has__Element_asCharacter);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.SetOfCharacters.TYPE)) {
					...
					if (has__Element_asSetOfCharacters != null) {
						boolean found = false;
						for (int i=0;i<has__Element_asSetOfCharacters.size();i++) {
							org.cdao.jasper.SetOfCharacters __item = (org.cdao.jasper.SetOfCharacters) has__Element_asSetOfCharacters.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Element_asSetOfCharacters = __item;
								break;
							}
						}
						if (found)
							has__Element_asSetOfCharacters.remove(_has__Element_asSetOfCharacters);
						else {
							try {
								_has__Element_asSetOfCharacters = org.cdao.jasper.CDAOFactory.getSetOfCharacters(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asSetOfCharacters.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has__Element_asSetOfCharacters);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.SetOfNodesImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.SetOfNodesImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.SetOfNodesImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.SetOfNodesImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.SetOfNodesImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.SetOfNodesImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.SetOfNodesImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.SetOfNodesImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.SetOfNodesImpl.this,_exclude);
						}
					}
				}
				return;
