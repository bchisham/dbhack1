...
/**
 * Implementation of {@link org.cdao.jasper.CoordinateList}
 ...
 * <br>
 */
public class CoordinateListImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.CoordinateList {
	

	private static com.hp.hpl.jena.rdf.model.Property has__Coordinate__SystemProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Coordinate_System");
	private org.cdao.jasper.CoordinateSystem has__Coordinate__System;
	...
	private static com.hp.hpl.jena.rdf.model.Property has__First__Coordinate__ItemProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_First_Coordinate_Item");
	private java.util.ArrayList has__First__Coordinate__Item_asCoordinatePoint;
	private java.util.ArrayList has__First__Coordinate__Item_asCoordinateRange;
	private static com.hp.hpl.jena.rdf.model.Property has__Remaining__Coordinate__ListProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Remaining_Coordinate_List");
	private java.util.ArrayList has__Remaining__Coordinate__List;
 

	CoordinateListImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static CoordinateListImpl getCoordinateList(Resource resource, Model model) throws JastorException {
		return new CoordinateListImpl(resource, model);
	}
	    
	static CoordinateListImpl createCoordinateList(Resource resource, Model model) throws JastorException { 
		CoordinateListImpl impl = new CoordinateListImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, CoordinateList.TYPE)))
			impl._model.add(impl._resource, RDF.type, CoordinateList.TYPE);
		impl.addSuperTypes();
	...
	void addSuperTypes() {
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.DatumCoordinate.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.DatumCoordinate.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__Coordinate__SystemProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,has__First__Coordinate__ItemProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,has__Remaining__Coordinate__ListProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.CoordinateList.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.DatumCoordinate.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public void clearCache() {
		...
		precedes = null;
		exclude = null;
		has__First__Coordinate__Item_asCoordinatePoint = null;
		has__First__Coordinate__Item_asCoordinateRange = null;
		has__Remaining__Coordinate__List = null;
	}
	...
	public org.cdao.jasper.CoordinateSystem getHas__Coordinate__System() throws JastorException {
		if (has__Coordinate__System != null)
			return has__Coordinate__System;
		com.hp.hpl.jena.rdf.model.Statement stmt = _model.getProperty(_resource, has__Coordinate__SystemProperty);
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Coordinate__System getProperty() in org.cdao.CoordinateList model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		has__Coordinate__System = org.cdao.jasper.CDAOFactory.getCoordinateSystem(resource,_model);
		return has__Coordinate__System;
	}

	public void setHas__Coordinate__System(org.cdao.jasper.CoordinateSystem has__Coordinate__System) throws JastorException {
		if (_model.contains(_resource,has__Coordinate__SystemProperty)) {
			_model.removeAll(_resource,has__Coordinate__SystemProperty,null);
		}
		this.has__Coordinate__System = has__Coordinate__System;
		if (has__Coordinate__System != null) {
			_model.add(_model.createStatement(_resource,has__Coordinate__SystemProperty, has__Coordinate__System.resource()));
		}			
	}
		
	public org.cdao.jasper.CoordinateSystem setHas__Coordinate__System() throws JastorException {
		if (_model.contains(_resource,has__Coordinate__SystemProperty)) {
			_model.removeAll(_resource,has__Coordinate__SystemProperty,null);
		}
		org.cdao.jasper.CoordinateSystem has__Coordinate__System = org.cdao.jasper.CDAOFactory.createCoordinateSystem(_model.createResource(),_model);
		this.has__Coordinate__System = has__Coordinate__System;
		_model.add(_model.createStatement(_resource,has__Coordinate__SystemProperty, has__Coordinate__System.resource()));
		return has__Coordinate__System;
	}
	
	public org.cdao.jasper.CoordinateSystem setHas__Coordinate__System(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,has__Coordinate__SystemProperty)) {
			_model.removeAll(_resource,has__Coordinate__SystemProperty,null);
		}
		org.cdao.jasper.CoordinateSystem has__Coordinate__System = org.cdao.jasper.CDAOFactory.getCoordinateSystem(resource,_model);
		this.has__Coordinate__System = has__Coordinate__System;
		_model.add(_model.createStatement(_resource,has__Coordinate__SystemProperty, has__Coordinate__System.resource()));
		return has__Coordinate__System;
	}
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in CoordinateList model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__First__Coordinate__Item_asCoordinatePoint() throws JastorException {
		this.has__First__Coordinate__Item_asCoordinatePoint = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__First__Coordinate__ItemProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_First_Coordinate_Item properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.CoordinatePoint.TYPE)) {
				org.cdao.jasper.CoordinatePoint has__First__Coordinate__Item = org.cdao.jasper.CDAOFactory.getCoordinatePoint(resource,_model);
				this.has__First__Coordinate__Item_asCoordinatePoint.add(has__First__Coordinate__Item);
			}
		}
	}

	public java.util.Iterator getHas__First__Coordinate__Item_asCoordinatePoint() throws JastorException {
		if (has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__First__Coordinate__Item_asCoordinatePoint,_resource,has__First__Coordinate__ItemProperty,true);
	}

	public void addHas__First__Coordinate__Item(org.cdao.jasper.CoordinatePoint has__First__Coordinate__Item) throws JastorException {
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		if (this.has__First__Coordinate__Item_asCoordinatePoint.contains(has__First__Coordinate__Item)) {
			this.has__First__Coordinate__Item_asCoordinatePoint.remove(has__First__Coordinate__Item);
			this.has__First__Coordinate__Item_asCoordinatePoint.add(has__First__Coordinate__Item);
			return;
		}
		this.has__First__Coordinate__Item_asCoordinatePoint.add(has__First__Coordinate__Item);
		_model.add(_model.createStatement(_resource,has__First__Coordinate__ItemProperty,has__First__Coordinate__Item.resource()));
	}
	
	public org.cdao.jasper.CoordinatePoint addHas__First__Coordinate__Item_asCoordinatePoint() throws JastorException {
		org.cdao.jasper.CoordinatePoint has__First__Coordinate__Item = org.cdao.jasper.CDAOFactory.createCoordinatePoint(_model.createResource(),_model);
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		this.has__First__Coordinate__Item_asCoordinatePoint.add(has__First__Coordinate__Item);
		_model.add(_model.createStatement(_resource,has__First__Coordinate__ItemProperty,has__First__Coordinate__Item.resource()));
		return has__First__Coordinate__Item;
	}
	
	public org.cdao.jasper.CoordinatePoint addHas__First__Coordinate__Item_asCoordinatePoint(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CoordinatePoint has__First__Coordinate__Item = org.cdao.jasper.CDAOFactory.getCoordinatePoint(resource,_model);
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		if (this.has__First__Coordinate__Item_asCoordinatePoint.contains(has__First__Coordinate__Item))
	...
	public void removeHas__First__Coordinate__Item(org.cdao.jasper.CoordinatePoint has__First__Coordinate__Item) throws JastorException {
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		if (!this.has__First__Coordinate__Item_asCoordinatePoint.contains(has__First__Coordinate__Item))
			return;
		if (!_model.contains(_resource, has__First__Coordinate__ItemProperty, has__First__Coordinate__Item.resource()))
			return;
		this.has__First__Coordinate__Item_asCoordinatePoint.remove(has__First__Coordinate__Item);
		_model.removeAll(_resource, has__First__Coordinate__ItemProperty, has__First__Coordinate__Item.resource());
	}
		
	private void initHas__First__Coordinate__Item_asCoordinateRange() throws JastorException {
		this.has__First__Coordinate__Item_asCoordinateRange = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__First__Coordinate__ItemProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_First_Coordinate_Item properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.CoordinateRange.TYPE)) {
				org.cdao.jasper.CoordinateRange has__First__Coordinate__Item = org.cdao.jasper.CDAOFactory.getCoordinateRange(resource,_model);
				this.has__First__Coordinate__Item_asCoordinateRange.add(has__First__Coordinate__Item);
			}
		}
	}

	public java.util.Iterator getHas__First__Coordinate__Item_asCoordinateRange() throws JastorException {
		if (has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__First__Coordinate__Item_asCoordinateRange,_resource,has__First__Coordinate__ItemProperty,true);
	}

	public void addHas__First__Coordinate__Item(org.cdao.jasper.CoordinateRange has__First__Coordinate__Item) throws JastorException {
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		if (this.has__First__Coordinate__Item_asCoordinateRange.contains(has__First__Coordinate__Item)) {
			this.has__First__Coordinate__Item_asCoordinateRange.remove(has__First__Coordinate__Item);
			this.has__First__Coordinate__Item_asCoordinateRange.add(has__First__Coordinate__Item);
			return;
		}
		this.has__First__Coordinate__Item_asCoordinateRange.add(has__First__Coordinate__Item);
	...
	public org.cdao.jasper.CoordinateRange addHas__First__Coordinate__Item_asCoordinateRange() throws JastorException {
		org.cdao.jasper.CoordinateRange has__First__Coordinate__Item = org.cdao.jasper.CDAOFactory.createCoordinateRange(_model.createResource(),_model);
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		this.has__First__Coordinate__Item_asCoordinateRange.add(has__First__Coordinate__Item);
		_model.add(_model.createStatement(_resource,has__First__Coordinate__ItemProperty,has__First__Coordinate__Item.resource()));
	...
	public org.cdao.jasper.CoordinateRange addHas__First__Coordinate__Item_asCoordinateRange(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CoordinateRange has__First__Coordinate__Item = org.cdao.jasper.CDAOFactory.getCoordinateRange(resource,_model);
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		if (this.has__First__Coordinate__Item_asCoordinateRange.contains(has__First__Coordinate__Item))
	...
	public void removeHas__First__Coordinate__Item(org.cdao.jasper.CoordinateRange has__First__Coordinate__Item) throws JastorException {
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		if (!this.has__First__Coordinate__Item_asCoordinateRange.contains(has__First__Coordinate__Item))
			return;
	...
	private void initHas__Remaining__Coordinate__List() throws JastorException {
		this.has__Remaining__Coordinate__List = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Remaining__Coordinate__ListProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Remaining_Coordinate_List properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.CoordinateList has__Remaining__Coordinate__List = org.cdao.jasper.CDAOFactory.getCoordinateList(resource,_model);
				this.has__Remaining__Coordinate__List.add(has__Remaining__Coordinate__List);
			}
		}
	}

	public java.util.Iterator getHas__Remaining__Coordinate__List() throws JastorException {
		if (has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Remaining__Coordinate__List,_resource,has__Remaining__Coordinate__ListProperty,true);
	}

	public void addHas__Remaining__Coordinate__List(org.cdao.jasper.CoordinateList has__Remaining__Coordinate__List) throws JastorException {
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		if (this.has__Remaining__Coordinate__List.contains(has__Remaining__Coordinate__List)) {
			this.has__Remaining__Coordinate__List.remove(has__Remaining__Coordinate__List);
			this.has__Remaining__Coordinate__List.add(has__Remaining__Coordinate__List);
			return;
		}
		this.has__Remaining__Coordinate__List.add(has__Remaining__Coordinate__List);
		_model.add(_model.createStatement(_resource,has__Remaining__Coordinate__ListProperty,has__Remaining__Coordinate__List.resource()));
	}
	
	public org.cdao.jasper.CoordinateList addHas__Remaining__Coordinate__List() throws JastorException {
		org.cdao.jasper.CoordinateList has__Remaining__Coordinate__List = org.cdao.jasper.CDAOFactory.createCoordinateList(_model.createResource(),_model);
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		this.has__Remaining__Coordinate__List.add(has__Remaining__Coordinate__List);
		_model.add(_model.createStatement(_resource,has__Remaining__Coordinate__ListProperty,has__Remaining__Coordinate__List.resource()));
		return has__Remaining__Coordinate__List;
	}
	
	public org.cdao.jasper.CoordinateList addHas__Remaining__Coordinate__List(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CoordinateList has__Remaining__Coordinate__List = org.cdao.jasper.CDAOFactory.getCoordinateList(resource,_model);
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		if (this.has__Remaining__Coordinate__List.contains(has__Remaining__Coordinate__List))
	...
	public void removeHas__Remaining__Coordinate__List(org.cdao.jasper.CoordinateList has__Remaining__Coordinate__List) throws JastorException {
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		if (!this.has__Remaining__Coordinate__List.contains(has__Remaining__Coordinate__List))
			return;
		if (!_model.contains(_resource, has__Remaining__Coordinate__ListProperty, has__Remaining__Coordinate__List.resource()))
			return;
		this.has__Remaining__Coordinate__List.remove(has__Remaining__Coordinate__List);
		_model.removeAll(_resource, has__Remaining__Coordinate__ListProperty, has__Remaining__Coordinate__List.resource());
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof CoordinateListListener))
			throw new IllegalArgumentException("ThingListener must be instance of CoordinateListListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((CoordinateListListener)listener);
		}
	}
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(has__Coordinate__SystemProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				has__Coordinate__System = null;
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Coordinate__SystemChanged(org.cdao.jasper.CoordinateListImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.CoordinateListImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.CoordinateListImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.CoordinateListImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.CoordinateListImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.hasAdded(org.cdao.jasper.CoordinateListImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.CoordinateListImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.CoordinateListImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.CoordinateListImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.CoordinateListImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.CoordinateListImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.CoordinateListImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.CoordinateListImpl.this,_exclude);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__First__Coordinate__ItemProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CoordinatePoint.TYPE)) {
					org.cdao.jasper.CoordinatePoint _has__First__Coordinate__Item_asCoordinatePoint = null;
					try {
						_has__First__Coordinate__Item_asCoordinatePoint = org.cdao.jasper.CDAOFactory.getCoordinatePoint(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__First__Coordinate__Item_asCoordinatePoint == null) {
					...
					if (!has__First__Coordinate__Item_asCoordinatePoint.contains(_has__First__Coordinate__Item_asCoordinatePoint))
						has__First__Coordinate__Item_asCoordinatePoint.add(_has__First__Coordinate__Item_asCoordinatePoint);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__First__Coordinate__Item_asCoordinatePoint;
						synchronized (listeners) {
							consumersForHas__First__Coordinate__Item_asCoordinatePoint = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinatePoint.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemAdded(org.cdao.jasper.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinatePoint);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CoordinateRange.TYPE)) {
					org.cdao.jasper.CoordinateRange _has__First__Coordinate__Item_asCoordinateRange = null;
					try {
						_has__First__Coordinate__Item_asCoordinateRange = org.cdao.jasper.CDAOFactory.getCoordinateRange(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__First__Coordinate__Item_asCoordinateRange == null) {
					...
					if (!has__First__Coordinate__Item_asCoordinateRange.contains(_has__First__Coordinate__Item_asCoordinateRange))
						has__First__Coordinate__Item_asCoordinateRange.add(_has__First__Coordinate__Item_asCoordinateRange);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__First__Coordinate__Item_asCoordinateRange;
						synchronized (listeners) {
							consumersForHas__First__Coordinate__Item_asCoordinateRange = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinateRange.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemAdded(org.cdao.jasper.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinateRange);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Remaining__Coordinate__ListProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.CoordinateList _has__Remaining__Coordinate__List = null;
					try {
						_has__Remaining__Coordinate__List = org.cdao.jasper.CDAOFactory.getCoordinateList(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Remaining__Coordinate__List == null) {
					...
					if (!has__Remaining__Coordinate__List.contains(_has__Remaining__Coordinate__List))
						has__Remaining__Coordinate__List.add(_has__Remaining__Coordinate__List);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Remaining__Coordinate__List;
						synchronized (listeners) {
							consumersForHas__Remaining__Coordinate__List = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Remaining__Coordinate__List.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__Remaining__Coordinate__ListAdded(org.cdao.jasper.CoordinateListImpl.this,_has__Remaining__Coordinate__List);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__Coordinate__SystemProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
					if (has__Coordinate__System != null && has__Coordinate__System.resource().equals(resource))
						has__Coordinate__System = null;				
				if (listeners != null) {
					java.util.ArrayList consumers;
					synchronized (listeners) {
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.CoordinateListImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.CoordinateListImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.CoordinateListImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.CoordinateListImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.CoordinateListImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.CoordinateListImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.CoordinateListImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.CoordinateListImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.CoordinateListImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.CoordinateListImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.CoordinateListImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.CoordinateListImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__First__Coordinate__ItemProperty)) {
				...
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CoordinatePoint.TYPE)) {
					...
					if (has__First__Coordinate__Item_asCoordinatePoint != null) {
						boolean found = false;
						for (int i=0;i<has__First__Coordinate__Item_asCoordinatePoint.size();i++) {
							org.cdao.jasper.CoordinatePoint __item = (org.cdao.jasper.CoordinatePoint) has__First__Coordinate__Item_asCoordinatePoint.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__First__Coordinate__Item_asCoordinatePoint = __item;
								break;
							}
						}
						if (found)
							has__First__Coordinate__Item_asCoordinatePoint.remove(_has__First__Coordinate__Item_asCoordinatePoint);
						else {
							try {
								_has__First__Coordinate__Item_asCoordinatePoint = org.cdao.jasper.CDAOFactory.getCoordinatePoint(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinatePoint.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemRemoved(org.cdao.jasper.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinatePoint);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CoordinateRange.TYPE)) {
					...
					if (has__First__Coordinate__Item_asCoordinateRange != null) {
						boolean found = false;
						for (int i=0;i<has__First__Coordinate__Item_asCoordinateRange.size();i++) {
							org.cdao.jasper.CoordinateRange __item = (org.cdao.jasper.CoordinateRange) has__First__Coordinate__Item_asCoordinateRange.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__First__Coordinate__Item_asCoordinateRange = __item;
								break;
							}
						}
						if (found)
							has__First__Coordinate__Item_asCoordinateRange.remove(_has__First__Coordinate__Item_asCoordinateRange);
						else {
							try {
								_has__First__Coordinate__Item_asCoordinateRange = org.cdao.jasper.CDAOFactory.getCoordinateRange(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinateRange.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemRemoved(org.cdao.jasper.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinateRange);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Remaining__Coordinate__ListProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Remaining__Coordinate__List != null) {
						boolean found = false;
						for (int i=0;i<has__Remaining__Coordinate__List.size();i++) {
							org.cdao.jasper.CoordinateList __item = (org.cdao.jasper.CoordinateList) has__Remaining__Coordinate__List.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Remaining__Coordinate__List = __item;
								break;
							}
						}
						if (found)
							has__Remaining__Coordinate__List.remove(_has__Remaining__Coordinate__List);
						else {
							try {
								_has__Remaining__Coordinate__List = org.cdao.jasper.CDAOFactory.getCoordinateList(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Remaining__Coordinate__List.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__Remaining__Coordinate__ListRemoved(org.cdao.jasper.CoordinateListImpl.this,_has__Remaining__Coordinate__List);
						}
					}
				}
				return;
