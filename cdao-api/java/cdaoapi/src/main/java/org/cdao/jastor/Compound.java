 ...
 * <br>
 */
public interface Compound extends org.cdao.jastor.Categorical, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#Compound");
