...
/**
 * Interface for CategoricalCharacter ontology class<br>
 ...
 * 	description : Class describing a discrete character <br>
 * <br>
 */
public interface CategoricalCharacter extends org.cdao.jastor.Character, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#CategoricalCharacter");
