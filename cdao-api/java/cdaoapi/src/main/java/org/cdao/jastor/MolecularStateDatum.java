...
/**
 * Interface for MolecularStateDatum ontology class<br>
 ...
 * 	description : Instance of a character for a given TU, in the case of a molecular character <br>
 * <br>
 */
public interface MolecularStateDatum extends org.cdao.jastor.CategoricalStateDatum, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#MolecularStateDatum");
