 ...
 * <br>
 */
public interface DesoxiRibonucleotideResidue extends org.cdao.jastor.Molecular, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#DesoxiRibonucleotideResidue");
	...
	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#dC
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dC = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#dC");


	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#dG
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dG = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#dG");


	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#dT
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dT = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#dT");


	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#dA
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dA = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#dA");
