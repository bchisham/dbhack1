...
/**
 * Implementation of {@link org.cdao.jastor.DistanceMatrixBasedMethod}
 * Use the org.cdao.jasper.CDAOFactory to create instances of this class.
 * <p>(URI: http://localhost/~vivek/cdao.owl#DistanceMatrixBasedMethod)</p>
 * <br>
 */
public class DistanceMatrixBasedMethodImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.DistanceMatrixBasedMethod {
	...
	DistanceMatrixBasedMethodImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static DistanceMatrixBasedMethodImpl getDistanceMatrixBasedMethod(Resource resource, Model model) throws JastorException {
		return new DistanceMatrixBasedMethodImpl(resource, model);
	}
	    
	static DistanceMatrixBasedMethodImpl createDistanceMatrixBasedMethod(Resource resource, Model model) throws JastorException { 
		DistanceMatrixBasedMethodImpl impl = new DistanceMatrixBasedMethodImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, DistanceMatrixBasedMethod.TYPE)))
			impl._model.add(impl._resource, RDF.type, DistanceMatrixBasedMethod.TYPE);
		impl.addSuperTypes();
	...
	void addSuperTypes() {
		...
		if (!_model.contains(_resource, RDF.type, org.cdao.jastor.TreeAnnotation.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jastor.TreeAnnotation.TYPE));     
		if (!_model.contains(_resource, RDF.type, org.cdao.jastor.TreeProcedure.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jastor.TreeProcedure.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.DistanceMatrixBasedMethod.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.TreeAnnotation.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.TreeProcedure.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initIs__annotation__of() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#is_annotation_of properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
	...
	private void initIs__annotation__of_asTree() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#is_annotation_of properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Tree.TYPE)) {
				org.cdao.jastor.Tree is__annotation__of = org.cdao.jastor.CDAOFactory.getTree(resource,_model);
	...
	public void addIs__annotation__of(org.cdao.jastor.Tree is__annotation__of) throws JastorException {
	...
	public org.cdao.jastor.Tree addIs__annotation__of_asTree() throws JastorException {
		org.cdao.jastor.Tree is__annotation__of = org.cdao.jastor.CDAOFactory.createTree(_model.createResource(),_model);
		if (this.is__annotation__of_asTree == null)
			initIs__annotation__of_asTree();
		this.is__annotation__of_asTree.add(is__annotation__of);
		_model.add(_model.createStatement(_resource,is__annotation__ofProperty,is__annotation__of.resource()));
	...
	public org.cdao.jastor.Tree addIs__annotation__of_asTree(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Tree is__annotation__of = org.cdao.jastor.CDAOFactory.getTree(resource,_model);
		if (this.is__annotation__of_asTree == null)
			initIs__annotation__of_asTree();
		if (this.is__annotation__of_asTree.contains(is__annotation__of))
	...
	public void removeIs__annotation__of(org.cdao.jastor.Tree is__annotation__of) throws JastorException {
		if (this.is__annotation__of_asTree == null)
			initIs__annotation__of_asTree();
		if (!this.is__annotation__of_asTree.contains(is__annotation__of))
			return;
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in DistanceMatrixBasedMethod model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in DistanceMatrixBasedMethod model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof DistanceMatrixBasedMethodListener))
			throw new IllegalArgumentException("ThingListener must be instance of DistanceMatrixBasedMethodListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((DistanceMatrixBasedMethodListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.is__annotation__ofAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_is__annotation__of);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Tree.TYPE)) {
					org.cdao.jastor.Tree _is__annotation__of_asTree = null;
					try {
						_is__annotation__of_asTree = org.cdao.jastor.CDAOFactory.getTree(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (is__annotation__of_asTree == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of_asTree.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.is__annotation__ofAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_is__annotation__of_asTree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.hasAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,literal);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(is__annotation__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.is__annotation__ofRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_is__annotation__of);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Tree.TYPE)) {
					...
					if (is__annotation__of_asTree != null) {
						...
						for (int i=0;i<is__annotation__of_asTree.size();i++) {
							org.cdao.jastor.Tree __item = (org.cdao.jastor.Tree) is__annotation__of_asTree.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of_asTree.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.is__annotation__ofRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_is__annotation__of_asTree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						DistanceMatrixBasedMethodListener listener=(DistanceMatrixBasedMethodListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.DistanceMatrixBasedMethodImpl.this,literal);
					}
				}
				return;
			}
