 ...
 * <br>
 */
public interface CoordinateRange extends org.cdao.jastor.DatumCoordinate, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#CoordinateRange");
	

	/**
	 * The Jena Property for has__Range__End__Value 
	 * <p>(URI: http://localhost/~vivek/cdao.owl#has_Range_End_Value)</p>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__Range__End__ValueProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Range_End_Value");


	/**
	 * The Jena Property for has__Range__Start__Value 
	 * <p>(URI: http://localhost/~vivek/cdao.owl#has_Range_Start_Value)</p>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__Range__Start__ValueProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Range_Start_Value");
