...
/**
 * Interface for Character ontology class<br>
 ...
 * 	description : Traits shown to be relevant for phylogenetic classification <br>
 * <br>
 */
public interface Character extends com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#Character");
