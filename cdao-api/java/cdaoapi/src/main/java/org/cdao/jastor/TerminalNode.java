...
/**
 * Interface for TerminalNode ontology class<br>
 ...
 * 	description : A node that has not descendants in the tree; it typically represents an OTU <br>
 * <br>
 */
public interface TerminalNode extends org.cdao.jastor.Node, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#TerminalNode");
