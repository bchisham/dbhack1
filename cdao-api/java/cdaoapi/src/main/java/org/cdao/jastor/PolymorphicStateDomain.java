 ...
 * <br>
 */
public interface PolymorphicStateDomain extends org.cdao.jastor.CharacterStateDomain, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#PolymorphicStateDomain");
