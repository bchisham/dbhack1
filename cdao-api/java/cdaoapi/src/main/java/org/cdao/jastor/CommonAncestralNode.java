 ...
 * 	description : A node in the tree that is the ancestor of  descendants along different branches <br>
 * <br>
 */
public interface CommonAncestralNode extends org.cdao.jastor.AncestralNode, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#CommonAncestralNode");
