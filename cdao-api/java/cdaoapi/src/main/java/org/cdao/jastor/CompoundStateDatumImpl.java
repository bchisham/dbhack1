...
/**
 * Implementation of {@link org.cdao.jastor.CompoundStateDatum}
 ...
 * <br>
 */
public class CompoundStateDatumImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.CompoundStateDatum {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Compound__StateProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Compound_State");
	...
	private static com.hp.hpl.jena.rdf.model.Property belongs__to__Compound__CharacterProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#belongs_to_Compound_Character");
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.CompoundStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHas__Coordinate() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Coordinate properties in CompoundStateDatum model not a Resource", stmt.getObject());
	...
	public org.cdao.jastor.TU getBelongs__to__TU() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__TU getProperty() in org.cdao.jasper.CompoundStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__State() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_State properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jastor.Character getBelongs__to__Character() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Character getProperty() in org.cdao.jasper.CompoundStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHomologous__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#homologous_to properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Compound__State_asCompound() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Compound_State properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Compound.TYPE)) {
				org.cdao.jastor.Compound has__Compound__State = org.cdao.jastor.CDAOFactory.getCompound(resource,_model);
	...
	public void addHas__Compound__State(org.cdao.jastor.Compound has__Compound__State) throws JastorException {
	...
	public org.cdao.jastor.Compound addHas__Compound__State_asCompound() throws JastorException {
		org.cdao.jastor.Compound has__Compound__State = org.cdao.jastor.CDAOFactory.createCompound(_model.createResource(),_model);
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		this.has__Compound__State_asCompound.add(has__Compound__State);
		_model.add(_model.createStatement(_resource,has__Compound__StateProperty,has__Compound__State.resource()));
	...
	public org.cdao.jastor.Compound addHas__Compound__State_asCompound(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Compound has__Compound__State = org.cdao.jastor.CDAOFactory.getCompound(resource,_model);
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		if (this.has__Compound__State_asCompound.contains(has__Compound__State))
	...
	public void removeHas__Compound__State(org.cdao.jastor.Compound has__Compound__State) throws JastorException {
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		if (!this.has__Compound__State_asCompound.contains(has__Compound__State))
			return;
	...
	private void initHas__Compound__State_asGeneric__State() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
				org.cdao.jastor.Generic__State has__Compound__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
	...
	public void addHas__Compound__State(org.cdao.jastor.Generic__State has__Compound__State) throws JastorException {
	...
	public org.cdao.jastor.Generic__State addHas__Compound__State_asGeneric__State() throws JastorException {
		org.cdao.jastor.Generic__State has__Compound__State = org.cdao.jastor.CDAOFactory.createGeneric__State(_model.createResource(),_model);
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		this.has__Compound__State_asGeneric__State.add(has__Compound__State);
		_model.add(_model.createStatement(_resource,has__Compound__StateProperty,has__Compound__State.resource()));
	...
	public org.cdao.jastor.Generic__State addHas__Compound__State_asGeneric__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Generic__State has__Compound__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		if (this.has__Compound__State_asGeneric__State.contains(has__Compound__State))
	...
	public void removeHas__Compound__State(org.cdao.jastor.Generic__State has__Compound__State) throws JastorException {
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		if (!this.has__Compound__State_asGeneric__State.contains(has__Compound__State))
			return;
	...
	private void initBelongs__to__Compound__Character() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to_Compound_Character properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.CompoundCharacter belongs__to__Compound__Character = org.cdao.jastor.CDAOFactory.getCompoundCharacter(resource,_model);
	...
	public void addBelongs__to__Compound__Character(org.cdao.jastor.CompoundCharacter belongs__to__Compound__Character) throws JastorException {
	...
	public org.cdao.jastor.CompoundCharacter addBelongs__to__Compound__Character() throws JastorException {
		org.cdao.jastor.CompoundCharacter belongs__to__Compound__Character = org.cdao.jastor.CDAOFactory.createCompoundCharacter(_model.createResource(),_model);
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		this.belongs__to__Compound__Character.add(belongs__to__Compound__Character);
		_model.add(_model.createStatement(_resource,belongs__to__Compound__CharacterProperty,belongs__to__Compound__Character.resource()));
	...
	public org.cdao.jastor.CompoundCharacter addBelongs__to__Compound__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CompoundCharacter belongs__to__Compound__Character = org.cdao.jastor.CDAOFactory.getCompoundCharacter(resource,_model);
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		if (this.belongs__to__Compound__Character.contains(belongs__to__Compound__Character))
	...
	public void removeBelongs__to__Compound__Character(org.cdao.jastor.CompoundCharacter belongs__to__Compound__Character) throws JastorException {
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		if (!this.belongs__to__Compound__Character.contains(belongs__to__Compound__Character))
			return;
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							...
							listener.has__CoordinateAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__TUProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.belongs__to__TUChanged(org.cdao.jastor.CompoundStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__StateAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.belongs__to__CharacterChanged(org.cdao.jastor.CompoundStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.homologous__toAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.CompoundStateDatumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.hasAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Compound__StateProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Compound.TYPE)) {
					org.cdao.jastor.Compound _has__Compound__State_asCompound = null;
					try {
						_has__Compound__State_asCompound = org.cdao.jastor.CDAOFactory.getCompound(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Compound__State_asCompound == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__State_asCompound.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Compound__State_asCompound);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
					org.cdao.jastor.Generic__State _has__Compound__State_asGeneric__State = null;
					try {
						_has__Compound__State_asGeneric__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Compound__State_asGeneric__State == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__State_asGeneric__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Compound__State_asGeneric__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Compound__CharacterProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.CompoundCharacter _belongs__to__Compound__Character = null;
					try {
						_belongs__to__Compound__Character = org.cdao.jastor.CDAOFactory.getCompoundCharacter(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (belongs__to__Compound__Character == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Compound__Character.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__to__Compound__CharacterAdded(org.cdao.jastor.CompoundStateDatumImpl.this,_belongs__to__Compound__Character);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__CoordinateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__CoordinateRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__StateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__StateRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(homologous__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.homologous__toRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Compound.TYPE)) {
					...
					if (has__Compound__State_asCompound != null) {
						...
						for (int i=0;i<has__Compound__State_asCompound.size();i++) {
							org.cdao.jastor.Compound __item = (org.cdao.jastor.Compound) has__Compound__State_asCompound.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__State_asCompound.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Compound__State_asCompound);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
					...
					if (has__Compound__State_asGeneric__State != null) {
						...
						for (int i=0;i<has__Compound__State_asGeneric__State.size();i++) {
							org.cdao.jastor.Generic__State __item = (org.cdao.jastor.Generic__State) has__Compound__State_asGeneric__State.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__State_asGeneric__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_has__Compound__State_asGeneric__State);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (belongs__to__Compound__Character != null) {
						...
						for (int i=0;i<belongs__to__Compound__Character.size();i++) {
							org.cdao.jastor.CompoundCharacter __item = (org.cdao.jastor.CompoundCharacter) belongs__to__Compound__Character.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Compound__Character.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__to__Compound__CharacterRemoved(org.cdao.jastor.CompoundStateDatumImpl.this,_belongs__to__Compound__Character);
						}
					}
				}
				return;
