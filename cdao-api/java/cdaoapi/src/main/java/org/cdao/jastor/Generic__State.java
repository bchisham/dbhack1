 ...
 * <br>
 */
public interface Generic__State extends org.cdao.jastor.Categorical, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#Generic_State");
	...
	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#absent
	 */
	public static com.hp.hpl.jena.rdf.model.Resource absent = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#absent");


	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#unknown
	 */
	public static com.hp.hpl.jena.rdf.model.Resource unknown = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#unknown");


	/**
	 * Individual for URI: http://localhost/~vivek/cdao.owl#gap
	 */
	public static com.hp.hpl.jena.rdf.model.Resource gap = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#gap");
