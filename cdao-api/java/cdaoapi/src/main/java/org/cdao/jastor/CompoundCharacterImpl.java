...
/**
 * Implementation of {@link org.cdao.jastor.CompoundCharacter}
 * Use the org.cdao.jasper.CDAOFactory to create instances of this class.
 * <p>(URI: http://localhost/~vivek/cdao.owl#CompoundCharacter)</p>
 * <br>
 */
public class CompoundCharacterImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.CompoundCharacter {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.CompoundCharacter.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHas__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Datum properties in CompoundCharacter model not a Resource", stmt.getObject());
	...
	private void initHas__Datum_asCompoundStateDatum() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Datum properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.CompoundStateDatum.TYPE)) {
				org.cdao.jastor.CompoundStateDatum has__Datum = org.cdao.jastor.CDAOFactory.getCompoundStateDatum(resource,_model);
	...
	public void addHas__Datum(org.cdao.jastor.CompoundStateDatum has__Datum) throws JastorException {
	...
	public org.cdao.jastor.CompoundStateDatum addHas__Datum_asCompoundStateDatum() throws JastorException {
		org.cdao.jastor.CompoundStateDatum has__Datum = org.cdao.jastor.CDAOFactory.createCompoundStateDatum(_model.createResource(),_model);
		if (this.has__Datum_asCompoundStateDatum == null)
			initHas__Datum_asCompoundStateDatum();
		this.has__Datum_asCompoundStateDatum.add(has__Datum);
		_model.add(_model.createStatement(_resource,has__DatumProperty,has__Datum.resource()));
	...
	public org.cdao.jastor.CompoundStateDatum addHas__Datum_asCompoundStateDatum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CompoundStateDatum has__Datum = org.cdao.jastor.CDAOFactory.getCompoundStateDatum(resource,_model);
		if (this.has__Datum_asCompoundStateDatum == null)
			initHas__Datum_asCompoundStateDatum();
		if (this.has__Datum_asCompoundStateDatum.contains(has__Datum))
	...
	public void removeHas__Datum(org.cdao.jastor.CompoundStateDatum has__Datum) throws JastorException {
		if (this.has__Datum_asCompoundStateDatum == null)
			initHas__Datum_asCompoundStateDatum();
		if (!this.has__Datum_asCompoundStateDatum.contains(has__Datum))
			return;
	...
	private void initBelongs__to__Character__State__Data__Matrix() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to_Character_State_Data_Matrix properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in CompoundCharacter model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in CompoundCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in CompoundCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in CompoundCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in CompoundCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in CompoundCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in CompoundCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Compound__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Compound_Datum properties in CompoundCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							...
							listener.has__DatumAdded(org.cdao.jastor.CompoundCharacterImpl.this,_has__Datum);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CompoundStateDatum.TYPE)) {
					org.cdao.jastor.CompoundStateDatum _has__Datum_asCompoundStateDatum = null;
					try {
						_has__Datum_asCompoundStateDatum = org.cdao.jastor.CDAOFactory.getCompoundStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Datum_asCompoundStateDatum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum_asCompoundStateDatum.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__DatumAdded(org.cdao.jastor.CompoundCharacterImpl.this,_has__Datum_asCompoundStateDatum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixAdded(org.cdao.jastor.CompoundCharacterImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.CompoundCharacterImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.CompoundCharacterImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.CompoundCharacterImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.CompoundCharacterImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.hasAdded(org.cdao.jastor.CompoundCharacterImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.CompoundCharacterImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.CompoundCharacterImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__Datum.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__Compound__DatumAdded(org.cdao.jastor.CompoundCharacterImpl.this,_has__Compound__Datum);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_has__Datum);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CompoundStateDatum.TYPE)) {
					...
					if (has__Datum_asCompoundStateDatum != null) {
						...
						for (int i=0;i<has__Datum_asCompoundStateDatum.size();i++) {
							org.cdao.jastor.CompoundStateDatum __item = (org.cdao.jastor.CompoundStateDatum) has__Datum_asCompoundStateDatum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum_asCompoundStateDatum.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_has__Datum_asCompoundStateDatum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Character__State__Data__MatrixProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.CompoundCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.CompoundCharacterImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Compound__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__Datum.iterator();iter.hasNext();){
							CompoundCharacterListener listener=(CompoundCharacterListener)iter.next();
							listener.has__Compound__DatumRemoved(org.cdao.jastor.CompoundCharacterImpl.this,_has__Compound__Datum);
						}
					}
				}
				return;
