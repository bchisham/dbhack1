 ...
 * <br>
 */
public interface RibonucleotideResidueCharacter extends org.cdao.jastor.MolecularCharacter, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#RibonucleotideResidueCharacter");
	 ...
	 * @return		{@link java.util.Iterator} of {@link org.cdao.jastor.RibonucleotideResidueStateDatum}
	 ...
	 * @param		The {@link org.cdao.jastor.RibonucleotideResidueStateDatum} to add
	 * @see			#has__DatumProperty
	 */
	public void addHas__Datum(org.cdao.jastor.RibonucleotideResidueStateDatum has__Datum) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has__Datum' property
	 * @return		The anoymous {@link org.cdao.jastor.RibonucleotideResidueStateDatum} created
	 * @see			#has__DatumProperty
	 */
	public org.cdao.jastor.RibonucleotideResidueStateDatum addHas__Datum_asRibonucleotideResidueStateDatum() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * 
	 * The resource argument have rdf:type http://localhost/~vivek/cdao.owl#RibonucleotideResidueStateDatum.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		The {@link om.hp.hpl.jena.rdf.model.Resource} to add
	 * @see			#has__DatumProperty
	 */
	public org.cdao.jastor.RibonucleotideResidueStateDatum addHas__Datum_asRibonucleotideResidueStateDatum(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has__Datum' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link org.cdao.jastor.RibonucleotideResidueStateDatum} to remove
	 * @see			#has__DatumProperty
	 */
	public void removeHas__Datum(org.cdao.jastor.RibonucleotideResidueStateDatum has__Datum) throws com.ibm.adtech.jastor.JastorException;
