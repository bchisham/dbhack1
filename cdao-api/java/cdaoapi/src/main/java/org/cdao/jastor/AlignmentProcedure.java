...
/**
 * Interface for AlignmentProcedure ontology class<br>
 ...
 * 	description : Algorithm employed to derive the character state data matrix <br>
 * <br>
 */
public interface AlignmentProcedure extends org.cdao.jastor.CharacterStateDataMatrixAnnotation, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#AlignmentProcedure");
