...
/**
 * Implementation of {@link org.cdao.jastor.CharacterStateDataMatrix}
 * Use the org.cdao.jasper.CDAOFactory to create instances of this class.
 * <p>(URI: http://localhost/~vivek/cdao.owl#CharacterStateDataMatrix)</p>
 * <br>
 */
public class CharacterStateDataMatrixImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.CharacterStateDataMatrix {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__TUProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_TU");
	private java.util.ArrayList has__TU;
	private static com.hp.hpl.jena.rdf.model.Property has__CharacterProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Character");
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.CharacterStateDataMatrix.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
	...
	private void initHas_asCharacterStateDataMatrixAnnotation() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.CharacterStateDataMatrixAnnotation.TYPE)) {
				org.cdao.jastor.CharacterStateDataMatrixAnnotation has = org.cdao.jastor.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
	...
	public void addHas(org.cdao.jastor.CharacterStateDataMatrixAnnotation has) throws JastorException {
	...
	public org.cdao.jastor.CharacterStateDataMatrixAnnotation addHas_asCharacterStateDataMatrixAnnotation() throws JastorException {
		org.cdao.jastor.CharacterStateDataMatrixAnnotation has = org.cdao.jastor.CDAOFactory.createCharacterStateDataMatrixAnnotation(_model.createResource(),_model);
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		this.has_asCharacterStateDataMatrixAnnotation.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jastor.CharacterStateDataMatrixAnnotation addHas_asCharacterStateDataMatrixAnnotation(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CharacterStateDataMatrixAnnotation has = org.cdao.jastor.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		if (this.has_asCharacterStateDataMatrixAnnotation.contains(has))
	...
	public void removeHas(org.cdao.jastor.CharacterStateDataMatrixAnnotation has) throws JastorException {
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		if (!this.has_asCharacterStateDataMatrixAnnotation.contains(has))
			return;
	...
	private void initHas__TU() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_TU properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.TU has__TU = org.cdao.jastor.CDAOFactory.getTU(resource,_model);
	...
	public void addHas__TU(org.cdao.jastor.TU has__TU) throws JastorException {
	...
	public org.cdao.jastor.TU addHas__TU() throws JastorException {
		org.cdao.jastor.TU has__TU = org.cdao.jastor.CDAOFactory.createTU(_model.createResource(),_model);
		if (this.has__TU == null)
			initHas__TU();
		this.has__TU.add(has__TU);
		_model.add(_model.createStatement(_resource,has__TUProperty,has__TU.resource()));
	...
	public org.cdao.jastor.TU addHas__TU(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.TU has__TU = org.cdao.jastor.CDAOFactory.getTU(resource,_model);
		if (this.has__TU == null)
			initHas__TU();
		if (this.has__TU.contains(has__TU))
	...
	public void removeHas__TU(org.cdao.jastor.TU has__TU) throws JastorException {
		if (this.has__TU == null)
			initHas__TU();
		if (!this.has__TU.contains(has__TU))
			return;
	...
	private void initHas__Character() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Character properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.Character has__Character = org.cdao.jastor.CDAOFactory.getCharacter(resource,_model);
	...
	public void addHas__Character(org.cdao.jastor.Character has__Character) throws JastorException {
	...
	public org.cdao.jastor.Character addHas__Character() throws JastorException {
		org.cdao.jastor.Character has__Character = org.cdao.jastor.CDAOFactory.createCharacter(_model.createResource(),_model);
		if (this.has__Character == null)
			initHas__Character();
		this.has__Character.add(has__Character);
		_model.add(_model.createStatement(_resource,has__CharacterProperty,has__Character.resource()));
	...
	public org.cdao.jastor.Character addHas__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Character has__Character = org.cdao.jastor.CDAOFactory.getCharacter(resource,_model);
		if (this.has__Character == null)
			initHas__Character();
		if (this.has__Character.contains(has__Character))
	...
	public void removeHas__Character(org.cdao.jastor.Character has__Character) throws JastorException {
		if (this.has__Character == null)
			initHas__Character();
		if (!this.has__Character.contains(has__Character))
			return;
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							...
							listener.hasAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CharacterStateDataMatrixAnnotation.TYPE)) {
					org.cdao.jastor.CharacterStateDataMatrixAnnotation _has_asCharacterStateDataMatrixAnnotation = null;
					try {
						_has_asCharacterStateDataMatrixAnnotation = org.cdao.jastor.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asCharacterStateDataMatrixAnnotation == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asCharacterStateDataMatrixAnnotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has_asCharacterStateDataMatrixAnnotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TUProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.TU _has__TU = null;
					try {
						_has__TU = org.cdao.jastor.CDAOFactory.getTU(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__TU == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__TU.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__TUAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has__TU);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__CharacterProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.Character _has__Character = null;
					try {
						_has__Character = org.cdao.jastor.CDAOFactory.getCharacter(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Character == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Character.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__CharacterAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has__Character);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_precedes);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CharacterStateDataMatrixAnnotation.TYPE)) {
					...
					if (has_asCharacterStateDataMatrixAnnotation != null) {
						...
						for (int i=0;i<has_asCharacterStateDataMatrixAnnotation.size();i++) {
							org.cdao.jastor.CharacterStateDataMatrixAnnotation __item = (org.cdao.jastor.CharacterStateDataMatrixAnnotation) has_asCharacterStateDataMatrixAnnotation.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asCharacterStateDataMatrixAnnotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has_asCharacterStateDataMatrixAnnotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__TU != null) {
						...
						for (int i=0;i<has__TU.size();i++) {
							org.cdao.jastor.TU __item = (org.cdao.jastor.TU) has__TU.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__TU = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__TU.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__TURemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has__TU);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Character != null) {
						...
						for (int i=0;i<has__Character.size();i++) {
							org.cdao.jastor.Character __item = (org.cdao.jastor.Character) has__Character.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Character.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__CharacterRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has__Character);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.CharacterStateDataMatrixImpl.this,_precedes);
						}
					}
				}
				return;
