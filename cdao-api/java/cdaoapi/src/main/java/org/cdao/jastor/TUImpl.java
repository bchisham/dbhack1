...
/**
 * Implementation of {@link org.cdao.jastor.TU}
 * Use the org.cdao.jasper.CDAOFactory to create instances of this class.
 * <p>(URI: http://localhost/~vivek/cdao.owl#TU)</p>
 * <br>
 */
public class TUImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.TU {
	...
	private static com.hp.hpl.jena.rdf.model.Property represented__by__NodeProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#represented_by_Node");
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Nucleotide__DatumProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Nucleotide_Datum");
	private java.util.ArrayList has__Nucleotide__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__Continuous__DatumProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Continuous_Datum");
	private java.util.ArrayList has__Continuous__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__Standard__DatumProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Standard_Datum");
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Compound__DatumProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Compound_Datum");
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.TU.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in TU model not a Literal", stmt.getObject());
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in TU model not a Resource", stmt.getObject());
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initRepresented__by__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#represented_by_Node properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.Node represented__by__Node = org.cdao.jastor.CDAOFactory.getNode(resource,_model);
	...
	public void addRepresented__by__Node(org.cdao.jastor.Node represented__by__Node) throws JastorException {
	...
	public org.cdao.jastor.Node addRepresented__by__Node() throws JastorException {
		org.cdao.jastor.Node represented__by__Node = org.cdao.jastor.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		this.represented__by__Node.add(represented__by__Node);
		_model.add(_model.createStatement(_resource,represented__by__NodeProperty,represented__by__Node.resource()));
	...
	public org.cdao.jastor.Node addRepresented__by__Node(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Node represented__by__Node = org.cdao.jastor.CDAOFactory.getNode(resource,_model);
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		if (this.represented__by__Node.contains(represented__by__Node))
	...
	public void removeRepresented__by__Node(org.cdao.jastor.Node represented__by__Node) throws JastorException {
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		if (!this.represented__by__Node.contains(represented__by__Node))
			return;
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Molecular__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Molecular_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Nucleotide__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Nucleotide_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
	...
	public void addHas__Nucleotide__Datum(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum) throws JastorException {
	...
	public org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum addHas__Nucleotide__Datum() throws JastorException {
		org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum = org.cdao.jastor.CDAOFactory.createDesoxiRibonucleotideResidueStateDatum(_model.createResource(),_model);
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		this.has__Nucleotide__Datum.add(has__Nucleotide__Datum);
		_model.add(_model.createStatement(_resource,has__Nucleotide__DatumProperty,has__Nucleotide__Datum.resource()));
	...
	public org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum addHas__Nucleotide__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		if (this.has__Nucleotide__Datum.contains(has__Nucleotide__Datum))
	...
	public void removeHas__Nucleotide__Datum(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum) throws JastorException {
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		if (!this.has__Nucleotide__Datum.contains(has__Nucleotide__Datum))
			return;
	...
	private void initHas__Continuous__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Continuous_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.ContinuousStateDatum has__Continuous__Datum = org.cdao.jastor.CDAOFactory.getContinuousStateDatum(resource,_model);
	...
	public void addHas__Continuous__Datum(org.cdao.jastor.ContinuousStateDatum has__Continuous__Datum) throws JastorException {
	...
	public org.cdao.jastor.ContinuousStateDatum addHas__Continuous__Datum() throws JastorException {
		org.cdao.jastor.ContinuousStateDatum has__Continuous__Datum = org.cdao.jastor.CDAOFactory.createContinuousStateDatum(_model.createResource(),_model);
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		this.has__Continuous__Datum.add(has__Continuous__Datum);
		_model.add(_model.createStatement(_resource,has__Continuous__DatumProperty,has__Continuous__Datum.resource()));
	...
	public org.cdao.jastor.ContinuousStateDatum addHas__Continuous__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.ContinuousStateDatum has__Continuous__Datum = org.cdao.jastor.CDAOFactory.getContinuousStateDatum(resource,_model);
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		if (this.has__Continuous__Datum.contains(has__Continuous__Datum))
	...
	public void removeHas__Continuous__Datum(org.cdao.jastor.ContinuousStateDatum has__Continuous__Datum) throws JastorException {
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		if (!this.has__Continuous__Datum.contains(has__Continuous__Datum))
			return;
	...
	private void initHas__Standard__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Standard_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.StandardStateDatum has__Standard__Datum = org.cdao.jastor.CDAOFactory.getStandardStateDatum(resource,_model);
	...
	public void addHas__Standard__Datum(org.cdao.jastor.StandardStateDatum has__Standard__Datum) throws JastorException {
	...
	public org.cdao.jastor.StandardStateDatum addHas__Standard__Datum() throws JastorException {
		org.cdao.jastor.StandardStateDatum has__Standard__Datum = org.cdao.jastor.CDAOFactory.createStandardStateDatum(_model.createResource(),_model);
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		this.has__Standard__Datum.add(has__Standard__Datum);
		_model.add(_model.createStatement(_resource,has__Standard__DatumProperty,has__Standard__Datum.resource()));
	...
	public org.cdao.jastor.StandardStateDatum addHas__Standard__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.StandardStateDatum has__Standard__Datum = org.cdao.jastor.CDAOFactory.getStandardStateDatum(resource,_model);
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		if (this.has__Standard__Datum.contains(has__Standard__Datum))
	...
	public void removeHas__Standard__Datum(org.cdao.jastor.StandardStateDatum has__Standard__Datum) throws JastorException {
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		if (!this.has__Standard__Datum.contains(has__Standard__Datum))
			return;
	...
	private void initHas__Amino__Acid__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Amino_Acid_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to__Character__State__Data__Matrix() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to_Character_State_Data_Matrix properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Compound__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Compound_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.CompoundStateDatum has__Compound__Datum = org.cdao.jastor.CDAOFactory.getCompoundStateDatum(resource,_model);
	...
	public void addHas__Compound__Datum(org.cdao.jastor.CompoundStateDatum has__Compound__Datum) throws JastorException {
	...
	public org.cdao.jastor.CompoundStateDatum addHas__Compound__Datum() throws JastorException {
		org.cdao.jastor.CompoundStateDatum has__Compound__Datum = org.cdao.jastor.CDAOFactory.createCompoundStateDatum(_model.createResource(),_model);
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		this.has__Compound__Datum.add(has__Compound__Datum);
		_model.add(_model.createStatement(_resource,has__Compound__DatumProperty,has__Compound__Datum.resource()));
	...
	public org.cdao.jastor.CompoundStateDatum addHas__Compound__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CompoundStateDatum has__Compound__Datum = org.cdao.jastor.CDAOFactory.getCompoundStateDatum(resource,_model);
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		if (this.has__Compound__Datum.contains(has__Compound__Datum))
	...
	public void removeHas__Compound__Datum(org.cdao.jastor.CompoundStateDatum has__Compound__Datum) throws JastorException {
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		if (!this.has__Compound__Datum.contains(has__Compound__Datum))
			return;
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						...
						listener.has__Support__ValueAdded(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.TUImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.TUImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.TUImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.TUImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(represented__by__NodeProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.Node _represented__by__Node = null;
					try {
						_represented__by__Node = org.cdao.jastor.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (represented__by__Node == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRepresented__by__Node.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.represented__by__NodeAdded(org.cdao.jastor.TUImpl.this,_represented__by__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.TUImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.hasAdded(org.cdao.jastor.TUImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.TUImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.TUImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.TUImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Molecular__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Molecular__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Molecular__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Nucleotide__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum _has__Nucleotide__Datum = null;
					try {
						_has__Nucleotide__Datum = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Nucleotide__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Nucleotide__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Nucleotide__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Continuous__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.ContinuousStateDatum _has__Continuous__Datum = null;
					try {
						_has__Continuous__Datum = org.cdao.jastor.CDAOFactory.getContinuousStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Continuous__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Continuous__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Continuous__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Continuous__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Standard__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.StandardStateDatum _has__Standard__Datum = null;
					try {
						_has__Standard__Datum = org.cdao.jastor.CDAOFactory.getStandardStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Standard__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Standard__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Standard__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Standard__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Amino__Acid__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Amino__Acid__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixAdded(org.cdao.jastor.TUImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Compound__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.CompoundStateDatum _has__Compound__Datum = null;
					try {
						_has__Compound__Datum = org.cdao.jastor.CDAOFactory.getCompoundStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Compound__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Compound__DatumAdded(org.cdao.jastor.TUImpl.this,_has__Compound__Datum);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.TUImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.TUImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.TUImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.TUImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (represented__by__Node != null) {
						...
						for (int i=0;i<represented__by__Node.size();i++) {
							org.cdao.jastor.Node __item = (org.cdao.jastor.Node) represented__by__Node.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRepresented__by__Node.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.represented__by__NodeRemoved(org.cdao.jastor.TUImpl.this,_represented__by__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.TUImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.TUImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.TUImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.TUImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.TUImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Molecular__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Molecular__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Molecular__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Molecular__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Nucleotide__Datum != null) {
						...
						for (int i=0;i<has__Nucleotide__Datum.size();i++) {
							org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum __item = (org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum) has__Nucleotide__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Nucleotide__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Nucleotide__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Continuous__Datum != null) {
						...
						for (int i=0;i<has__Continuous__Datum.size();i++) {
							org.cdao.jastor.ContinuousStateDatum __item = (org.cdao.jastor.ContinuousStateDatum) has__Continuous__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Continuous__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Continuous__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Continuous__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Standard__Datum != null) {
						...
						for (int i=0;i<has__Standard__Datum.size();i++) {
							org.cdao.jastor.StandardStateDatum __item = (org.cdao.jastor.StandardStateDatum) has__Standard__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Standard__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Standard__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Standard__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Amino__Acid__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Amino__Acid__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Amino__Acid__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Character__State__Data__MatrixProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixRemoved(org.cdao.jastor.TUImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Compound__Datum != null) {
						...
						for (int i=0;i<has__Compound__Datum.size();i++) {
							org.cdao.jastor.CompoundStateDatum __item = (org.cdao.jastor.CompoundStateDatum) has__Compound__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Compound__DatumRemoved(org.cdao.jastor.TUImpl.this,_has__Compound__Datum);
						}
					}
				}
				return;
