...
/**
 * Interface for CategoricalStateDatum ontology class<br>
 ...
 * 	description : Instance of a character for a given TU in the case of a discrete character <br>
 * <br>
 */
public interface CategoricalStateDatum extends org.cdao.jastor.CharacterStateDatum, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#CategoricalStateDatum");
