...
_prog_usage = '%prog -d <engine://user:password@host:port/database> -b <biodatabase ID#> [options] <NeXML filepath>'
_prog_version = 'NeXML-to-BioSQL Version 1.0'
_prog_description = 'imports one or more NeXML file into a pre-existing and pre-prepared database'
