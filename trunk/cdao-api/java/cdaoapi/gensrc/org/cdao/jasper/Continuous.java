...
/**
 * Interface for Continuous ontology class<br>
 ...
 * 	description : This class describes a continuous value. The link to the actual float value is through the property has_Value. It could have also other properties attached (e.g., has_Precision). <br>
 * <br>
 */
public interface Continuous extends org.cdao.jasper.CharacterStateDomain, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#Continuous");
