...
/**
 * Interface for RibonucleotideResidueCharacter ontology class<br>
 ...
 * <br>
 */
public interface RibonucleotideResidueCharacter extends org.cdao.jasper.MolecularCharacter, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#RibonucleotideResidueCharacter");
	 ...
	 * @return		{@link java.util.Iterator} of {@link org.cdao.jasper.RibonucleotideResidueStateDatum}
	 * @see			#has__DatumProperty
	 */
	public java.util.Iterator getHas__Datum_asRibonucleotideResidueStateDatum() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'has__Datum' property
	 * @param		The {@link org.cdao.jasper.RibonucleotideResidueStateDatum} to add
	 * @see			#has__DatumProperty
	 */
	public void addHas__Datum(org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has__Datum' property
	 * @return		The anoymous {@link org.cdao.jasper.RibonucleotideResidueStateDatum} created
	 * @see			#has__DatumProperty
	 */
	public org.cdao.jasper.RibonucleotideResidueStateDatum addHas__Datum_asRibonucleotideResidueStateDatum() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * 
	 * The resource argument have rdf:type http://www.cs.nmsu.edu/~epontell/CURRENT.owl#RibonucleotideResidueStateDatum.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		The {@link om.hp.hpl.jena.rdf.model.Resource} to add
	 * @see			#has__DatumProperty
	 */
	public org.cdao.jasper.RibonucleotideResidueStateDatum addHas__Datum_asRibonucleotideResidueStateDatum(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has__Datum' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link org.cdao.jasper.RibonucleotideResidueStateDatum} to remove
	 * @see			#has__DatumProperty
	 */
	public void removeHas__Datum(org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum) throws com.ibm.adtech.jastor.JastorException;
