...
/**
 * Implementation of {@link org.cdao.jasper.Sequence}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#Sequence)</p>
 * <br>
 */
public class SequenceImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.Sequence {
	...
	private java.util.ArrayList has_asThing;
	private java.util.ArrayList has_asCharacterStateDatum;
	...
	SequenceImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static SequenceImpl getSequence(Resource resource, Model model) throws JastorException {
		return new SequenceImpl(resource, model);
	}
	    
	static SequenceImpl createSequence(Resource resource, Model model) throws JastorException { 
		SequenceImpl impl = new SequenceImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Sequence.TYPE)))
			impl._model.add(impl._resource, RDF.type, Sequence.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.Sequence.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public void clearCache() {
		has = null;
		has_asThing = null;
		has_asCharacterStateDatum = null;
		belongs__to = null;
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in Sequence model not a Resource", stmt.getObject());
	...
	private void initHas_asThing() throws JastorException {
		this.has_asThing = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, hasProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (true) { // don't check resource type if the property range is Resource
				com.ibm.adtech.jastor.Thing has = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
				this.has_asThing.add(has);
			}
		}
	}

	public java.util.Iterator getHas_asThing() throws JastorException {
		if (has_asThing == null)
			initHas_asThing();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has_asThing,_resource,hasProperty,true);
	}

	public void addHas(com.ibm.adtech.jastor.Thing has) throws JastorException {
		if (this.has_asThing == null)
			initHas_asThing();
		if (this.has_asThing.contains(has)) {
			this.has_asThing.remove(has);
			this.has_asThing.add(has);
			return;
		}
		this.has_asThing.add(has);
	...
	public com.ibm.adtech.jastor.Thing addHas_asThing() throws JastorException {
		com.ibm.adtech.jastor.Thing has = com.ibm.adtech.jastor.ThingFactory.createThing(_model.createResource(),_model);
		if (this.has_asThing == null)
			initHas_asThing();
		this.has_asThing.add(has);
	...
	public com.ibm.adtech.jastor.Thing addHas_asThing(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		com.ibm.adtech.jastor.Thing has = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
		if (this.has_asThing == null)
			initHas_asThing();
		if (this.has_asThing.contains(has))
	...
	private void initHas_asCharacterStateDatum() throws JastorException {
		this.has_asCharacterStateDatum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, hasProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.CharacterStateDatum.TYPE)) {
				org.cdao.jasper.CharacterStateDatum has = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
				this.has_asCharacterStateDatum.add(has);
			}
		}
	}

	public java.util.Iterator getHas_asCharacterStateDatum() throws JastorException {
		if (has_asCharacterStateDatum == null)
			initHas_asCharacterStateDatum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has_asCharacterStateDatum,_resource,hasProperty,true);
	}

	public void addHas(org.cdao.jasper.CharacterStateDatum has) throws JastorException {
		if (this.has_asCharacterStateDatum == null)
			initHas_asCharacterStateDatum();
		if (this.has_asCharacterStateDatum.contains(has)) {
			this.has_asCharacterStateDatum.remove(has);
			this.has_asCharacterStateDatum.add(has);
			return;
		}
		this.has_asCharacterStateDatum.add(has);
	...
	public org.cdao.jasper.CharacterStateDatum addHas_asCharacterStateDatum() throws JastorException {
		org.cdao.jasper.CharacterStateDatum has = org.cdao.jasper.CDAOFactory.createCharacterStateDatum(_model.createResource(),_model);
		if (this.has_asCharacterStateDatum == null)
			initHas_asCharacterStateDatum();
		this.has_asCharacterStateDatum.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.CharacterStateDatum addHas_asCharacterStateDatum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CharacterStateDatum has = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
		if (this.has_asCharacterStateDatum == null)
			initHas_asCharacterStateDatum();
		if (this.has_asCharacterStateDatum.contains(has))
	...
	public void removeHas(org.cdao.jasper.CharacterStateDatum has) throws JastorException {
		if (this.has_asCharacterStateDatum == null)
			initHas_asCharacterStateDatum();
		if (!this.has_asCharacterStateDatum.contains(has))
			return;
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in Sequence model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in Sequence model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in Sequence model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in Sequence model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in Sequence model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in Sequence model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in Sequence model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in Sequence model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof SequenceListener))
			throw new IllegalArgumentException("ThingListener must be instance of SequenceListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((SequenceListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.hasAdded(org.cdao.jasper.SequenceImpl.this,_has);
						}
					}
				}
				if (true) { // don't check resource type if the property range is Resource
					com.ibm.adtech.jastor.Thing _has_asThing = null;
					try {
						_has_asThing = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asThing == null) {
					...
					if (!has_asThing.contains(_has_asThing))
						has_asThing.add(_has_asThing);
					if (listeners != null) {
						java.util.ArrayList consumersForHas_asThing;
						synchronized (listeners) {
							consumersForHas_asThing = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas_asThing.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.hasAdded(org.cdao.jasper.SequenceImpl.this,_has_asThing);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CharacterStateDatum.TYPE)) {
					org.cdao.jasper.CharacterStateDatum _has_asCharacterStateDatum = null;
					try {
						_has_asCharacterStateDatum = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asCharacterStateDatum == null) {
					...
					if (!has_asCharacterStateDatum.contains(_has_asCharacterStateDatum))
						has_asCharacterStateDatum.add(_has_asCharacterStateDatum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas_asCharacterStateDatum;
						synchronized (listeners) {
							consumersForHas_asCharacterStateDatum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas_asCharacterStateDatum.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.hasAdded(org.cdao.jasper.SequenceImpl.this,_has_asCharacterStateDatum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.SequenceImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.SequenceImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.SequenceImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.SequenceImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.SequenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.SequenceImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.SequenceImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.SequenceImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.SequenceImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.SequenceImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.SequenceImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.SequenceImpl.this,_exclude);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.SequenceImpl.this,_has);
						}
					}
				}
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has_asThing != null) {
						boolean found = false;
						for (int i=0;i<has_asThing.size();i++) {
							com.ibm.adtech.jastor.Thing __item = (com.ibm.adtech.jastor.Thing) has_asThing.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asThing = __item;
								break;
						...
						if (found)
							has_asThing.remove(_has_asThing);
						else {
							try {
								_has_asThing = com.ibm.adtech.jastor.ThingFactory.getThing(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asThing.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.SequenceImpl.this,_has_asThing);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CharacterStateDatum.TYPE)) {
					...
					if (has_asCharacterStateDatum != null) {
						boolean found = false;
						for (int i=0;i<has_asCharacterStateDatum.size();i++) {
							org.cdao.jasper.CharacterStateDatum __item = (org.cdao.jasper.CharacterStateDatum) has_asCharacterStateDatum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asCharacterStateDatum = __item;
								break;
							}
						}
						if (found)
							has_asCharacterStateDatum.remove(_has_asCharacterStateDatum);
						else {
							try {
								_has_asCharacterStateDatum = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asCharacterStateDatum.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.SequenceImpl.this,_has_asCharacterStateDatum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.SequenceImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.SequenceImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.SequenceImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.SequenceImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.SequenceImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SequenceListener listener=(SequenceListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.SequenceImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.SequenceImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.SequenceImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.SequenceImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.SequenceImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.SequenceImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.SequenceImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							SequenceListener listener=(SequenceListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.SequenceImpl.this,_exclude);
						}
					}
				}
				return;
