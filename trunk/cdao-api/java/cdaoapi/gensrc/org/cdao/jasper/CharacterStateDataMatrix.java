...
/**
 * Interface for CharacterStateDataMatrix ontology class<br>
 ...
 * 	description : A matrix of character-state data, typically containing observed data, though in some cases the states in the matrix might be simulated or hypothetical. Synonyms: character Data matrix, character-state matrix <br>
 * <br>
 */
public interface CharacterStateDataMatrix extends com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#CharacterStateDataMatrix");
	...
	/**
	 * The Jena Property for has__Character 
	 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Character)</p>
	 * <br>
	 * Dublin Core Standard Properties <br>
	 * 	description : This property associates a character data matrix with a character (a column) represented in the matrix.^^http://www.w3.org/2001/XMLSchema#string <br>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__CharacterProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Character");


	/**
	 * The Jena Property for has__TU 
	 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_TU)</p>
	 * <br>
	 * Dublin Core Standard Properties <br>
	 * 	description : This property associates a character data matrix with a TU (a row) represented in the matrix.^^http://www.w3.org/2001/XMLSchema#string <br>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__TUProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_TU");
	 ...
	 * Get an Iterator the 'has' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link org.cdao.jasper.CharacterStateDataMatrixAnnotation}
	 * @see			#hasProperty
	 */
	public java.util.Iterator getHas_asCharacterStateDataMatrixAnnotation() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'has' property
	 * @param		The {@link org.cdao.jasper.CharacterStateDataMatrixAnnotation} to add
	 * @see			#hasProperty
	 */
	public void addHas(org.cdao.jasper.CharacterStateDataMatrixAnnotation has) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has' property
	 * @return		The anoymous {@link org.cdao.jasper.CharacterStateDataMatrixAnnotation} created
	 * @see			#hasProperty
	 */
	public org.cdao.jasper.CharacterStateDataMatrixAnnotation addHas_asCharacterStateDataMatrixAnnotation() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * 
	 * The resource argument have rdf:type http://www.cs.nmsu.edu/~epontell/CURRENT.owl#CharacterStateDataMatrixAnnotation.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		The {@link om.hp.hpl.jena.rdf.model.Resource} to add
	 * @see			#hasProperty
	 */
	public org.cdao.jasper.CharacterStateDataMatrixAnnotation addHas_asCharacterStateDataMatrixAnnotation(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link org.cdao.jasper.CharacterStateDataMatrixAnnotation} to remove
	 * @see			#hasProperty
	 */
	public void removeHas(org.cdao.jasper.CharacterStateDataMatrixAnnotation has) throws com.ibm.adtech.jastor.JastorException;
		
	/**
	 * Get an Iterator the 'has__Character' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link org.cdao.jasper.Character}
	 * @see			#has__CharacterProperty
	 */
	public java.util.Iterator getHas__Character() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'has__Character' property
	 * @param		The {@link org.cdao.jasper.Character} to add
	 * @see			#has__CharacterProperty
	 */
	public void addHas__Character(org.cdao.jasper.Character has__Character) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has__Character' property
	 * @return		The anoymous {@link org.cdao.jasper.Character} created
	 * @see			#has__CharacterProperty
	 */
	public org.cdao.jasper.Character addHas__Character() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * 
	 * The resource argument have rdf:type http://www.cs.nmsu.edu/~epontell/CURRENT.owl#Character.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		The {@link om.hp.hpl.jena.rdf.model.Resource} to add
	 * @see			#has__CharacterProperty
	 */
	public org.cdao.jasper.Character addHas__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has__Character' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link org.cdao.jasper.Character} to remove
	 * @see			#has__CharacterProperty
	 */
	public void removeHas__Character(org.cdao.jasper.Character has__Character) throws com.ibm.adtech.jastor.JastorException;
		
	/**
	 * Get an Iterator the 'has__TU' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link org.cdao.jasper.TU}
	 * @see			#has__TUProperty
	 */
	public java.util.Iterator getHas__TU() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'has__TU' property
	 * @param		The {@link org.cdao.jasper.TU} to add
	 * @see			#has__TUProperty
	 */
	public void addHas__TU(org.cdao.jasper.TU has__TU) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has__TU' property
	 * @return		The anoymous {@link org.cdao.jasper.TU} created
	 * @see			#has__TUProperty
	 */
	public org.cdao.jasper.TU addHas__TU() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * 
	 * The resource argument have rdf:type http://www.cs.nmsu.edu/~epontell/CURRENT.owl#TU.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		The {@link om.hp.hpl.jena.rdf.model.Resource} to add
	 * @see			#has__TUProperty
	 */
	public org.cdao.jasper.TU addHas__TU(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has__TU' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link org.cdao.jasper.TU} to remove
	 * @see			#has__TUProperty
	 */
	public void removeHas__TU(org.cdao.jasper.TU has__TU) throws com.ibm.adtech.jastor.JastorException;
