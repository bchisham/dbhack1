...
/**
 * Interface for AminoAcidResidue ontology class<br>
 ...
 * 	description : This class will be declared equivalent ot the amino acid class description imported <br>
 * <br>
 */
public interface AminoAcidResidue extends org.cdao.jasper.Molecular, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#AminoAcidResidue");
