...
/**
 * Implementation of {@link org.cdao.jasper.CharacterStateDataMatrix}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#CharacterStateDataMatrix)</p>
 * <br>
 */
public class CharacterStateDataMatrixImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.CharacterStateDataMatrix {
	...
	private java.util.ArrayList has_asCharacterStateDataMatrixAnnotation;
	private static com.hp.hpl.jena.rdf.model.Property has__CharacterProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Character");
	private java.util.ArrayList has__Character;
	private static com.hp.hpl.jena.rdf.model.Property has__TUProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_TU");
	private java.util.ArrayList has__TU;
	...
	CharacterStateDataMatrixImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static CharacterStateDataMatrixImpl getCharacterStateDataMatrix(Resource resource, Model model) throws JastorException {
		return new CharacterStateDataMatrixImpl(resource, model);
	}
	    
	static CharacterStateDataMatrixImpl createCharacterStateDataMatrix(Resource resource, Model model) throws JastorException { 
		CharacterStateDataMatrixImpl impl = new CharacterStateDataMatrixImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, CharacterStateDataMatrix.TYPE)))
			impl._model.add(impl._resource, RDF.type, CharacterStateDataMatrix.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__CharacterProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,has__TUProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.CharacterStateDataMatrix.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public void clearCache() {
		has = null;
		has_asCharacterStateDataMatrixAnnotation = null;
		has__Character = null;
		has__TU = null;
		belongs__to = null;
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
	...
	private void initHas_asCharacterStateDataMatrixAnnotation() throws JastorException {
		this.has_asCharacterStateDataMatrixAnnotation = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, hasProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.CharacterStateDataMatrixAnnotation.TYPE)) {
				org.cdao.jasper.CharacterStateDataMatrixAnnotation has = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
				this.has_asCharacterStateDataMatrixAnnotation.add(has);
			}
		}
	}

	public java.util.Iterator getHas_asCharacterStateDataMatrixAnnotation() throws JastorException {
		if (has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has_asCharacterStateDataMatrixAnnotation,_resource,hasProperty,true);
	}

	public void addHas(org.cdao.jasper.CharacterStateDataMatrixAnnotation has) throws JastorException {
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		if (this.has_asCharacterStateDataMatrixAnnotation.contains(has)) {
			this.has_asCharacterStateDataMatrixAnnotation.remove(has);
			this.has_asCharacterStateDataMatrixAnnotation.add(has);
			return;
		}
		this.has_asCharacterStateDataMatrixAnnotation.add(has);
	...
	public org.cdao.jasper.CharacterStateDataMatrixAnnotation addHas_asCharacterStateDataMatrixAnnotation() throws JastorException {
		org.cdao.jasper.CharacterStateDataMatrixAnnotation has = org.cdao.jasper.CDAOFactory.createCharacterStateDataMatrixAnnotation(_model.createResource(),_model);
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		this.has_asCharacterStateDataMatrixAnnotation.add(has);
		_model.add(_model.createStatement(_resource,hasProperty,has.resource()));
	...
	public org.cdao.jasper.CharacterStateDataMatrixAnnotation addHas_asCharacterStateDataMatrixAnnotation(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CharacterStateDataMatrixAnnotation has = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		if (this.has_asCharacterStateDataMatrixAnnotation.contains(has))
	...
	public void removeHas(org.cdao.jasper.CharacterStateDataMatrixAnnotation has) throws JastorException {
		if (this.has_asCharacterStateDataMatrixAnnotation == null)
			initHas_asCharacterStateDataMatrixAnnotation();
		if (!this.has_asCharacterStateDataMatrixAnnotation.contains(has))
			return;
	...
	private void initHas__Character() throws JastorException {
		this.has__Character = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__CharacterProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Character properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.Character has__Character = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
				this.has__Character.add(has__Character);
			}
		}
	}

	public java.util.Iterator getHas__Character() throws JastorException {
		if (has__Character == null)
			initHas__Character();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Character,_resource,has__CharacterProperty,true);
	}

	public void addHas__Character(org.cdao.jasper.Character has__Character) throws JastorException {
		if (this.has__Character == null)
			initHas__Character();
		if (this.has__Character.contains(has__Character)) {
			this.has__Character.remove(has__Character);
			this.has__Character.add(has__Character);
			return;
		}
		this.has__Character.add(has__Character);
		_model.add(_model.createStatement(_resource,has__CharacterProperty,has__Character.resource()));
	}
	
	public org.cdao.jasper.Character addHas__Character() throws JastorException {
		org.cdao.jasper.Character has__Character = org.cdao.jasper.CDAOFactory.createCharacter(_model.createResource(),_model);
		if (this.has__Character == null)
			initHas__Character();
		this.has__Character.add(has__Character);
		_model.add(_model.createStatement(_resource,has__CharacterProperty,has__Character.resource()));
		return has__Character;
	}
	
	public org.cdao.jasper.Character addHas__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Character has__Character = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
		if (this.has__Character == null)
			initHas__Character();
		if (this.has__Character.contains(has__Character))
	...
	public void removeHas__Character(org.cdao.jasper.Character has__Character) throws JastorException {
		if (this.has__Character == null)
			initHas__Character();
		if (!this.has__Character.contains(has__Character))
			return;
		if (!_model.contains(_resource, has__CharacterProperty, has__Character.resource()))
			return;
		this.has__Character.remove(has__Character);
		_model.removeAll(_resource, has__CharacterProperty, has__Character.resource());
	}
		 

	private void initHas__TU() throws JastorException {
		this.has__TU = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__TUProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_TU properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.TU has__TU = org.cdao.jasper.CDAOFactory.getTU(resource,_model);
				this.has__TU.add(has__TU);
			}
		}
	}

	public java.util.Iterator getHas__TU() throws JastorException {
		if (has__TU == null)
			initHas__TU();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__TU,_resource,has__TUProperty,true);
	}

	public void addHas__TU(org.cdao.jasper.TU has__TU) throws JastorException {
		if (this.has__TU == null)
			initHas__TU();
		if (this.has__TU.contains(has__TU)) {
			this.has__TU.remove(has__TU);
			this.has__TU.add(has__TU);
			return;
		}
		this.has__TU.add(has__TU);
		_model.add(_model.createStatement(_resource,has__TUProperty,has__TU.resource()));
	}
	
	public org.cdao.jasper.TU addHas__TU() throws JastorException {
		org.cdao.jasper.TU has__TU = org.cdao.jasper.CDAOFactory.createTU(_model.createResource(),_model);
		if (this.has__TU == null)
			initHas__TU();
		this.has__TU.add(has__TU);
		_model.add(_model.createStatement(_resource,has__TUProperty,has__TU.resource()));
	...
	public org.cdao.jasper.TU addHas__TU(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.TU has__TU = org.cdao.jasper.CDAOFactory.getTU(resource,_model);
		if (this.has__TU == null)
			initHas__TU();
		if (this.has__TU.contains(has__TU))
	...
	public void removeHas__TU(org.cdao.jasper.TU has__TU) throws JastorException {
		if (this.has__TU == null)
			initHas__TU();
		if (!this.has__TU.contains(has__TU))
			return;
		if (!_model.contains(_resource, has__TUProperty, has__TU.resource()))
			return;
		this.has__TU.remove(has__TU);
		_model.removeAll(_resource, has__TUProperty, has__TU.resource());
	}
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in CharacterStateDataMatrix model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in CharacterStateDataMatrix model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof CharacterStateDataMatrixListener))
			throw new IllegalArgumentException("ThingListener must be instance of CharacterStateDataMatrixListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((CharacterStateDataMatrixListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CharacterStateDataMatrixAnnotation.TYPE)) {
					org.cdao.jasper.CharacterStateDataMatrixAnnotation _has_asCharacterStateDataMatrixAnnotation = null;
					try {
						_has_asCharacterStateDataMatrixAnnotation = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has_asCharacterStateDataMatrixAnnotation == null) {
					...
					if (!has_asCharacterStateDataMatrixAnnotation.contains(_has_asCharacterStateDataMatrixAnnotation))
						has_asCharacterStateDataMatrixAnnotation.add(_has_asCharacterStateDataMatrixAnnotation);
					if (listeners != null) {
						java.util.ArrayList consumersForHas_asCharacterStateDataMatrixAnnotation;
						synchronized (listeners) {
							consumersForHas_asCharacterStateDataMatrixAnnotation = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas_asCharacterStateDataMatrixAnnotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has_asCharacterStateDataMatrixAnnotation);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__CharacterProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.Character _has__Character = null;
					try {
						_has__Character = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Character == null) {
					...
					if (!has__Character.contains(_has__Character))
						has__Character.add(_has__Character);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Character;
						synchronized (listeners) {
							consumersForHas__Character = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Character.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__CharacterAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__Character);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__TUProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.TU _has__TU = null;
					try {
						_has__TU = org.cdao.jasper.CDAOFactory.getTU(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__TU == null) {
					...
					if (!has__TU.contains(_has__TU))
						has__TU.add(_has__TU);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__TU;
						synchronized (listeners) {
							consumersForHas__TU = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__TU.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__TUAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__TU);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_exclude);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.CharacterStateDataMatrixAnnotation.TYPE)) {
					...
					if (has_asCharacterStateDataMatrixAnnotation != null) {
						boolean found = false;
						for (int i=0;i<has_asCharacterStateDataMatrixAnnotation.size();i++) {
							org.cdao.jasper.CharacterStateDataMatrixAnnotation __item = (org.cdao.jasper.CharacterStateDataMatrixAnnotation) has_asCharacterStateDataMatrixAnnotation.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has_asCharacterStateDataMatrixAnnotation = __item;
								break;
							}
						}
						if (found)
							has_asCharacterStateDataMatrixAnnotation.remove(_has_asCharacterStateDataMatrixAnnotation);
						else {
							try {
								_has_asCharacterStateDataMatrixAnnotation = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrixAnnotation(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas_asCharacterStateDataMatrixAnnotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has_asCharacterStateDataMatrixAnnotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__CharacterProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Character != null) {
						boolean found = false;
						for (int i=0;i<has__Character.size();i++) {
							org.cdao.jasper.Character __item = (org.cdao.jasper.Character) has__Character.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Character = __item;
								break;
							}
						}
						if (found)
							has__Character.remove(_has__Character);
						else {
							try {
								_has__Character = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Character.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__CharacterRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__Character);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TUProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__TU != null) {
						boolean found = false;
						for (int i=0;i<has__TU.size();i++) {
							org.cdao.jasper.TU __item = (org.cdao.jasper.TU) has__TU.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__TU = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__TU.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__TURemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__TU);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CharacterStateDataMatrixListener listener=(CharacterStateDataMatrixListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.CharacterStateDataMatrixImpl.this,_exclude);
						}
					}
				}
				return;
