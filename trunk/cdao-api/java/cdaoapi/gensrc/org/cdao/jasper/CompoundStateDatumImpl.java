...
/**
 * Implementation of {@link org.cdao.jasper.CompoundStateDatum}
 ...
 * <br>
 */
public class CompoundStateDatumImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.CompoundStateDatum {
	...
	private static com.hp.hpl.jena.rdf.model.Property belongs__to__Compound__CharacterProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Compound_Character");
	private java.util.ArrayList belongs__to__Compound__Character;
	private static com.hp.hpl.jena.rdf.model.Property has__Compound__StateProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Compound_State");
	private java.util.ArrayList has__Compound__State_asCompound;
	private java.util.ArrayList has__Compound__State_asGeneric__State;
 

	CompoundStateDatumImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static CompoundStateDatumImpl getCompoundStateDatum(Resource resource, Model model) throws JastorException {
		return new CompoundStateDatumImpl(resource, model);
	}
	    
	static CompoundStateDatumImpl createCompoundStateDatum(Resource resource, Model model) throws JastorException { 
		CompoundStateDatumImpl impl = new CompoundStateDatumImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, CompoundStateDatum.TYPE)))
			impl._model.add(impl._resource, RDF.type, CompoundStateDatum.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,belongs__to__Compound__CharacterProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,has__Compound__StateProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.CompoundStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		precedes = null;
		exclude = null;
		belongs__to__Compound__Character = null;
		has__Compound__State_asCompound = null;
		has__Compound__State_asGeneric__State = null;
	}
	...
	public org.cdao.jasper.Character getBelongs__to__Character() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Character getProperty() in org.cdao.CompoundStateDatum model not Resource", stmt.getObject());
	...
	private void initHomologous__to() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#homologous_to properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__State() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_State properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Coordinate() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Coordinate properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jasper.TU getBelongs__to__TU() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__TU getProperty() in org.cdao.CompoundStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in CompoundStateDatum model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in CompoundStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to__Compound__Character() throws JastorException {
		this.belongs__to__Compound__Character = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, belongs__to__Compound__CharacterProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Compound_Character properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.CompoundCharacter belongs__to__Compound__Character = org.cdao.jasper.CDAOFactory.getCompoundCharacter(resource,_model);
				this.belongs__to__Compound__Character.add(belongs__to__Compound__Character);
			}
		}
	}

	public java.util.Iterator getBelongs__to__Compound__Character() throws JastorException {
		if (belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(belongs__to__Compound__Character,_resource,belongs__to__Compound__CharacterProperty,true);
	}

	public void addBelongs__to__Compound__Character(org.cdao.jasper.CompoundCharacter belongs__to__Compound__Character) throws JastorException {
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		if (this.belongs__to__Compound__Character.contains(belongs__to__Compound__Character)) {
			this.belongs__to__Compound__Character.remove(belongs__to__Compound__Character);
			this.belongs__to__Compound__Character.add(belongs__to__Compound__Character);
			return;
		}
		this.belongs__to__Compound__Character.add(belongs__to__Compound__Character);
		_model.add(_model.createStatement(_resource,belongs__to__Compound__CharacterProperty,belongs__to__Compound__Character.resource()));
	}
	
	public org.cdao.jasper.CompoundCharacter addBelongs__to__Compound__Character() throws JastorException {
		org.cdao.jasper.CompoundCharacter belongs__to__Compound__Character = org.cdao.jasper.CDAOFactory.createCompoundCharacter(_model.createResource(),_model);
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		this.belongs__to__Compound__Character.add(belongs__to__Compound__Character);
		_model.add(_model.createStatement(_resource,belongs__to__Compound__CharacterProperty,belongs__to__Compound__Character.resource()));
		return belongs__to__Compound__Character;
	}
	
	public org.cdao.jasper.CompoundCharacter addBelongs__to__Compound__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CompoundCharacter belongs__to__Compound__Character = org.cdao.jasper.CDAOFactory.getCompoundCharacter(resource,_model);
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		if (this.belongs__to__Compound__Character.contains(belongs__to__Compound__Character))
	...
	public void removeBelongs__to__Compound__Character(org.cdao.jasper.CompoundCharacter belongs__to__Compound__Character) throws JastorException {
		if (this.belongs__to__Compound__Character == null)
			initBelongs__to__Compound__Character();
		if (!this.belongs__to__Compound__Character.contains(belongs__to__Compound__Character))
			return;
		if (!_model.contains(_resource, belongs__to__Compound__CharacterProperty, belongs__to__Compound__Character.resource()))
			return;
		this.belongs__to__Compound__Character.remove(belongs__to__Compound__Character);
		_model.removeAll(_resource, belongs__to__Compound__CharacterProperty, belongs__to__Compound__Character.resource());
	}
		 

	private void initHas__Compound__State_asCompound() throws JastorException {
		this.has__Compound__State_asCompound = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Compound__StateProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Compound_State properties in CompoundStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Compound.TYPE)) {
				org.cdao.jasper.Compound has__Compound__State = org.cdao.jasper.CDAOFactory.getCompound(resource,_model);
				this.has__Compound__State_asCompound.add(has__Compound__State);
			}
		}
	}

	public java.util.Iterator getHas__Compound__State_asCompound() throws JastorException {
		if (has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Compound__State_asCompound,_resource,has__Compound__StateProperty,true);
	}

	public void addHas__Compound__State(org.cdao.jasper.Compound has__Compound__State) throws JastorException {
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		if (this.has__Compound__State_asCompound.contains(has__Compound__State)) {
			this.has__Compound__State_asCompound.remove(has__Compound__State);
			this.has__Compound__State_asCompound.add(has__Compound__State);
			return;
		}
		this.has__Compound__State_asCompound.add(has__Compound__State);
		_model.add(_model.createStatement(_resource,has__Compound__StateProperty,has__Compound__State.resource()));
	}
	
	public org.cdao.jasper.Compound addHas__Compound__State_asCompound() throws JastorException {
		org.cdao.jasper.Compound has__Compound__State = org.cdao.jasper.CDAOFactory.createCompound(_model.createResource(),_model);
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		this.has__Compound__State_asCompound.add(has__Compound__State);
		_model.add(_model.createStatement(_resource,has__Compound__StateProperty,has__Compound__State.resource()));
		return has__Compound__State;
	}
	
	public org.cdao.jasper.Compound addHas__Compound__State_asCompound(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Compound has__Compound__State = org.cdao.jasper.CDAOFactory.getCompound(resource,_model);
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		if (this.has__Compound__State_asCompound.contains(has__Compound__State))
	...
	public void removeHas__Compound__State(org.cdao.jasper.Compound has__Compound__State) throws JastorException {
		if (this.has__Compound__State_asCompound == null)
			initHas__Compound__State_asCompound();
		if (!this.has__Compound__State_asCompound.contains(has__Compound__State))
			return;
		if (!_model.contains(_resource, has__Compound__StateProperty, has__Compound__State.resource()))
			return;
		this.has__Compound__State_asCompound.remove(has__Compound__State);
		_model.removeAll(_resource, has__Compound__StateProperty, has__Compound__State.resource());
	}
		
	private void initHas__Compound__State_asGeneric__State() throws JastorException {
		this.has__Compound__State_asGeneric__State = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Compound__StateProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			...
			if (_model.contains(resource,RDF.type,org.cdao.jasper.Generic__State.TYPE)) {
				org.cdao.jasper.Generic__State has__Compound__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
				this.has__Compound__State_asGeneric__State.add(has__Compound__State);
			}
		}
	}

	public java.util.Iterator getHas__Compound__State_asGeneric__State() throws JastorException {
		if (has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Compound__State_asGeneric__State,_resource,has__Compound__StateProperty,true);
	}

	public void addHas__Compound__State(org.cdao.jasper.Generic__State has__Compound__State) throws JastorException {
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		if (this.has__Compound__State_asGeneric__State.contains(has__Compound__State)) {
			this.has__Compound__State_asGeneric__State.remove(has__Compound__State);
			this.has__Compound__State_asGeneric__State.add(has__Compound__State);
			return;
		}
		this.has__Compound__State_asGeneric__State.add(has__Compound__State);
	...
	public org.cdao.jasper.Generic__State addHas__Compound__State_asGeneric__State() throws JastorException {
		org.cdao.jasper.Generic__State has__Compound__State = org.cdao.jasper.CDAOFactory.createGeneric__State(_model.createResource(),_model);
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		this.has__Compound__State_asGeneric__State.add(has__Compound__State);
		_model.add(_model.createStatement(_resource,has__Compound__StateProperty,has__Compound__State.resource()));
	...
	public org.cdao.jasper.Generic__State addHas__Compound__State_asGeneric__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Generic__State has__Compound__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		if (this.has__Compound__State_asGeneric__State.contains(has__Compound__State))
	...
	public void removeHas__Compound__State(org.cdao.jasper.Generic__State has__Compound__State) throws JastorException {
		if (this.has__Compound__State_asGeneric__State == null)
			initHas__Compound__State_asGeneric__State();
		if (!this.has__Compound__State_asGeneric__State.contains(has__Compound__State))
			return;
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof CompoundStateDatumListener))
			throw new IllegalArgumentException("ThingListener must be instance of CompoundStateDatumListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((CompoundStateDatumListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(belongs__to__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.belongs__to__CharacterChanged(org.cdao.jasper.CompoundStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.homologous__toAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__StateAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__CoordinateAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__TUProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.belongs__to__TUChanged(org.cdao.jasper.CompoundStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.CompoundStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.hasAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_exclude);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(belongs__to__Compound__CharacterProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.CompoundCharacter _belongs__to__Compound__Character = null;
					try {
						_belongs__to__Compound__Character = org.cdao.jasper.CDAOFactory.getCompoundCharacter(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (belongs__to__Compound__Character == null) {
					...
					if (!belongs__to__Compound__Character.contains(_belongs__to__Compound__Character))
						belongs__to__Compound__Character.add(_belongs__to__Compound__Character);
					if (listeners != null) {
						java.util.ArrayList consumersForBelongs__to__Compound__Character;
						synchronized (listeners) {
							consumersForBelongs__to__Compound__Character = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForBelongs__to__Compound__Character.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__to__Compound__CharacterAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_belongs__to__Compound__Character);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Compound__StateProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Compound.TYPE)) {
					org.cdao.jasper.Compound _has__Compound__State_asCompound = null;
					try {
						_has__Compound__State_asCompound = org.cdao.jasper.CDAOFactory.getCompound(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Compound__State_asCompound == null) {
					...
					if (!has__Compound__State_asCompound.contains(_has__Compound__State_asCompound))
						has__Compound__State_asCompound.add(_has__Compound__State_asCompound);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Compound__State_asCompound;
						synchronized (listeners) {
							consumersForHas__Compound__State_asCompound = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Compound__State_asCompound.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Compound__State_asCompound);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Generic__State.TYPE)) {
					org.cdao.jasper.Generic__State _has__Compound__State_asGeneric__State = null;
					try {
						_has__Compound__State_asGeneric__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Compound__State_asGeneric__State == null) {
					...
					if (!has__Compound__State_asGeneric__State.contains(_has__Compound__State_asGeneric__State))
						has__Compound__State_asGeneric__State.add(_has__Compound__State_asGeneric__State);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Compound__State_asGeneric__State;
						synchronized (listeners) {
							consumersForHas__Compound__State_asGeneric__State = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Compound__State_asGeneric__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateAdded(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Compound__State_asGeneric__State);
						}
					}
				}
				return;
...
//				return;
			...
			if (stmt.getPredicate().equals(homologous__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.homologous__toRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__StateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__StateRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__CoordinateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__CoordinateRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Compound__CharacterProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (belongs__to__Compound__Character != null) {
						boolean found = false;
						for (int i=0;i<belongs__to__Compound__Character.size();i++) {
							org.cdao.jasper.CompoundCharacter __item = (org.cdao.jasper.CompoundCharacter) belongs__to__Compound__Character.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_belongs__to__Compound__Character = __item;
								break;
							}
						}
						if (found)
							belongs__to__Compound__Character.remove(_belongs__to__Compound__Character);
						else {
							try {
								_belongs__to__Compound__Character = org.cdao.jasper.CDAOFactory.getCompoundCharacter(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Compound__Character.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.belongs__to__Compound__CharacterRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_belongs__to__Compound__Character);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Compound__StateProperty)) {
				...
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Compound.TYPE)) {
					...
					if (has__Compound__State_asCompound != null) {
						boolean found = false;
						for (int i=0;i<has__Compound__State_asCompound.size();i++) {
							org.cdao.jasper.Compound __item = (org.cdao.jasper.Compound) has__Compound__State_asCompound.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Compound__State_asCompound = __item;
								break;
							}
						}
						if (found)
							has__Compound__State_asCompound.remove(_has__Compound__State_asCompound);
						else {
							try {
								_has__Compound__State_asCompound = org.cdao.jasper.CDAOFactory.getCompound(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__State_asCompound.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Compound__State_asCompound);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.Generic__State.TYPE)) {
					...
					if (has__Compound__State_asGeneric__State != null) {
						boolean found = false;
						for (int i=0;i<has__Compound__State_asGeneric__State.size();i++) {
							org.cdao.jasper.Generic__State __item = (org.cdao.jasper.Generic__State) has__Compound__State_asGeneric__State.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Compound__State_asGeneric__State = __item;
								break;
							}
						}
						if (found)
							has__Compound__State_asGeneric__State.remove(_has__Compound__State_asGeneric__State);
						else {
							try {
								_has__Compound__State_asGeneric__State = org.cdao.jasper.CDAOFactory.getGeneric__State(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__State_asGeneric__State.iterator();iter.hasNext();){
							CompoundStateDatumListener listener=(CompoundStateDatumListener)iter.next();
							listener.has__Compound__StateRemoved(org.cdao.jasper.CompoundStateDatumImpl.this,_has__Compound__State_asGeneric__State);
						}
					}
				}
				return;
