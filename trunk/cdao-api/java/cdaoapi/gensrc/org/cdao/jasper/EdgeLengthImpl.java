...
/**
 * Implementation of {@link org.cdao.jasper.EdgeLength}
 ...
 * <br>
 */
public class EdgeLengthImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.EdgeLength {
	...
	private java.util.ArrayList has__Type_asEdgeLengthType;
	...
	EdgeLengthImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static EdgeLengthImpl getEdgeLength(Resource resource, Model model) throws JastorException {
		return new EdgeLengthImpl(resource, model);
	}
	    
	static EdgeLengthImpl createEdgeLength(Resource resource, Model model) throws JastorException { 
		EdgeLengthImpl impl = new EdgeLengthImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, EdgeLength.TYPE)))
			impl._model.add(impl._resource, RDF.type, EdgeLength.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.EdgeLength.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		precedes = null;
		has__Type = null;
		has__Type_asEdgeLengthType = null;
		has__Value = null;
		exclude__Node = null;
	}
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in EdgeLength model not a Literal", stmt.getObject());
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in EdgeLength model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initIs__annotation__of() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#is_annotation_of properties in EdgeLength model not a Resource", stmt.getObject());
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in EdgeLength model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in EdgeLength model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in EdgeLength model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in EdgeLength model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type_asEdgeLengthType() throws JastorException {
		this.has__Type_asEdgeLengthType = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__TypeProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.EdgeLengthType.TYPE)) {
				org.cdao.jasper.EdgeLengthType has__Type = org.cdao.jasper.CDAOFactory.getEdgeLengthType(resource,_model);
				this.has__Type_asEdgeLengthType.add(has__Type);
			}
		}
	}

	public java.util.Iterator getHas__Type_asEdgeLengthType() throws JastorException {
		if (has__Type_asEdgeLengthType == null)
			initHas__Type_asEdgeLengthType();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Type_asEdgeLengthType,_resource,has__TypeProperty,true);
	}

	public void addHas__Type(org.cdao.jasper.EdgeLengthType has__Type) throws JastorException {
		if (this.has__Type_asEdgeLengthType == null)
			initHas__Type_asEdgeLengthType();
		if (this.has__Type_asEdgeLengthType.contains(has__Type)) {
			this.has__Type_asEdgeLengthType.remove(has__Type);
			this.has__Type_asEdgeLengthType.add(has__Type);
			return;
		}
		this.has__Type_asEdgeLengthType.add(has__Type);
	...
	public org.cdao.jasper.EdgeLengthType addHas__Type_asEdgeLengthType() throws JastorException {
		org.cdao.jasper.EdgeLengthType has__Type = org.cdao.jasper.CDAOFactory.createEdgeLengthType(_model.createResource(),_model);
		if (this.has__Type_asEdgeLengthType == null)
			initHas__Type_asEdgeLengthType();
		this.has__Type_asEdgeLengthType.add(has__Type);
		_model.add(_model.createStatement(_resource,has__TypeProperty,has__Type.resource()));
	...
	public org.cdao.jasper.EdgeLengthType addHas__Type_asEdgeLengthType(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.EdgeLengthType has__Type = org.cdao.jasper.CDAOFactory.getEdgeLengthType(resource,_model);
		if (this.has__Type_asEdgeLengthType == null)
			initHas__Type_asEdgeLengthType();
		if (this.has__Type_asEdgeLengthType.contains(has__Type))
	...
	public void removeHas__Type(org.cdao.jasper.EdgeLengthType has__Type) throws JastorException {
		if (this.has__Type_asEdgeLengthType == null)
			initHas__Type_asEdgeLengthType();
		if (!this.has__Type_asEdgeLengthType.contains(has__Type))
			return;
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in EdgeLength model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in EdgeLength model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof EdgeLengthListener))
			throw new IllegalArgumentException("ThingListener must be instance of EdgeLengthListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((EdgeLengthListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.EdgeLengthImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.is__annotation__ofAdded(org.cdao.jasper.EdgeLengthImpl.this,_is__annotation__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.EdgeLengthImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.EdgeLengthImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.EdgeLengthImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.EdgeLengthImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.EdgeLengthImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.hasAdded(org.cdao.jasper.EdgeLengthImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.EdgeLengthImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.EdgeLengthImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.EdgeLengthImpl.this,_has__Type);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.EdgeLengthType.TYPE)) {
					org.cdao.jasper.EdgeLengthType _has__Type_asEdgeLengthType = null;
					try {
						_has__Type_asEdgeLengthType = org.cdao.jasper.CDAOFactory.getEdgeLengthType(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Type_asEdgeLengthType == null) {
					...
					if (!has__Type_asEdgeLengthType.contains(_has__Type_asEdgeLengthType))
						has__Type_asEdgeLengthType.add(_has__Type_asEdgeLengthType);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Type_asEdgeLengthType;
						synchronized (listeners) {
							consumersForHas__Type_asEdgeLengthType = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Type_asEdgeLengthType.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.EdgeLengthImpl.this,_has__Type_asEdgeLengthType);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.EdgeLengthImpl.this,_exclude__Node);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.EdgeLengthImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(is__annotation__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.is__annotation__ofRemoved(org.cdao.jasper.EdgeLengthImpl.this,_is__annotation__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.EdgeLengthImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.EdgeLengthImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.EdgeLengthImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.EdgeLengthImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.EdgeLengthImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.EdgeLengthImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.EdgeLengthImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.EdgeLengthImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.EdgeLengthImpl.this,_has__Type);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.EdgeLengthType.TYPE)) {
					...
					if (has__Type_asEdgeLengthType != null) {
						boolean found = false;
						for (int i=0;i<has__Type_asEdgeLengthType.size();i++) {
							org.cdao.jasper.EdgeLengthType __item = (org.cdao.jasper.EdgeLengthType) has__Type_asEdgeLengthType.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Type_asEdgeLengthType = __item;
								break;
							}
						}
						if (found)
							has__Type_asEdgeLengthType.remove(_has__Type_asEdgeLengthType);
						else {
							try {
								_has__Type_asEdgeLengthType = org.cdao.jasper.CDAOFactory.getEdgeLengthType(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type_asEdgeLengthType.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.EdgeLengthImpl.this,_has__Type_asEdgeLengthType);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeLengthListener listener=(EdgeLengthListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.EdgeLengthImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							EdgeLengthListener listener=(EdgeLengthListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.EdgeLengthImpl.this,_exclude__Node);
						}
					}
				}
				return;
