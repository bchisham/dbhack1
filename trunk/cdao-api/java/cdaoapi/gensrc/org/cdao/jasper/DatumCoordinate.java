...
/**
 * Interface for DatumCoordinate ontology class<br>
 ...
 * 	comment : drawing from seqloc categories from NCBI at http://www.ncbi.nlm.nih.gov/IEB/ToolBox/SDKDOCS/SEQLOC.HTML#_Seq-loc:_Locations_on <br>
 * <br>
 * Dublin Core Standard Properties <br>
 * 	description : A positional coordinate giving the source of a character state, used for molecular sequences. <br>
 * <br>
 */
public interface DatumCoordinate extends com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#DatumCoordinate");
	

	/**
	 * The Jena Property for has__Coordinate__System 
	 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Coordinate_System)</p>
	 * <br>
	 * Dublin Core Standard Properties <br>
	 * 	description : This property links a coordinate to the coordinate system it references.^^http://www.w3.org/2001/XMLSchema#string <br>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__Coordinate__SystemProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Coordinate_System");
	...
	/**
	 * Gets the 'has__Coordinate__System' property value
	 * @return		{@link org.cdao.jasper.CoordinateSystem}
	 * @see			#has__Coordinate__SystemProperty
	 */
	public org.cdao.jasper.CoordinateSystem getHas__Coordinate__System() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Sets the 'has__Coordinate__System' property value
	 * @param		{@link org.cdao.jasper.CoordinateSystem}
	 * @see			#has__Coordinate__SystemProperty
	 */
	public void setHas__Coordinate__System(org.cdao.jasper.CoordinateSystem has__Coordinate__System) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Sets the 'has__Coordinate__System' property value to an anonymous node
	 * @return		{@link org.cdao.jasper.CoordinateSystem}, the created value
	 * @see			#has__Coordinate__SystemProperty
	 */	
	public org.cdao.jasper.CoordinateSystem setHas__Coordinate__System() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Sets the 'has__Coordinate__System' property value to the given resource
	 * The resource argument should have rdf:type http://www.cs.nmsu.edu/~epontell/CURRENT.owl#CoordinateSystem.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		{@link com.hp.hpl.jena.rdf.model.Resource} must not be be null.
	 * @return		{@link org.cdao.jasper.CoordinateSystem}, the newly created value
	 * @see			#has__Coordinate__SystemProperty
	 */
	public org.cdao.jasper.CoordinateSystem setHas__Coordinate__System(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
