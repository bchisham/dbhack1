...
/**
 * Implementation of {@link org.cdao.jasper.TU}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#TU)</p>
 * <br>
 */
public class TUImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.TU {
	...
	private static com.hp.hpl.jena.rdf.model.Property represented__by__NodeProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#represented_by_Node");
	private java.util.ArrayList represented__by__Node;
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Standard__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Standard_Datum");
	private java.util.ArrayList has__Standard__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__Amino__Acid__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Amino_Acid_Datum");
	private java.util.ArrayList has__Amino__Acid__Datum;
	private static com.hp.hpl.jena.rdf.model.Property belongs__to__Character__State__Data__MatrixProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Character_State_Data_Matrix");
	private java.util.ArrayList belongs__to__Character__State__Data__Matrix;
	private static com.hp.hpl.jena.rdf.model.Property has__Molecular__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Molecular_Datum");
	private java.util.ArrayList has__Molecular__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__Compound__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Compound_Datum");
	private java.util.ArrayList has__Compound__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Datum");
	private java.util.ArrayList has__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__Nucleotide__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Nucleotide_Datum");
	private java.util.ArrayList has__Nucleotide__Datum;
	private static com.hp.hpl.jena.rdf.model.Property has__Continuous__DatumProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Continuous_Datum");
	private java.util.ArrayList has__Continuous__Datum;
 

	TUImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static TUImpl getTU(Resource resource, Model model) throws JastorException {
		return new TUImpl(resource, model);
	}
	    
	static TUImpl createTU(Resource resource, Model model) throws JastorException { 
		TUImpl impl = new TUImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, TU.TYPE)))
			impl._model.add(impl._resource, RDF.type, TU.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,represented__by__NodeProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,has__Standard__DatumProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,has__Compound__DatumProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,has__Nucleotide__DatumProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,has__Continuous__DatumProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.TU.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public void clearCache() {
		...
		has__Value = null;
		exclude__Node = null;
		has__Standard__Datum = null;
		has__Amino__Acid__Datum = null;
		belongs__to__Character__State__Data__Matrix = null;
		has__Molecular__Datum = null;
		has__Compound__Datum = null;
		has__Datum = null;
		has__Nucleotide__Datum = null;
		has__Continuous__Datum = null;
	}
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in TU model not a Literal", stmt.getObject());
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in TU model not a Resource", stmt.getObject());
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initRepresented__by__Node() throws JastorException {
		this.represented__by__Node = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, represented__by__NodeProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#represented_by_Node properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.Node represented__by__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
				this.represented__by__Node.add(represented__by__Node);
			}
		}
	}

	public java.util.Iterator getRepresented__by__Node() throws JastorException {
		if (represented__by__Node == null)
			initRepresented__by__Node();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(represented__by__Node,_resource,represented__by__NodeProperty,true);
	}

	public void addRepresented__by__Node(org.cdao.jasper.Node represented__by__Node) throws JastorException {
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		if (this.represented__by__Node.contains(represented__by__Node)) {
			this.represented__by__Node.remove(represented__by__Node);
			this.represented__by__Node.add(represented__by__Node);
			return;
		}
		this.represented__by__Node.add(represented__by__Node);
		_model.add(_model.createStatement(_resource,represented__by__NodeProperty,represented__by__Node.resource()));
	}
	
	public org.cdao.jasper.Node addRepresented__by__Node() throws JastorException {
		org.cdao.jasper.Node represented__by__Node = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		this.represented__by__Node.add(represented__by__Node);
		_model.add(_model.createStatement(_resource,represented__by__NodeProperty,represented__by__Node.resource()));
		return represented__by__Node;
	}
	
	public org.cdao.jasper.Node addRepresented__by__Node(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Node represented__by__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		if (this.represented__by__Node.contains(represented__by__Node))
	...
	public void removeRepresented__by__Node(org.cdao.jasper.Node represented__by__Node) throws JastorException {
		if (this.represented__by__Node == null)
			initRepresented__by__Node();
		if (!this.represented__by__Node.contains(represented__by__Node))
			return;
		if (!_model.contains(_resource, represented__by__NodeProperty, represented__by__Node.resource()))
			return;
		this.represented__by__Node.remove(represented__by__Node);
		_model.removeAll(_resource, represented__by__NodeProperty, represented__by__Node.resource());
	}
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in TU model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Standard__Datum() throws JastorException {
		this.has__Standard__Datum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Standard__DatumProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Standard_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.StandardStateDatum has__Standard__Datum = org.cdao.jasper.CDAOFactory.getStandardStateDatum(resource,_model);
				this.has__Standard__Datum.add(has__Standard__Datum);
			}
		}
	}

	public java.util.Iterator getHas__Standard__Datum() throws JastorException {
		if (has__Standard__Datum == null)
			initHas__Standard__Datum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Standard__Datum,_resource,has__Standard__DatumProperty,true);
	}

	public void addHas__Standard__Datum(org.cdao.jasper.StandardStateDatum has__Standard__Datum) throws JastorException {
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		if (this.has__Standard__Datum.contains(has__Standard__Datum)) {
			this.has__Standard__Datum.remove(has__Standard__Datum);
			this.has__Standard__Datum.add(has__Standard__Datum);
			return;
		}
		this.has__Standard__Datum.add(has__Standard__Datum);
		_model.add(_model.createStatement(_resource,has__Standard__DatumProperty,has__Standard__Datum.resource()));
	}
	
	public org.cdao.jasper.StandardStateDatum addHas__Standard__Datum() throws JastorException {
		org.cdao.jasper.StandardStateDatum has__Standard__Datum = org.cdao.jasper.CDAOFactory.createStandardStateDatum(_model.createResource(),_model);
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		this.has__Standard__Datum.add(has__Standard__Datum);
		_model.add(_model.createStatement(_resource,has__Standard__DatumProperty,has__Standard__Datum.resource()));
		return has__Standard__Datum;
	}
	
	public org.cdao.jasper.StandardStateDatum addHas__Standard__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.StandardStateDatum has__Standard__Datum = org.cdao.jasper.CDAOFactory.getStandardStateDatum(resource,_model);
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		if (this.has__Standard__Datum.contains(has__Standard__Datum))
	...
	public void removeHas__Standard__Datum(org.cdao.jasper.StandardStateDatum has__Standard__Datum) throws JastorException {
		if (this.has__Standard__Datum == null)
			initHas__Standard__Datum();
		if (!this.has__Standard__Datum.contains(has__Standard__Datum))
			return;
		if (!_model.contains(_resource, has__Standard__DatumProperty, has__Standard__Datum.resource()))
			return;
		this.has__Standard__Datum.remove(has__Standard__Datum);
		_model.removeAll(_resource, has__Standard__DatumProperty, has__Standard__Datum.resource());
	}
	...
	private void initHas__Amino__Acid__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Amino_Acid_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.AminoAcidResidueStateDatum has__Amino__Acid__Datum = org.cdao.jasper.CDAOFactory.getAminoAcidResidueStateDatum(resource,_model);
	...
	public void addHas__Amino__Acid__Datum(org.cdao.jasper.AminoAcidResidueStateDatum has__Amino__Acid__Datum) throws JastorException {
	...
	public org.cdao.jasper.AminoAcidResidueStateDatum addHas__Amino__Acid__Datum() throws JastorException {
		org.cdao.jasper.AminoAcidResidueStateDatum has__Amino__Acid__Datum = org.cdao.jasper.CDAOFactory.createAminoAcidResidueStateDatum(_model.createResource(),_model);
		if (this.has__Amino__Acid__Datum == null)
			initHas__Amino__Acid__Datum();
		this.has__Amino__Acid__Datum.add(has__Amino__Acid__Datum);
		_model.add(_model.createStatement(_resource,has__Amino__Acid__DatumProperty,has__Amino__Acid__Datum.resource()));
	...
	public org.cdao.jasper.AminoAcidResidueStateDatum addHas__Amino__Acid__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.AminoAcidResidueStateDatum has__Amino__Acid__Datum = org.cdao.jasper.CDAOFactory.getAminoAcidResidueStateDatum(resource,_model);
		if (this.has__Amino__Acid__Datum == null)
			initHas__Amino__Acid__Datum();
		if (this.has__Amino__Acid__Datum.contains(has__Amino__Acid__Datum))
	...
	public void removeHas__Amino__Acid__Datum(org.cdao.jasper.AminoAcidResidueStateDatum has__Amino__Acid__Datum) throws JastorException {
		if (this.has__Amino__Acid__Datum == null)
			initHas__Amino__Acid__Datum();
		if (!this.has__Amino__Acid__Datum.contains(has__Amino__Acid__Datum))
			return;
	...
	private void initBelongs__to__Character__State__Data__Matrix() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Character_State_Data_Matrix properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.CharacterStateDataMatrix belongs__to__Character__State__Data__Matrix = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrix(resource,_model);
	...
	public void addBelongs__to__Character__State__Data__Matrix(org.cdao.jasper.CharacterStateDataMatrix belongs__to__Character__State__Data__Matrix) throws JastorException {
	...
	public org.cdao.jasper.CharacterStateDataMatrix addBelongs__to__Character__State__Data__Matrix() throws JastorException {
		org.cdao.jasper.CharacterStateDataMatrix belongs__to__Character__State__Data__Matrix = org.cdao.jasper.CDAOFactory.createCharacterStateDataMatrix(_model.createResource(),_model);
		if (this.belongs__to__Character__State__Data__Matrix == null)
			initBelongs__to__Character__State__Data__Matrix();
		this.belongs__to__Character__State__Data__Matrix.add(belongs__to__Character__State__Data__Matrix);
		_model.add(_model.createStatement(_resource,belongs__to__Character__State__Data__MatrixProperty,belongs__to__Character__State__Data__Matrix.resource()));
	...
	public org.cdao.jasper.CharacterStateDataMatrix addBelongs__to__Character__State__Data__Matrix(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CharacterStateDataMatrix belongs__to__Character__State__Data__Matrix = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrix(resource,_model);
		if (this.belongs__to__Character__State__Data__Matrix == null)
			initBelongs__to__Character__State__Data__Matrix();
		if (this.belongs__to__Character__State__Data__Matrix.contains(belongs__to__Character__State__Data__Matrix))
	...
	public void removeBelongs__to__Character__State__Data__Matrix(org.cdao.jasper.CharacterStateDataMatrix belongs__to__Character__State__Data__Matrix) throws JastorException {
		if (this.belongs__to__Character__State__Data__Matrix == null)
			initBelongs__to__Character__State__Data__Matrix();
		if (!this.belongs__to__Character__State__Data__Matrix.contains(belongs__to__Character__State__Data__Matrix))
			return;
	...
	private void initHas__Molecular__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Molecular_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.MolecularStateDatum has__Molecular__Datum = org.cdao.jasper.CDAOFactory.getMolecularStateDatum(resource,_model);
	...
	public void addHas__Molecular__Datum(org.cdao.jasper.MolecularStateDatum has__Molecular__Datum) throws JastorException {
	...
	public org.cdao.jasper.MolecularStateDatum addHas__Molecular__Datum() throws JastorException {
		org.cdao.jasper.MolecularStateDatum has__Molecular__Datum = org.cdao.jasper.CDAOFactory.createMolecularStateDatum(_model.createResource(),_model);
		if (this.has__Molecular__Datum == null)
			initHas__Molecular__Datum();
		this.has__Molecular__Datum.add(has__Molecular__Datum);
		_model.add(_model.createStatement(_resource,has__Molecular__DatumProperty,has__Molecular__Datum.resource()));
	...
	public org.cdao.jasper.MolecularStateDatum addHas__Molecular__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.MolecularStateDatum has__Molecular__Datum = org.cdao.jasper.CDAOFactory.getMolecularStateDatum(resource,_model);
		if (this.has__Molecular__Datum == null)
			initHas__Molecular__Datum();
		if (this.has__Molecular__Datum.contains(has__Molecular__Datum))
	...
	public void removeHas__Molecular__Datum(org.cdao.jasper.MolecularStateDatum has__Molecular__Datum) throws JastorException {
		if (this.has__Molecular__Datum == null)
			initHas__Molecular__Datum();
		if (!this.has__Molecular__Datum.contains(has__Molecular__Datum))
			return;
	...
	private void initHas__Compound__Datum() throws JastorException {
		this.has__Compound__Datum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Compound__DatumProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Compound_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.CompoundStateDatum has__Compound__Datum = org.cdao.jasper.CDAOFactory.getCompoundStateDatum(resource,_model);
				this.has__Compound__Datum.add(has__Compound__Datum);
			}
		}
	}

	public java.util.Iterator getHas__Compound__Datum() throws JastorException {
		if (has__Compound__Datum == null)
			initHas__Compound__Datum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Compound__Datum,_resource,has__Compound__DatumProperty,true);
	}

	public void addHas__Compound__Datum(org.cdao.jasper.CompoundStateDatum has__Compound__Datum) throws JastorException {
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		if (this.has__Compound__Datum.contains(has__Compound__Datum)) {
			this.has__Compound__Datum.remove(has__Compound__Datum);
			this.has__Compound__Datum.add(has__Compound__Datum);
			return;
		}
		this.has__Compound__Datum.add(has__Compound__Datum);
		_model.add(_model.createStatement(_resource,has__Compound__DatumProperty,has__Compound__Datum.resource()));
	}
	
	public org.cdao.jasper.CompoundStateDatum addHas__Compound__Datum() throws JastorException {
		org.cdao.jasper.CompoundStateDatum has__Compound__Datum = org.cdao.jasper.CDAOFactory.createCompoundStateDatum(_model.createResource(),_model);
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		this.has__Compound__Datum.add(has__Compound__Datum);
		_model.add(_model.createStatement(_resource,has__Compound__DatumProperty,has__Compound__Datum.resource()));
		return has__Compound__Datum;
	}
	
	public org.cdao.jasper.CompoundStateDatum addHas__Compound__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CompoundStateDatum has__Compound__Datum = org.cdao.jasper.CDAOFactory.getCompoundStateDatum(resource,_model);
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		if (this.has__Compound__Datum.contains(has__Compound__Datum))
	...
	public void removeHas__Compound__Datum(org.cdao.jasper.CompoundStateDatum has__Compound__Datum) throws JastorException {
		if (this.has__Compound__Datum == null)
			initHas__Compound__Datum();
		if (!this.has__Compound__Datum.contains(has__Compound__Datum))
			return;
		if (!_model.contains(_resource, has__Compound__DatumProperty, has__Compound__Datum.resource()))
			return;
		this.has__Compound__Datum.remove(has__Compound__Datum);
		_model.removeAll(_resource, has__Compound__DatumProperty, has__Compound__Datum.resource());
	}
	...
	private void initHas__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.CharacterStateDatum has__Datum = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
	...
	public void addHas__Datum(org.cdao.jasper.CharacterStateDatum has__Datum) throws JastorException {
	...
	public org.cdao.jasper.CharacterStateDatum addHas__Datum() throws JastorException {
		org.cdao.jasper.CharacterStateDatum has__Datum = org.cdao.jasper.CDAOFactory.createCharacterStateDatum(_model.createResource(),_model);
		if (this.has__Datum == null)
			initHas__Datum();
		this.has__Datum.add(has__Datum);
		_model.add(_model.createStatement(_resource,has__DatumProperty,has__Datum.resource()));
	...
	public org.cdao.jasper.CharacterStateDatum addHas__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.CharacterStateDatum has__Datum = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
		if (this.has__Datum == null)
			initHas__Datum();
		if (this.has__Datum.contains(has__Datum))
	...
	public void removeHas__Datum(org.cdao.jasper.CharacterStateDatum has__Datum) throws JastorException {
		if (this.has__Datum == null)
			initHas__Datum();
		if (!this.has__Datum.contains(has__Datum))
			return;
	...
	private void initHas__Nucleotide__Datum() throws JastorException {
		this.has__Nucleotide__Datum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Nucleotide__DatumProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Nucleotide_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum = org.cdao.jasper.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
				this.has__Nucleotide__Datum.add(has__Nucleotide__Datum);
			}
		}
	}

	public java.util.Iterator getHas__Nucleotide__Datum() throws JastorException {
		if (has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Nucleotide__Datum,_resource,has__Nucleotide__DatumProperty,true);
	}

	public void addHas__Nucleotide__Datum(org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum) throws JastorException {
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		if (this.has__Nucleotide__Datum.contains(has__Nucleotide__Datum)) {
			this.has__Nucleotide__Datum.remove(has__Nucleotide__Datum);
			this.has__Nucleotide__Datum.add(has__Nucleotide__Datum);
			return;
		}
		this.has__Nucleotide__Datum.add(has__Nucleotide__Datum);
		_model.add(_model.createStatement(_resource,has__Nucleotide__DatumProperty,has__Nucleotide__Datum.resource()));
	}
	
	public org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum addHas__Nucleotide__Datum() throws JastorException {
		org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum = org.cdao.jasper.CDAOFactory.createDesoxiRibonucleotideResidueStateDatum(_model.createResource(),_model);
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		this.has__Nucleotide__Datum.add(has__Nucleotide__Datum);
		_model.add(_model.createStatement(_resource,has__Nucleotide__DatumProperty,has__Nucleotide__Datum.resource()));
		return has__Nucleotide__Datum;
	}
	
	public org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum addHas__Nucleotide__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum = org.cdao.jasper.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		if (this.has__Nucleotide__Datum.contains(has__Nucleotide__Datum))
	...
	public void removeHas__Nucleotide__Datum(org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum has__Nucleotide__Datum) throws JastorException {
		if (this.has__Nucleotide__Datum == null)
			initHas__Nucleotide__Datum();
		if (!this.has__Nucleotide__Datum.contains(has__Nucleotide__Datum))
			return;
		if (!_model.contains(_resource, has__Nucleotide__DatumProperty, has__Nucleotide__Datum.resource()))
			return;
		this.has__Nucleotide__Datum.remove(has__Nucleotide__Datum);
		_model.removeAll(_resource, has__Nucleotide__DatumProperty, has__Nucleotide__Datum.resource());
	}
		 

	private void initHas__Continuous__Datum() throws JastorException {
		this.has__Continuous__Datum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__Continuous__DatumProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Continuous_Datum properties in TU model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.ContinuousStateDatum has__Continuous__Datum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
				this.has__Continuous__Datum.add(has__Continuous__Datum);
			}
		}
	}

	public java.util.Iterator getHas__Continuous__Datum() throws JastorException {
		if (has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Continuous__Datum,_resource,has__Continuous__DatumProperty,true);
	}

	public void addHas__Continuous__Datum(org.cdao.jasper.ContinuousStateDatum has__Continuous__Datum) throws JastorException {
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		if (this.has__Continuous__Datum.contains(has__Continuous__Datum)) {
			this.has__Continuous__Datum.remove(has__Continuous__Datum);
			this.has__Continuous__Datum.add(has__Continuous__Datum);
			return;
		}
		this.has__Continuous__Datum.add(has__Continuous__Datum);
		_model.add(_model.createStatement(_resource,has__Continuous__DatumProperty,has__Continuous__Datum.resource()));
	}
	
	public org.cdao.jasper.ContinuousStateDatum addHas__Continuous__Datum() throws JastorException {
		org.cdao.jasper.ContinuousStateDatum has__Continuous__Datum = org.cdao.jasper.CDAOFactory.createContinuousStateDatum(_model.createResource(),_model);
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		this.has__Continuous__Datum.add(has__Continuous__Datum);
		_model.add(_model.createStatement(_resource,has__Continuous__DatumProperty,has__Continuous__Datum.resource()));
		return has__Continuous__Datum;
	}
	
	public org.cdao.jasper.ContinuousStateDatum addHas__Continuous__Datum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.ContinuousStateDatum has__Continuous__Datum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		if (this.has__Continuous__Datum.contains(has__Continuous__Datum))
	...
	public void removeHas__Continuous__Datum(org.cdao.jasper.ContinuousStateDatum has__Continuous__Datum) throws JastorException {
		if (this.has__Continuous__Datum == null)
			initHas__Continuous__Datum();
		if (!this.has__Continuous__Datum.contains(has__Continuous__Datum))
			return;
		if (!_model.contains(_resource, has__Continuous__DatumProperty, has__Continuous__Datum.resource()))
			return;
		this.has__Continuous__Datum.remove(has__Continuous__Datum);
		_model.removeAll(_resource, has__Continuous__DatumProperty, has__Continuous__Datum.resource());
	}
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof TUListener))
			throw new IllegalArgumentException("ThingListener must be instance of TUListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((TUListener)listener);
		}
	}
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.TUImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.TUImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.TUImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.TUImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.TUImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.TUImpl.this,_belongs__to);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(represented__by__NodeProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.Node _represented__by__Node = null;
					try {
						_represented__by__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (represented__by__Node == null) {
					...
					if (!represented__by__Node.contains(_represented__by__Node))
						represented__by__Node.add(_represented__by__Node);
					if (listeners != null) {
						java.util.ArrayList consumersForRepresented__by__Node;
						synchronized (listeners) {
							consumersForRepresented__by__Node = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForRepresented__by__Node.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.represented__by__NodeAdded(org.cdao.jasper.TUImpl.this,_represented__by__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.TUImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.hasAdded(org.cdao.jasper.TUImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.TUImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.TUImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.TUImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.TUImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.TUImpl.this,_exclude__Node);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Standard__DatumProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.StandardStateDatum _has__Standard__Datum = null;
					try {
						_has__Standard__Datum = org.cdao.jasper.CDAOFactory.getStandardStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Standard__Datum == null) {
					...
					if (!has__Standard__Datum.contains(_has__Standard__Datum))
						has__Standard__Datum.add(_has__Standard__Datum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Standard__Datum;
						synchronized (listeners) {
							consumersForHas__Standard__Datum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Standard__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Standard__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Standard__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Amino__Acid__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.AminoAcidResidueStateDatum _has__Amino__Acid__Datum = null;
					try {
						_has__Amino__Acid__Datum = org.cdao.jasper.CDAOFactory.getAminoAcidResidueStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Amino__Acid__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Amino__Acid__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Amino__Acid__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Character__State__Data__MatrixProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.CharacterStateDataMatrix _belongs__to__Character__State__Data__Matrix = null;
					try {
						_belongs__to__Character__State__Data__Matrix = org.cdao.jasper.CDAOFactory.getCharacterStateDataMatrix(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (belongs__to__Character__State__Data__Matrix == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixAdded(org.cdao.jasper.TUImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Molecular__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.MolecularStateDatum _has__Molecular__Datum = null;
					try {
						_has__Molecular__Datum = org.cdao.jasper.CDAOFactory.getMolecularStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Molecular__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Molecular__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Molecular__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Molecular__Datum);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Compound__DatumProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.CompoundStateDatum _has__Compound__Datum = null;
					try {
						_has__Compound__Datum = org.cdao.jasper.CDAOFactory.getCompoundStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Compound__Datum == null) {
					...
					if (!has__Compound__Datum.contains(_has__Compound__Datum))
						has__Compound__Datum.add(_has__Compound__Datum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Compound__Datum;
						synchronized (listeners) {
							consumersForHas__Compound__Datum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Compound__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Compound__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Compound__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__DatumProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.CharacterStateDatum _has__Datum = null;
					try {
						_has__Datum = org.cdao.jasper.CDAOFactory.getCharacterStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Datum == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Datum);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Nucleotide__DatumProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum _has__Nucleotide__Datum = null;
					try {
						_has__Nucleotide__Datum = org.cdao.jasper.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Nucleotide__Datum == null) {
					...
					if (!has__Nucleotide__Datum.contains(_has__Nucleotide__Datum))
						has__Nucleotide__Datum.add(_has__Nucleotide__Datum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Nucleotide__Datum;
						synchronized (listeners) {
							consumersForHas__Nucleotide__Datum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Nucleotide__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Nucleotide__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Nucleotide__Datum);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Continuous__DatumProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.ContinuousStateDatum _has__Continuous__Datum = null;
					try {
						_has__Continuous__Datum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Continuous__Datum == null) {
					...
					if (!has__Continuous__Datum.contains(_has__Continuous__Datum))
						has__Continuous__Datum.add(_has__Continuous__Datum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Continuous__Datum;
						synchronized (listeners) {
							consumersForHas__Continuous__Datum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Continuous__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Continuous__DatumAdded(org.cdao.jasper.TUImpl.this,_has__Continuous__Datum);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.TUImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.TUImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.TUImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.TUImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.TUImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.TUImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(represented__by__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (represented__by__Node != null) {
						boolean found = false;
						for (int i=0;i<represented__by__Node.size();i++) {
							org.cdao.jasper.Node __item = (org.cdao.jasper.Node) represented__by__Node.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_represented__by__Node = __item;
								break;
							}
						}
						if (found)
							represented__by__Node.remove(_represented__by__Node);
						else {
							try {
								_represented__by__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRepresented__by__Node.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.represented__by__NodeRemoved(org.cdao.jasper.TUImpl.this,_represented__by__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.TUImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.TUImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.TUImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.TUImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.TUImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.TUImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TUListener listener=(TUListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.TUImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.TUImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Standard__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Standard__Datum != null) {
						boolean found = false;
						for (int i=0;i<has__Standard__Datum.size();i++) {
							org.cdao.jasper.StandardStateDatum __item = (org.cdao.jasper.StandardStateDatum) has__Standard__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Standard__Datum = __item;
								break;
							}
						}
						if (found)
							has__Standard__Datum.remove(_has__Standard__Datum);
						else {
							try {
								_has__Standard__Datum = org.cdao.jasper.CDAOFactory.getStandardStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Standard__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Standard__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Standard__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Amino__Acid__Datum != null) {
						...
						for (int i=0;i<has__Amino__Acid__Datum.size();i++) {
							org.cdao.jasper.AminoAcidResidueStateDatum __item = (org.cdao.jasper.AminoAcidResidueStateDatum) has__Amino__Acid__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Amino__Acid__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Amino__Acid__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (belongs__to__Character__State__Data__Matrix != null) {
						...
						for (int i=0;i<belongs__to__Character__State__Data__Matrix.size();i++) {
							org.cdao.jasper.CharacterStateDataMatrix __item = (org.cdao.jasper.CharacterStateDataMatrix) belongs__to__Character__State__Data__Matrix.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixRemoved(org.cdao.jasper.TUImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Molecular__Datum != null) {
						...
						for (int i=0;i<has__Molecular__Datum.size();i++) {
							org.cdao.jasper.MolecularStateDatum __item = (org.cdao.jasper.MolecularStateDatum) has__Molecular__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Molecular__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Molecular__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Molecular__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Compound__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Compound__Datum != null) {
						boolean found = false;
						for (int i=0;i<has__Compound__Datum.size();i++) {
							org.cdao.jasper.CompoundStateDatum __item = (org.cdao.jasper.CompoundStateDatum) has__Compound__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Compound__Datum = __item;
								break;
							}
						}
						if (found)
							has__Compound__Datum.remove(_has__Compound__Datum);
						else {
							try {
								_has__Compound__Datum = org.cdao.jasper.CDAOFactory.getCompoundStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Compound__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Compound__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Compound__Datum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Datum != null) {
						...
						for (int i=0;i<has__Datum.size();i++) {
							org.cdao.jasper.CharacterStateDatum __item = (org.cdao.jasper.CharacterStateDatum) has__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Datum = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Nucleotide__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Nucleotide__Datum != null) {
						boolean found = false;
						for (int i=0;i<has__Nucleotide__Datum.size();i++) {
							org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum __item = (org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum) has__Nucleotide__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Nucleotide__Datum = __item;
								break;
							}
						}
						if (found)
							has__Nucleotide__Datum.remove(_has__Nucleotide__Datum);
						else {
							try {
								_has__Nucleotide__Datum = org.cdao.jasper.CDAOFactory.getDesoxiRibonucleotideResidueStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Nucleotide__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Nucleotide__Datum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Continuous__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Continuous__Datum != null) {
						boolean found = false;
						for (int i=0;i<has__Continuous__Datum.size();i++) {
							org.cdao.jasper.ContinuousStateDatum __item = (org.cdao.jasper.ContinuousStateDatum) has__Continuous__Datum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Continuous__Datum = __item;
								break;
							}
						}
						if (found)
							has__Continuous__Datum.remove(_has__Continuous__Datum);
						else {
							try {
								_has__Continuous__Datum = org.cdao.jasper.CDAOFactory.getContinuousStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Continuous__Datum.iterator();iter.hasNext();){
							TUListener listener=(TUListener)iter.next();
							listener.has__Continuous__DatumRemoved(org.cdao.jasper.TUImpl.this,_has__Continuous__Datum);
						}
					}
				}
				return;
