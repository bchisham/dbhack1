...
/**
 * Interface for DesoxiRibonucleotideResidue ontology class<br>
 ...
 * <br>
 */
public interface DesoxiRibonucleotideResidue extends org.cdao.jasper.Molecular, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#DesoxiRibonucleotideResidue");
	...
	/**
	 * Individual for URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dA
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dA = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dA");


	/**
	 * Individual for URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dC
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dC = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dC");


	/**
	 * Individual for URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dG
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dG = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dG");


	/**
	 * Individual for URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dT
	 */
	public static com.hp.hpl.jena.rdf.model.Resource dT = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#dT");
