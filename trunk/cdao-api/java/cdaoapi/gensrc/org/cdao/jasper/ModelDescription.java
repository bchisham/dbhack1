...
/**
 * Interface for ModelDescription ontology class<br>
 ...
 * 	comment : This is a non-computible description of a model, not the fully specified mathematical model, which typically relates the probability of a transformation to various parameters. <br>
 * <br>
 * Dublin Core Standard Properties <br>
 * 	description : Description of a model of transformations. <br>
 * <br>
 */
public interface ModelDescription extends org.cdao.jasper.CDAOAnnotation, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#ModelDescription");
