...
/**
 * Implementation of {@link org.cdao.jasper.EdgeTransformation}
 ...
 * <br>
 */
public class EdgeTransformationImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.EdgeTransformation {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Left__NodeProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Left_Node");
	private java.util.ArrayList has__Left__Node;
	private static com.hp.hpl.jena.rdf.model.Property has__Right__NodeProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Right_Node");
	private java.util.ArrayList has__Right__Node;
	private static com.hp.hpl.jena.rdf.model.Property transformation__ofProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#transformation_of");
	private org.cdao.jasper.Character transformation__of;
	private static com.hp.hpl.jena.rdf.model.Property has__Right__StateProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Right_State");
	private org.cdao.jasper.CharacterStateDomain has__Right__State;
	private static com.hp.hpl.jena.rdf.model.Property has__Left__StateProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Left_State");
	private org.cdao.jasper.CharacterStateDomain has__Left__State;
	private static com.hp.hpl.jena.rdf.model.Property has__Transformation__ComponentProperty = ResourceFactory.createProperty("http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Transformation_Component");
	...
	void addSuperTypes() {
		...
		if (!_model.contains(_resource, RDF.type, org.cdao.jasper.EdgeAnnotation.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jasper.EdgeAnnotation.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.EdgeTransformation.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.EdgeAnnotation.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in EdgeTransformation model not a Literal", stmt.getObject());
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in EdgeTransformation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initIs__annotation__of() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#is_annotation_of properties in EdgeTransformation model not a Resource", stmt.getObject());
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in EdgeTransformation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in EdgeTransformation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in EdgeTransformation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in EdgeTransformation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in EdgeTransformation model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Left__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Left_Node properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.Node has__Left__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
	...
	public void addHas__Left__Node(org.cdao.jasper.Node has__Left__Node) throws JastorException {
	...
	public org.cdao.jasper.Node addHas__Left__Node() throws JastorException {
		org.cdao.jasper.Node has__Left__Node = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.has__Left__Node == null)
			initHas__Left__Node();
		this.has__Left__Node.add(has__Left__Node);
		_model.add(_model.createStatement(_resource,has__Left__NodeProperty,has__Left__Node.resource()));
	...
	public org.cdao.jasper.Node addHas__Left__Node(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Node has__Left__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		if (this.has__Left__Node == null)
			initHas__Left__Node();
		if (this.has__Left__Node.contains(has__Left__Node))
	...
	public void removeHas__Left__Node(org.cdao.jasper.Node has__Left__Node) throws JastorException {
		if (this.has__Left__Node == null)
			initHas__Left__Node();
		if (!this.has__Left__Node.contains(has__Left__Node))
			return;
	...
	private void initHas__Right__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Right_Node properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jasper.Node has__Right__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
	...
	public void addHas__Right__Node(org.cdao.jasper.Node has__Right__Node) throws JastorException {
	...
	public org.cdao.jasper.Node addHas__Right__Node() throws JastorException {
		org.cdao.jasper.Node has__Right__Node = org.cdao.jasper.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.has__Right__Node == null)
			initHas__Right__Node();
		this.has__Right__Node.add(has__Right__Node);
		_model.add(_model.createStatement(_resource,has__Right__NodeProperty,has__Right__Node.resource()));
	...
	public org.cdao.jasper.Node addHas__Right__Node(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.Node has__Right__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
		if (this.has__Right__Node == null)
			initHas__Right__Node();
		if (this.has__Right__Node.contains(has__Right__Node))
	...
	public void removeHas__Right__Node(org.cdao.jasper.Node has__Right__Node) throws JastorException {
		if (this.has__Right__Node == null)
			initHas__Right__Node();
		if (!this.has__Right__Node.contains(has__Right__Node))
			return;
	...
	public org.cdao.jasper.Character getTransformation__of() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": transformation__of getProperty() in org.cdao.EdgeTransformation model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		transformation__of = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
		return transformation__of;
	}

	public void setTransformation__of(org.cdao.jasper.Character transformation__of) throws JastorException {
	...
	public org.cdao.jasper.Character setTransformation__of() throws JastorException {
		if (_model.contains(_resource,transformation__ofProperty)) {
			_model.removeAll(_resource,transformation__ofProperty,null);
		}
		org.cdao.jasper.Character transformation__of = org.cdao.jasper.CDAOFactory.createCharacter(_model.createResource(),_model);
		this.transformation__of = transformation__of;
		_model.add(_model.createStatement(_resource,transformation__ofProperty, transformation__of.resource()));
		return transformation__of;
	}
	
	public org.cdao.jasper.Character setTransformation__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,transformation__ofProperty)) {
			_model.removeAll(_resource,transformation__ofProperty,null);
		}
		org.cdao.jasper.Character transformation__of = org.cdao.jasper.CDAOFactory.getCharacter(resource,_model);
		this.transformation__of = transformation__of;
		_model.add(_model.createStatement(_resource,transformation__ofProperty, transformation__of.resource()));
		return transformation__of;
	}
	...
	public org.cdao.jasper.CharacterStateDomain getHas__Right__State() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Right__State getProperty() in org.cdao.EdgeTransformation model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		has__Right__State = org.cdao.jasper.CDAOFactory.getCharacterStateDomain(resource,_model);
		return has__Right__State;
	}

	public void setHas__Right__State(org.cdao.jasper.CharacterStateDomain has__Right__State) throws JastorException {
	...
	public org.cdao.jasper.CharacterStateDomain setHas__Right__State() throws JastorException {
		if (_model.contains(_resource,has__Right__StateProperty)) {
			_model.removeAll(_resource,has__Right__StateProperty,null);
		}
		org.cdao.jasper.CharacterStateDomain has__Right__State = org.cdao.jasper.CDAOFactory.createCharacterStateDomain(_model.createResource(),_model);
		this.has__Right__State = has__Right__State;
		_model.add(_model.createStatement(_resource,has__Right__StateProperty, has__Right__State.resource()));
		return has__Right__State;
	}
	
	public org.cdao.jasper.CharacterStateDomain setHas__Right__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,has__Right__StateProperty)) {
			_model.removeAll(_resource,has__Right__StateProperty,null);
		}
		org.cdao.jasper.CharacterStateDomain has__Right__State = org.cdao.jasper.CDAOFactory.getCharacterStateDomain(resource,_model);
		this.has__Right__State = has__Right__State;
		_model.add(_model.createStatement(_resource,has__Right__StateProperty, has__Right__State.resource()));
		return has__Right__State;
	}
	...
	public org.cdao.jasper.CharacterStateDomain getHas__Left__State() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Left__State getProperty() in org.cdao.EdgeTransformation model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		has__Left__State = org.cdao.jasper.CDAOFactory.getCharacterStateDomain(resource,_model);
		return has__Left__State;
	}

	public void setHas__Left__State(org.cdao.jasper.CharacterStateDomain has__Left__State) throws JastorException {
	...
	public org.cdao.jasper.CharacterStateDomain setHas__Left__State() throws JastorException {
		if (_model.contains(_resource,has__Left__StateProperty)) {
			_model.removeAll(_resource,has__Left__StateProperty,null);
		}
		org.cdao.jasper.CharacterStateDomain has__Left__State = org.cdao.jasper.CDAOFactory.createCharacterStateDomain(_model.createResource(),_model);
		this.has__Left__State = has__Left__State;
		_model.add(_model.createStatement(_resource,has__Left__StateProperty, has__Left__State.resource()));
		return has__Left__State;
	}
	
	public org.cdao.jasper.CharacterStateDomain setHas__Left__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,has__Left__StateProperty)) {
			_model.removeAll(_resource,has__Left__StateProperty,null);
		}
		org.cdao.jasper.CharacterStateDomain has__Left__State = org.cdao.jasper.CDAOFactory.getCharacterStateDomain(resource,_model);
		this.has__Left__State = has__Left__State;
		_model.add(_model.createStatement(_resource,has__Left__StateProperty, has__Left__State.resource()));
		return has__Left__State;
	}
	...
	private void initHas__Transformation__Component() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Transformation_Component properties in EdgeTransformation model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						...
						listener.has__External__ReferenceAdded(org.cdao.jasper.EdgeTransformationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.is__annotation__ofAdded(org.cdao.jasper.EdgeTransformationImpl.this,_is__annotation__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.EdgeTransformationImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.EdgeTransformationImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.EdgeTransformationImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.EdgeTransformationImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.EdgeTransformationImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.hasAdded(org.cdao.jasper.EdgeTransformationImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.EdgeTransformationImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.EdgeTransformationImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.EdgeTransformationImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.EdgeTransformationImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Left__NodeProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.Node _has__Left__Node = null;
					try {
						_has__Left__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Left__Node == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Left__Node.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__Left__NodeAdded(org.cdao.jasper.EdgeTransformationImpl.this,_has__Left__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Right__NodeProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jasper.Node _has__Right__Node = null;
					try {
						_has__Right__Node = org.cdao.jasper.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Right__Node == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Right__Node.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__Right__NodeAdded(org.cdao.jasper.EdgeTransformationImpl.this,_has__Right__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(transformation__ofProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.transformation__ofChanged(org.cdao.jasper.EdgeTransformationImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Right__StateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Right__StateChanged(org.cdao.jasper.EdgeTransformationImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Left__StateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Left__StateChanged(org.cdao.jasper.EdgeTransformationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Transformation__Component.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__Transformation__ComponentAdded(org.cdao.jasper.EdgeTransformationImpl.this,_has__Transformation__Component);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.EdgeTransformationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(is__annotation__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIs__annotation__of.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.is__annotation__ofRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_is__annotation__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.EdgeTransformationImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Left__Node != null) {
						...
						for (int i=0;i<has__Left__Node.size();i++) {
							org.cdao.jasper.Node __item = (org.cdao.jasper.Node) has__Left__Node.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Left__Node.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__Left__NodeRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_has__Left__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Right__Node != null) {
						...
						for (int i=0;i<has__Right__Node.size();i++) {
							org.cdao.jasper.Node __item = (org.cdao.jasper.Node) has__Right__Node.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Right__Node.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__Right__NodeRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_has__Right__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Transformation__ComponentProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Transformation__Component.iterator();iter.hasNext();){
							EdgeTransformationListener listener=(EdgeTransformationListener)iter.next();
							listener.has__Transformation__ComponentRemoved(org.cdao.jasper.EdgeTransformationImpl.this,_has__Transformation__Component);
						}
					}
				}
				return;
