...
/**
 * Implementation of {@link org.cdao.jasper.RibonucleotideResidueCharacter}
 * Use the org.cdao.CDAOFactory to create instances of this class.
 * <p>(URI: http://www.cs.nmsu.edu/~epontell/CURRENT.owl#RibonucleotideResidueCharacter)</p>
 * <br>
 */
public class RibonucleotideResidueCharacterImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jasper.RibonucleotideResidueCharacter {
	...
	private java.util.ArrayList has__Datum_asRibonucleotideResidueStateDatum;
	...
	RibonucleotideResidueCharacterImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static RibonucleotideResidueCharacterImpl getRibonucleotideResidueCharacter(Resource resource, Model model) throws JastorException {
		return new RibonucleotideResidueCharacterImpl(resource, model);
	}
	    
	static RibonucleotideResidueCharacterImpl createRibonucleotideResidueCharacter(Resource resource, Model model) throws JastorException { 
		RibonucleotideResidueCharacterImpl impl = new RibonucleotideResidueCharacterImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, RibonucleotideResidueCharacter.TYPE)))
			impl._model.add(impl._resource, RDF.type, RibonucleotideResidueCharacter.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jasper.RibonucleotideResidueCharacter.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	public void clearCache() {
		...
		has__Datum = null;
		has__Datum_asRibonucleotideResidueStateDatum = null;
		belongs__to = null;
	...
	private void initBelongs__to__Character__State__Data__Matrix() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to_Character_State_Data_Matrix properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
	...
	private void initHas__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Datum properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Datum_asRibonucleotideResidueStateDatum() throws JastorException {
		this.has__Datum_asRibonucleotideResidueStateDatum = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__DatumProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Datum properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jasper.RibonucleotideResidueStateDatum.TYPE)) {
				org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum = org.cdao.jasper.CDAOFactory.getRibonucleotideResidueStateDatum(resource,_model);
				this.has__Datum_asRibonucleotideResidueStateDatum.add(has__Datum);
			}
		}
	}

	public java.util.Iterator getHas__Datum_asRibonucleotideResidueStateDatum() throws JastorException {
		if (has__Datum_asRibonucleotideResidueStateDatum == null)
			initHas__Datum_asRibonucleotideResidueStateDatum();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__Datum_asRibonucleotideResidueStateDatum,_resource,has__DatumProperty,true);
	}

	public void addHas__Datum(org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum) throws JastorException {
		if (this.has__Datum_asRibonucleotideResidueStateDatum == null)
			initHas__Datum_asRibonucleotideResidueStateDatum();
		if (this.has__Datum_asRibonucleotideResidueStateDatum.contains(has__Datum)) {
			this.has__Datum_asRibonucleotideResidueStateDatum.remove(has__Datum);
			this.has__Datum_asRibonucleotideResidueStateDatum.add(has__Datum);
			return;
		}
		this.has__Datum_asRibonucleotideResidueStateDatum.add(has__Datum);
	...
	public org.cdao.jasper.RibonucleotideResidueStateDatum addHas__Datum_asRibonucleotideResidueStateDatum() throws JastorException {
		org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum = org.cdao.jasper.CDAOFactory.createRibonucleotideResidueStateDatum(_model.createResource(),_model);
		if (this.has__Datum_asRibonucleotideResidueStateDatum == null)
			initHas__Datum_asRibonucleotideResidueStateDatum();
		this.has__Datum_asRibonucleotideResidueStateDatum.add(has__Datum);
		_model.add(_model.createStatement(_resource,has__DatumProperty,has__Datum.resource()));
	...
	public org.cdao.jasper.RibonucleotideResidueStateDatum addHas__Datum_asRibonucleotideResidueStateDatum(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum = org.cdao.jasper.CDAOFactory.getRibonucleotideResidueStateDatum(resource,_model);
		if (this.has__Datum_asRibonucleotideResidueStateDatum == null)
			initHas__Datum_asRibonucleotideResidueStateDatum();
		if (this.has__Datum_asRibonucleotideResidueStateDatum.contains(has__Datum))
	...
	public void removeHas__Datum(org.cdao.jasper.RibonucleotideResidueStateDatum has__Datum) throws JastorException {
		if (this.has__Datum_asRibonucleotideResidueStateDatum == null)
			initHas__Datum_asRibonucleotideResidueStateDatum();
		if (!this.has__Datum_asRibonucleotideResidueStateDatum.contains(has__Datum))
			return;
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#belongs_to properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Annotation properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_External_Reference properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Precision properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Uncertainty_Factor properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Float_Value properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Int_Value properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Value properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Support_Value properties in RibonucleotideResidueCharacter model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#connects_to properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Subtree() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Subtree properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#part_of properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Type() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Type properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude__Node() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude_Node properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#precedes properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initExclude() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#exclude properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Molecular__Datum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.cs.nmsu.edu/~epontell/CURRENT.owl#has_Molecular_Datum properties in RibonucleotideResidueCharacter model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof RibonucleotideResidueCharacterListener))
			throw new IllegalArgumentException("ThingListener must be instance of RibonucleotideResidueCharacterListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((RibonucleotideResidueCharacterListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__DatumAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Datum);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.RibonucleotideResidueStateDatum.TYPE)) {
					org.cdao.jasper.RibonucleotideResidueStateDatum _has__Datum_asRibonucleotideResidueStateDatum = null;
					try {
						_has__Datum_asRibonucleotideResidueStateDatum = org.cdao.jasper.CDAOFactory.getRibonucleotideResidueStateDatum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Datum_asRibonucleotideResidueStateDatum == null) {
					...
					if (!has__Datum_asRibonucleotideResidueStateDatum.contains(_has__Datum_asRibonucleotideResidueStateDatum))
						has__Datum_asRibonucleotideResidueStateDatum.add(_has__Datum_asRibonucleotideResidueStateDatum);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__Datum_asRibonucleotideResidueStateDatum;
						synchronized (listeners) {
							consumersForHas__Datum_asRibonucleotideResidueStateDatum = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__Datum_asRibonucleotideResidueStateDatum.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__DatumAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Datum_asRibonucleotideResidueStateDatum);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.belongs__toAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_belongs__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__ValueAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.hasAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.connects__toAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.exclude__SubtreeAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.part__ofAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__TypeAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Type);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.exclude__NodeAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_exclude__Node);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.precedesAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.excludeAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_exclude);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Molecular__Datum.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__Molecular__DatumAdded(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Molecular__Datum);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(belongs__to__Character__State__Data__MatrixProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to__Character__State__Data__Matrix.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.belongs__to__Character__State__Data__MatrixRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_belongs__to__Character__State__Data__Matrix);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Datum);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jasper.RibonucleotideResidueStateDatum.TYPE)) {
					...
					if (has__Datum_asRibonucleotideResidueStateDatum != null) {
						boolean found = false;
						for (int i=0;i<has__Datum_asRibonucleotideResidueStateDatum.size();i++) {
							org.cdao.jasper.RibonucleotideResidueStateDatum __item = (org.cdao.jasper.RibonucleotideResidueStateDatum) has__Datum_asRibonucleotideResidueStateDatum.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__Datum_asRibonucleotideResidueStateDatum = __item;
								break;
							}
						}
						if (found)
							has__Datum_asRibonucleotideResidueStateDatum.remove(_has__Datum_asRibonucleotideResidueStateDatum);
						else {
							try {
								_has__Datum_asRibonucleotideResidueStateDatum = org.cdao.jasper.CDAOFactory.getRibonucleotideResidueStateDatum(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Datum_asRibonucleotideResidueStateDatum.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__DatumRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Datum_asRibonucleotideResidueStateDatum);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.hasRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.connects__toRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__SubtreeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Subtree.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.exclude__SubtreeRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_exclude__Subtree);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.part__ofRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__TypeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Type.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__TypeRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Type);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(exclude__NodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude__Node.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.exclude__NodeRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_exclude__Node);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.precedesRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(excludeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForExclude.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.excludeRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_exclude);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Molecular__DatumProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Molecular__Datum.iterator();iter.hasNext();){
							RibonucleotideResidueCharacterListener listener=(RibonucleotideResidueCharacterListener)iter.next();
							listener.has__Molecular__DatumRemoved(org.cdao.jasper.RibonucleotideResidueCharacterImpl.this,_has__Molecular__Datum);
						}
					}
				}
				return;
