...
/**
 * Implementation of {@link org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum}
 ...
 * <br>
 */
public class DesoxiRibonucleotideResidueStateDatumImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Nucleotide__StateProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Nucleotide_State");
	...
	private static com.hp.hpl.jena.rdf.model.Property belongs__to__Nucleotide__CharacterProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#belongs_to_Nucleotide_Character");
	private org.cdao.jastor.DesoxiRibonucleotideResidueCharacter belongs__to__Nucleotide__Character;
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.DesoxiRibonucleotideResidueStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHas__Coordinate() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Coordinate properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
	...
	public org.cdao.jastor.TU getBelongs__to__TU() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__TU getProperty() in org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__State() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_State properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jastor.Character getBelongs__to__Character() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Character getProperty() in org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHomologous__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#homologous_to properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in DesoxiRibonucleotideResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Nucleotide__State_asDesoxiRibonucleotideResidue() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Nucleotide_State properties in DesoxiRibonucleotideResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.DesoxiRibonucleotideResidue.TYPE)) {
				org.cdao.jastor.DesoxiRibonucleotideResidue has__Nucleotide__State = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidue(resource,_model);
	...
	public void addHas__Nucleotide__State(org.cdao.jastor.DesoxiRibonucleotideResidue has__Nucleotide__State) throws JastorException {
	...
	public org.cdao.jastor.DesoxiRibonucleotideResidue addHas__Nucleotide__State_asDesoxiRibonucleotideResidue() throws JastorException {
		org.cdao.jastor.DesoxiRibonucleotideResidue has__Nucleotide__State = org.cdao.jastor.CDAOFactory.createDesoxiRibonucleotideResidue(_model.createResource(),_model);
		if (this.has__Nucleotide__State_asDesoxiRibonucleotideResidue == null)
			initHas__Nucleotide__State_asDesoxiRibonucleotideResidue();
		this.has__Nucleotide__State_asDesoxiRibonucleotideResidue.add(has__Nucleotide__State);
		_model.add(_model.createStatement(_resource,has__Nucleotide__StateProperty,has__Nucleotide__State.resource()));
	...
	public org.cdao.jastor.DesoxiRibonucleotideResidue addHas__Nucleotide__State_asDesoxiRibonucleotideResidue(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.DesoxiRibonucleotideResidue has__Nucleotide__State = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidue(resource,_model);
		if (this.has__Nucleotide__State_asDesoxiRibonucleotideResidue == null)
			initHas__Nucleotide__State_asDesoxiRibonucleotideResidue();
		if (this.has__Nucleotide__State_asDesoxiRibonucleotideResidue.contains(has__Nucleotide__State))
	...
	public void removeHas__Nucleotide__State(org.cdao.jastor.DesoxiRibonucleotideResidue has__Nucleotide__State) throws JastorException {
		if (this.has__Nucleotide__State_asDesoxiRibonucleotideResidue == null)
			initHas__Nucleotide__State_asDesoxiRibonucleotideResidue();
		if (!this.has__Nucleotide__State_asDesoxiRibonucleotideResidue.contains(has__Nucleotide__State))
			return;
	...
	private void initHas__Nucleotide__State_asGeneric__State() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
				org.cdao.jastor.Generic__State has__Nucleotide__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
	...
	public void addHas__Nucleotide__State(org.cdao.jastor.Generic__State has__Nucleotide__State) throws JastorException {
	...
	public org.cdao.jastor.Generic__State addHas__Nucleotide__State_asGeneric__State() throws JastorException {
		org.cdao.jastor.Generic__State has__Nucleotide__State = org.cdao.jastor.CDAOFactory.createGeneric__State(_model.createResource(),_model);
		if (this.has__Nucleotide__State_asGeneric__State == null)
			initHas__Nucleotide__State_asGeneric__State();
		this.has__Nucleotide__State_asGeneric__State.add(has__Nucleotide__State);
		_model.add(_model.createStatement(_resource,has__Nucleotide__StateProperty,has__Nucleotide__State.resource()));
	...
	public org.cdao.jastor.Generic__State addHas__Nucleotide__State_asGeneric__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Generic__State has__Nucleotide__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
		if (this.has__Nucleotide__State_asGeneric__State == null)
			initHas__Nucleotide__State_asGeneric__State();
		if (this.has__Nucleotide__State_asGeneric__State.contains(has__Nucleotide__State))
	...
	public void removeHas__Nucleotide__State(org.cdao.jastor.Generic__State has__Nucleotide__State) throws JastorException {
		if (this.has__Nucleotide__State_asGeneric__State == null)
			initHas__Nucleotide__State_asGeneric__State();
		if (!this.has__Nucleotide__State_asGeneric__State.contains(has__Nucleotide__State))
			return;
	...
	public org.cdao.jastor.DesoxiRibonucleotideResidueCharacter getBelongs__to__Nucleotide__Character() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Nucleotide__Character getProperty() in org.cdao.jasper.DesoxiRibonucleotideResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		belongs__to__Nucleotide__Character = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidueCharacter(resource,_model);
		return belongs__to__Nucleotide__Character;
	}

	public void setBelongs__to__Nucleotide__Character(org.cdao.jastor.DesoxiRibonucleotideResidueCharacter belongs__to__Nucleotide__Character) throws JastorException {
	...
	public org.cdao.jastor.DesoxiRibonucleotideResidueCharacter setBelongs__to__Nucleotide__Character() throws JastorException {
		if (_model.contains(_resource,belongs__to__Nucleotide__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Nucleotide__CharacterProperty,null);
		}
		org.cdao.jastor.DesoxiRibonucleotideResidueCharacter belongs__to__Nucleotide__Character = org.cdao.jastor.CDAOFactory.createDesoxiRibonucleotideResidueCharacter(_model.createResource(),_model);
		this.belongs__to__Nucleotide__Character = belongs__to__Nucleotide__Character;
		_model.add(_model.createStatement(_resource,belongs__to__Nucleotide__CharacterProperty, belongs__to__Nucleotide__Character.resource()));
		return belongs__to__Nucleotide__Character;
	}
	
	public org.cdao.jastor.DesoxiRibonucleotideResidueCharacter setBelongs__to__Nucleotide__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,belongs__to__Nucleotide__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Nucleotide__CharacterProperty,null);
		}
		org.cdao.jastor.DesoxiRibonucleotideResidueCharacter belongs__to__Nucleotide__Character = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidueCharacter(resource,_model);
		this.belongs__to__Nucleotide__Character = belongs__to__Nucleotide__Character;
		_model.add(_model.createStatement(_resource,belongs__to__Nucleotide__CharacterProperty, belongs__to__Nucleotide__Character.resource()));
		return belongs__to__Nucleotide__Character;
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							...
							listener.has__CoordinateAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__TUProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.belongs__to__TUChanged(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__StateAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.belongs__to__CharacterChanged(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.homologous__toAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.hasAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Nucleotide__StateProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jastor.DesoxiRibonucleotideResidue.TYPE)) {
					org.cdao.jastor.DesoxiRibonucleotideResidue _has__Nucleotide__State_asDesoxiRibonucleotideResidue = null;
					try {
						_has__Nucleotide__State_asDesoxiRibonucleotideResidue = org.cdao.jastor.CDAOFactory.getDesoxiRibonucleotideResidue(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Nucleotide__State_asDesoxiRibonucleotideResidue == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__State_asDesoxiRibonucleotideResidue.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__Nucleotide__StateAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Nucleotide__State_asDesoxiRibonucleotideResidue);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
					org.cdao.jastor.Generic__State _has__Nucleotide__State_asGeneric__State = null;
					try {
						_has__Nucleotide__State_asGeneric__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Nucleotide__State_asGeneric__State == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__State_asGeneric__State.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__Nucleotide__StateAdded(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Nucleotide__State_asGeneric__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Nucleotide__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.belongs__to__Nucleotide__CharacterChanged(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(has__CoordinateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__CoordinateRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__StateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__StateRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(homologous__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.homologous__toRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,org.cdao.jastor.DesoxiRibonucleotideResidue.TYPE)) {
					...
					if (has__Nucleotide__State_asDesoxiRibonucleotideResidue != null) {
						...
						for (int i=0;i<has__Nucleotide__State_asDesoxiRibonucleotideResidue.size();i++) {
							org.cdao.jastor.DesoxiRibonucleotideResidue __item = (org.cdao.jastor.DesoxiRibonucleotideResidue) has__Nucleotide__State_asDesoxiRibonucleotideResidue.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__State_asDesoxiRibonucleotideResidue.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__Nucleotide__StateRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Nucleotide__State_asDesoxiRibonucleotideResidue);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
					...
					if (has__Nucleotide__State_asGeneric__State != null) {
						...
						for (int i=0;i<has__Nucleotide__State_asGeneric__State.size();i++) {
							org.cdao.jastor.Generic__State __item = (org.cdao.jastor.Generic__State) has__Nucleotide__State_asGeneric__State.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Nucleotide__State_asGeneric__State.iterator();iter.hasNext();){
							DesoxiRibonucleotideResidueStateDatumListener listener=(DesoxiRibonucleotideResidueStateDatumListener)iter.next();
							listener.has__Nucleotide__StateRemoved(org.cdao.jastor.DesoxiRibonucleotideResidueStateDatumImpl.this,_has__Nucleotide__State_asGeneric__State);
						}
					}
				}
				return;
