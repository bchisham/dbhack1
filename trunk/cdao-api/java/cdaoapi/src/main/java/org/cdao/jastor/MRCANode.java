...
/**
 * Interface for MRCANode ontology class<br>
 ...
 * 	description : The most recent common ancestor of a collection of nodes in the tree <br>
 * <br>
 */
public interface MRCANode extends org.cdao.jastor.CommonAncestralNode, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#MRCANode");
