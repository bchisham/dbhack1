 ...
 * <br>
 */
public interface CoordinatePoint extends org.cdao.jastor.DatumCoordinate, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#CoordinatePoint");
	

	/**
	 * The Jena Property for has__Point__Coordinate__Value 
	 * <p>(URI: http://localhost/~vivek/cdao.owl#has_Point_Coordinate_Value)</p>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__Point__Coordinate__ValueProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Point_Coordinate_Value");
