...
/**
 * Interface for EdgeAnnotation ontology class<br>
 ...
 * 	description : Additional information that can be attached to a single edge <br>
 * <br>
 */
public interface EdgeAnnotation extends org.cdao.jastor.CDAOAnnotation, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#EdgeAnnotation");
