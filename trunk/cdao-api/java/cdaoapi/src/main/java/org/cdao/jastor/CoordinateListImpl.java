...
/**
 * Implementation of {@link org.cdao.jastor.CoordinateList}
 ...
 * <br>
 */
public class CoordinateListImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.CoordinateList {
	

	private static com.hp.hpl.jena.rdf.model.Property has__Coordinate__SystemProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Coordinate_System");
	private org.cdao.jastor.CoordinateSystem has__Coordinate__System;
	...
	private static com.hp.hpl.jena.rdf.model.Property has__Remaining__Coordinate__ListProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Remaining_Coordinate_List");
	private java.util.ArrayList has__Remaining__Coordinate__List;
	private static com.hp.hpl.jena.rdf.model.Property has__First__Coordinate__ItemProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_First_Coordinate_Item");
	...
	void addSuperTypes() {
		if (!_model.contains(_resource, RDF.type, org.cdao.jastor.DatumCoordinate.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jastor.DatumCoordinate.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.CoordinateList.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.DatumCoordinate.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	public org.cdao.jastor.CoordinateSystem getHas__Coordinate__System() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": has__Coordinate__System getProperty() in org.cdao.jasper.CoordinateList model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		has__Coordinate__System = org.cdao.jastor.CDAOFactory.getCoordinateSystem(resource,_model);
		return has__Coordinate__System;
	}

	public void setHas__Coordinate__System(org.cdao.jastor.CoordinateSystem has__Coordinate__System) throws JastorException {
	...
	public org.cdao.jastor.CoordinateSystem setHas__Coordinate__System() throws JastorException {
		if (_model.contains(_resource,has__Coordinate__SystemProperty)) {
			_model.removeAll(_resource,has__Coordinate__SystemProperty,null);
		}
		org.cdao.jastor.CoordinateSystem has__Coordinate__System = org.cdao.jastor.CDAOFactory.createCoordinateSystem(_model.createResource(),_model);
		this.has__Coordinate__System = has__Coordinate__System;
		_model.add(_model.createStatement(_resource,has__Coordinate__SystemProperty, has__Coordinate__System.resource()));
		return has__Coordinate__System;
	}
	
	public org.cdao.jastor.CoordinateSystem setHas__Coordinate__System(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,has__Coordinate__SystemProperty)) {
			_model.removeAll(_resource,has__Coordinate__SystemProperty,null);
		}
		org.cdao.jastor.CoordinateSystem has__Coordinate__System = org.cdao.jastor.CDAOFactory.getCoordinateSystem(resource,_model);
		this.has__Coordinate__System = has__Coordinate__System;
		_model.add(_model.createStatement(_resource,has__Coordinate__SystemProperty, has__Coordinate__System.resource()));
		return has__Coordinate__System;
	}
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in CoordinateList model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in CoordinateList model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Remaining__Coordinate__List() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Remaining_Coordinate_List properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				org.cdao.jastor.CoordinateList has__Remaining__Coordinate__List = org.cdao.jastor.CDAOFactory.getCoordinateList(resource,_model);
	...
	public void addHas__Remaining__Coordinate__List(org.cdao.jastor.CoordinateList has__Remaining__Coordinate__List) throws JastorException {
	...
	public org.cdao.jastor.CoordinateList addHas__Remaining__Coordinate__List() throws JastorException {
		org.cdao.jastor.CoordinateList has__Remaining__Coordinate__List = org.cdao.jastor.CDAOFactory.createCoordinateList(_model.createResource(),_model);
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		this.has__Remaining__Coordinate__List.add(has__Remaining__Coordinate__List);
		_model.add(_model.createStatement(_resource,has__Remaining__Coordinate__ListProperty,has__Remaining__Coordinate__List.resource()));
	...
	public org.cdao.jastor.CoordinateList addHas__Remaining__Coordinate__List(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CoordinateList has__Remaining__Coordinate__List = org.cdao.jastor.CDAOFactory.getCoordinateList(resource,_model);
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		if (this.has__Remaining__Coordinate__List.contains(has__Remaining__Coordinate__List))
	...
	public void removeHas__Remaining__Coordinate__List(org.cdao.jastor.CoordinateList has__Remaining__Coordinate__List) throws JastorException {
		if (this.has__Remaining__Coordinate__List == null)
			initHas__Remaining__Coordinate__List();
		if (!this.has__Remaining__Coordinate__List.contains(has__Remaining__Coordinate__List))
			return;
	...
	private void initHas__First__Coordinate__Item_asCoordinatePoint() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_First_Coordinate_Item properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.CoordinatePoint.TYPE)) {
				org.cdao.jastor.CoordinatePoint has__First__Coordinate__Item = org.cdao.jastor.CDAOFactory.getCoordinatePoint(resource,_model);
	...
	public void addHas__First__Coordinate__Item(org.cdao.jastor.CoordinatePoint has__First__Coordinate__Item) throws JastorException {
	...
	public org.cdao.jastor.CoordinatePoint addHas__First__Coordinate__Item_asCoordinatePoint() throws JastorException {
		org.cdao.jastor.CoordinatePoint has__First__Coordinate__Item = org.cdao.jastor.CDAOFactory.createCoordinatePoint(_model.createResource(),_model);
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		this.has__First__Coordinate__Item_asCoordinatePoint.add(has__First__Coordinate__Item);
		_model.add(_model.createStatement(_resource,has__First__Coordinate__ItemProperty,has__First__Coordinate__Item.resource()));
	...
	public org.cdao.jastor.CoordinatePoint addHas__First__Coordinate__Item_asCoordinatePoint(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CoordinatePoint has__First__Coordinate__Item = org.cdao.jastor.CDAOFactory.getCoordinatePoint(resource,_model);
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		if (this.has__First__Coordinate__Item_asCoordinatePoint.contains(has__First__Coordinate__Item))
	...
	public void removeHas__First__Coordinate__Item(org.cdao.jastor.CoordinatePoint has__First__Coordinate__Item) throws JastorException {
		if (this.has__First__Coordinate__Item_asCoordinatePoint == null)
			initHas__First__Coordinate__Item_asCoordinatePoint();
		if (!this.has__First__Coordinate__Item_asCoordinatePoint.contains(has__First__Coordinate__Item))
			return;
	...
	private void initHas__First__Coordinate__Item_asCoordinateRange() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_First_Coordinate_Item properties in CoordinateList model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.CoordinateRange.TYPE)) {
				org.cdao.jastor.CoordinateRange has__First__Coordinate__Item = org.cdao.jastor.CDAOFactory.getCoordinateRange(resource,_model);
	...
	public void addHas__First__Coordinate__Item(org.cdao.jastor.CoordinateRange has__First__Coordinate__Item) throws JastorException {
	...
	public org.cdao.jastor.CoordinateRange addHas__First__Coordinate__Item_asCoordinateRange() throws JastorException {
		org.cdao.jastor.CoordinateRange has__First__Coordinate__Item = org.cdao.jastor.CDAOFactory.createCoordinateRange(_model.createResource(),_model);
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		this.has__First__Coordinate__Item_asCoordinateRange.add(has__First__Coordinate__Item);
		_model.add(_model.createStatement(_resource,has__First__Coordinate__ItemProperty,has__First__Coordinate__Item.resource()));
	...
	public org.cdao.jastor.CoordinateRange addHas__First__Coordinate__Item_asCoordinateRange(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.CoordinateRange has__First__Coordinate__Item = org.cdao.jastor.CDAOFactory.getCoordinateRange(resource,_model);
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		if (this.has__First__Coordinate__Item_asCoordinateRange.contains(has__First__Coordinate__Item))
	...
	public void removeHas__First__Coordinate__Item(org.cdao.jastor.CoordinateRange has__First__Coordinate__Item) throws JastorException {
		if (this.has__First__Coordinate__Item_asCoordinateRange == null)
			initHas__First__Coordinate__Item_asCoordinateRange();
		if (!this.has__First__Coordinate__Item_asCoordinateRange.contains(has__First__Coordinate__Item))
			return;
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(has__Coordinate__SystemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						...
						listener.has__Coordinate__SystemChanged(org.cdao.jastor.CoordinateListImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.CoordinateListImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.CoordinateListImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.CoordinateListImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.CoordinateListImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.CoordinateListImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.hasAdded(org.cdao.jastor.CoordinateListImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.CoordinateListImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.CoordinateListImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__Remaining__Coordinate__ListProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					org.cdao.jastor.CoordinateList _has__Remaining__Coordinate__List = null;
					try {
						_has__Remaining__Coordinate__List = org.cdao.jastor.CDAOFactory.getCoordinateList(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Remaining__Coordinate__List == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Remaining__Coordinate__List.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__Remaining__Coordinate__ListAdded(org.cdao.jastor.CoordinateListImpl.this,_has__Remaining__Coordinate__List);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__First__Coordinate__ItemProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CoordinatePoint.TYPE)) {
					org.cdao.jastor.CoordinatePoint _has__First__Coordinate__Item_asCoordinatePoint = null;
					try {
						_has__First__Coordinate__Item_asCoordinatePoint = org.cdao.jastor.CDAOFactory.getCoordinatePoint(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__First__Coordinate__Item_asCoordinatePoint == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinatePoint.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemAdded(org.cdao.jastor.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinatePoint);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CoordinateRange.TYPE)) {
					org.cdao.jastor.CoordinateRange _has__First__Coordinate__Item_asCoordinateRange = null;
					try {
						_has__First__Coordinate__Item_asCoordinateRange = org.cdao.jastor.CDAOFactory.getCoordinateRange(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__First__Coordinate__Item_asCoordinateRange == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinateRange.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemAdded(org.cdao.jastor.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinateRange);
						}
					}
				}
				return;
...
//				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.CoordinateListImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.CoordinateListImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.CoordinateListImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.CoordinateListImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						CoordinateListListener listener=(CoordinateListListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.CoordinateListImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.CoordinateListImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.CoordinateListImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.CoordinateListImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.CoordinateListImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__Remaining__Coordinate__List != null) {
						...
						for (int i=0;i<has__Remaining__Coordinate__List.size();i++) {
							org.cdao.jastor.CoordinateList __item = (org.cdao.jastor.CoordinateList) has__Remaining__Coordinate__List.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Remaining__Coordinate__List.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__Remaining__Coordinate__ListRemoved(org.cdao.jastor.CoordinateListImpl.this,_has__Remaining__Coordinate__List);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CoordinatePoint.TYPE)) {
					...
					if (has__First__Coordinate__Item_asCoordinatePoint != null) {
						...
						for (int i=0;i<has__First__Coordinate__Item_asCoordinatePoint.size();i++) {
							org.cdao.jastor.CoordinatePoint __item = (org.cdao.jastor.CoordinatePoint) has__First__Coordinate__Item_asCoordinatePoint.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinatePoint.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemRemoved(org.cdao.jastor.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinatePoint);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.CoordinateRange.TYPE)) {
					...
					if (has__First__Coordinate__Item_asCoordinateRange != null) {
						...
						for (int i=0;i<has__First__Coordinate__Item_asCoordinateRange.size();i++) {
							org.cdao.jastor.CoordinateRange __item = (org.cdao.jastor.CoordinateRange) has__First__Coordinate__Item_asCoordinateRange.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__First__Coordinate__Item_asCoordinateRange.iterator();iter.hasNext();){
							CoordinateListListener listener=(CoordinateListListener)iter.next();
							listener.has__First__Coordinate__ItemRemoved(org.cdao.jastor.CoordinateListImpl.this,_has__First__Coordinate__Item_asCoordinateRange);
						}
					}
				}
				return;
