...
/**
 * Interface for UnrootedTree ontology class<br>
 ...
 * 	description : Tree where the root is unknown  <br>
 * <br>
 */
public interface UnrootedTree extends org.cdao.jastor.Tree, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#UnrootedTree");
