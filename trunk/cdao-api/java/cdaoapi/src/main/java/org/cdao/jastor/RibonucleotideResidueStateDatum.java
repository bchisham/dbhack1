 ...
 * <br>
 */
public interface RibonucleotideResidueStateDatum extends org.cdao.jastor.MolecularStateDatum, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#RibonucleotideResidueStateDatum");
