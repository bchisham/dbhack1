...
/**
 * Implementation of {@link org.cdao.jastor.SetOfNodes}
 * Use the org.cdao.jasper.CDAOFactory to create instances of this class.
 * <p>(URI: http://localhost/~vivek/cdao.owl#SetOfNodes)</p>
 * <br>
 */
public class SetOfNodesImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.SetOfNodes {
	

	private static com.hp.hpl.jena.rdf.model.Property has__ElementProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Element");
	...
	void addSuperTypes() {
		if (!_model.contains(_resource, RDF.type, org.cdao.jastor.SetOfThings.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jastor.SetOfThings.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.SetOfNodes.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.SetOfThings.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initHas__Element() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Element properties in SetOfNodes model not a Resource", stmt.getObject());
	...
	private void initHas__Element_asNode() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Node.TYPE)) {
				org.cdao.jastor.Node has__Element = org.cdao.jastor.CDAOFactory.getNode(resource,_model);
	...
	public void addHas__Element(org.cdao.jastor.Node has__Element) throws JastorException {
	...
	public org.cdao.jastor.Node addHas__Element_asNode() throws JastorException {
		org.cdao.jastor.Node has__Element = org.cdao.jastor.CDAOFactory.createNode(_model.createResource(),_model);
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		this.has__Element_asNode.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public org.cdao.jastor.Node addHas__Element_asNode(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Node has__Element = org.cdao.jastor.CDAOFactory.getNode(resource,_model);
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		if (this.has__Element_asNode.contains(has__Element))
	...
	public void removeHas__Element(org.cdao.jastor.Node has__Element) throws JastorException {
		if (this.has__Element_asNode == null)
			initHas__Element_asNode();
		if (!this.has__Element_asNode.contains(has__Element))
			return;
	...
	private void initHas__Element_asCharacter() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Element properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Character.TYPE)) {
				org.cdao.jastor.Character has__Element = org.cdao.jastor.CDAOFactory.getCharacter(resource,_model);
	...
	public void addHas__Element(org.cdao.jastor.Character has__Element) throws JastorException {
	...
	public org.cdao.jastor.Character addHas__Element_asCharacter() throws JastorException {
		org.cdao.jastor.Character has__Element = org.cdao.jastor.CDAOFactory.createCharacter(_model.createResource(),_model);
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		this.has__Element_asCharacter.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public org.cdao.jastor.Character addHas__Element_asCharacter(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Character has__Element = org.cdao.jastor.CDAOFactory.getCharacter(resource,_model);
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		if (this.has__Element_asCharacter.contains(has__Element))
	...
	public void removeHas__Element(org.cdao.jastor.Character has__Element) throws JastorException {
		if (this.has__Element_asCharacter == null)
			initHas__Element_asCharacter();
		if (!this.has__Element_asCharacter.contains(has__Element))
			return;
	...
	private void initHas__Element_asSetOfCharacters() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Element properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.SetOfCharacters.TYPE)) {
				org.cdao.jastor.SetOfCharacters has__Element = org.cdao.jastor.CDAOFactory.getSetOfCharacters(resource,_model);
	...
	public void addHas__Element(org.cdao.jastor.SetOfCharacters has__Element) throws JastorException {
	...
	public org.cdao.jastor.SetOfCharacters addHas__Element_asSetOfCharacters() throws JastorException {
		org.cdao.jastor.SetOfCharacters has__Element = org.cdao.jastor.CDAOFactory.createSetOfCharacters(_model.createResource(),_model);
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		this.has__Element_asSetOfCharacters.add(has__Element);
		_model.add(_model.createStatement(_resource,has__ElementProperty,has__Element.resource()));
	...
	public org.cdao.jastor.SetOfCharacters addHas__Element_asSetOfCharacters(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.SetOfCharacters has__Element = org.cdao.jastor.CDAOFactory.getSetOfCharacters(resource,_model);
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		if (this.has__Element_asSetOfCharacters.contains(has__Element))
	...
	public void removeHas__Element(org.cdao.jastor.SetOfCharacters has__Element) throws JastorException {
		if (this.has__Element_asSetOfCharacters == null)
			initHas__Element_asSetOfCharacters();
		if (!this.has__Element_asSetOfCharacters.contains(has__Element))
			return;
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in SetOfNodes model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in SetOfNodes model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in SetOfNodes model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element.iterator();iter.hasNext();){
							...
							listener.has__ElementAdded(org.cdao.jastor.SetOfNodesImpl.this,_has__Element);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Node.TYPE)) {
					org.cdao.jastor.Node _has__Element_asNode = null;
					try {
						_has__Element_asNode = org.cdao.jastor.CDAOFactory.getNode(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Element_asNode == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asNode.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jastor.SetOfNodesImpl.this,_has__Element_asNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Character.TYPE)) {
					org.cdao.jastor.Character _has__Element_asCharacter = null;
					try {
						_has__Element_asCharacter = org.cdao.jastor.CDAOFactory.getCharacter(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Element_asCharacter == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asCharacter.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jastor.SetOfNodesImpl.this,_has__Element_asCharacter);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.SetOfCharacters.TYPE)) {
					org.cdao.jastor.SetOfCharacters _has__Element_asSetOfCharacters = null;
					try {
						_has__Element_asSetOfCharacters = org.cdao.jastor.CDAOFactory.getSetOfCharacters(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Element_asSetOfCharacters == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asSetOfCharacters.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementAdded(org.cdao.jastor.SetOfNodesImpl.this,_has__Element_asSetOfCharacters);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.SetOfNodesImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.SetOfNodesImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.SetOfNodesImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.SetOfNodesImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.hasAdded(org.cdao.jastor.SetOfNodesImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.SetOfNodesImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.SetOfNodesImpl.this,_precedes);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__ElementProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jastor.SetOfNodesImpl.this,_has__Element);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Node.TYPE)) {
					...
					if (has__Element_asNode != null) {
						...
						for (int i=0;i<has__Element_asNode.size();i++) {
							org.cdao.jastor.Node __item = (org.cdao.jastor.Node) has__Element_asNode.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asNode.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jastor.SetOfNodesImpl.this,_has__Element_asNode);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Character.TYPE)) {
					...
					if (has__Element_asCharacter != null) {
						...
						for (int i=0;i<has__Element_asCharacter.size();i++) {
							org.cdao.jastor.Character __item = (org.cdao.jastor.Character) has__Element_asCharacter.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asCharacter.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jastor.SetOfNodesImpl.this,_has__Element_asCharacter);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.SetOfCharacters.TYPE)) {
					...
					if (has__Element_asSetOfCharacters != null) {
						...
						for (int i=0;i<has__Element_asSetOfCharacters.size();i++) {
							org.cdao.jastor.SetOfCharacters __item = (org.cdao.jastor.SetOfCharacters) has__Element_asSetOfCharacters.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Element_asSetOfCharacters.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__ElementRemoved(org.cdao.jastor.SetOfNodesImpl.this,_has__Element_asSetOfCharacters);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.SetOfNodesImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.SetOfNodesImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.SetOfNodesImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						SetOfNodesListener listener=(SetOfNodesListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.SetOfNodesImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.SetOfNodesImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.SetOfNodesImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.SetOfNodesImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							SetOfNodesListener listener=(SetOfNodesListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.SetOfNodesImpl.this,_precedes);
						}
					}
				}
				return;
