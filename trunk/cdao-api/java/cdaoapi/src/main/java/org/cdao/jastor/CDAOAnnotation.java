...
public interface CDAOAnnotation extends com.ibm.adtech.jastor.Thing {
     ...
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#CDAOAnnotation");
	

	/**
	 * The Jena Property for is__annotation__of 
	 * <p>(URI: http://localhost/~vivek/cdao.owl#is_annotation_of)</p>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property is__annotation__ofProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#is_annotation_of");
