...
/**
 * Interface for AminoAcid ontology class<br>
 ...
 * 	creator : CDAO-team <br>
 * 	description : This class describes a single amino acid residue; the concrete definition is imported from the external ontology at www.co-ode.org/ontologies/amino-acid. <br>
 * 	date : 09/15/2008 <br>
 * <br>
 */
public interface AminoAcid extends com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://www.co-ode.org/ontologies/amino-acid/2005/10/11/amino-acid.owl#AminoAcid");
