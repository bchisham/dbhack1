...
/**
 * Interface for AncestralNode ontology class<br>
 ...
 * 	description : A node that has descendants in the tree <br>
 * <br>
 */
public interface AncestralNode extends org.cdao.jastor.Node, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#AncestralNode");
