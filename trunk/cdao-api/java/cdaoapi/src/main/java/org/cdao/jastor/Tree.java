...
/**
 * Interface for Tree ontology class<br>
 ...
 * 	description : A c Tree represents evolutionary paths of descent-with-modification from common ancestors. Typically a  Tree is assumed to be a connected, acyclic graph in which Nodes have no more than one parent <br>
 * <br>
 */
public interface Tree extends org.cdao.jastor.Network, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#Tree");
