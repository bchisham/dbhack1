...
/**
 * Implementation of {@link org.cdao.jastor.AminoAcidResidueStateDatum}
 ...
 * <br>
 */
public class AminoAcidResidueStateDatumImpl extends com.ibm.adtech.jastor.ThingImpl implements org.cdao.jastor.AminoAcidResidueStateDatum {
	...
	private static com.hp.hpl.jena.rdf.model.Property belongs__to__Amino__Acid__CharacterProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#belongs_to_Amino_Acid_Character");
	private org.cdao.jastor.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character;
	private static com.hp.hpl.jena.rdf.model.Property has__Amino__Acid__StateProperty = ResourceFactory.createProperty("http://localhost/~vivek/cdao.owl#has_Amino_Acid_State");
	...
	void addSuperTypes() {
		...
		if (!_model.contains(_resource, RDF.type, org.cdao.jastor.CategoricalStateDatum.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jastor.CategoricalStateDatum.TYPE));     
		if (!_model.contains(_resource, RDF.type, org.cdao.jastor.MolecularStateDatum.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, org.cdao.jastor.MolecularStateDatum.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.AminoAcidResidueStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.CategoricalStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		it = _model.listStatements(_resource,RDF.type, org.cdao.jastor.MolecularStateDatum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initHas__Coordinate() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Coordinate properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
	...
	public org.cdao.jastor.TU getBelongs__to__TU() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__TU getProperty() in org.cdao.jasper.AminoAcidResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHas__State() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_State properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jastor.Character getBelongs__to__Character() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Character getProperty() in org.cdao.jasper.AminoAcidResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initHomologous__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#homologous_to properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Annotation() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Annotation properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initBelongs__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#belongs_to properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__Value() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
	...
	private void initHas__Support__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Support_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Float__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Float_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Int__Value() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Int_Value properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__Uncertainty__Factor() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Uncertainty_Factor properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__Precision() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Precision properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.Float","http://www.w3.org/2001/XMLSchema#float");
			if (obj != null)
	...
	private void initHas__External__Reference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_External_Reference properties in AminoAcidResidueStateDatum model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initConnects__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#connects_to properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#part_of properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrecedes() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#precedes properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public org.cdao.jastor.AminoAcidResidueCharacter getBelongs__to__Amino__Acid__Character() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": belongs__to__Amino__Acid__Character getProperty() in org.cdao.jasper.AminoAcidResidueStateDatum model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
		belongs__to__Amino__Acid__Character = org.cdao.jastor.CDAOFactory.getAminoAcidResidueCharacter(resource,_model);
		return belongs__to__Amino__Acid__Character;
	}

	public void setBelongs__to__Amino__Acid__Character(org.cdao.jastor.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character) throws JastorException {
	...
	public org.cdao.jastor.AminoAcidResidueCharacter setBelongs__to__Amino__Acid__Character() throws JastorException {
		if (_model.contains(_resource,belongs__to__Amino__Acid__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Amino__Acid__CharacterProperty,null);
		}
		org.cdao.jastor.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character = org.cdao.jastor.CDAOFactory.createAminoAcidResidueCharacter(_model.createResource(),_model);
		this.belongs__to__Amino__Acid__Character = belongs__to__Amino__Acid__Character;
		_model.add(_model.createStatement(_resource,belongs__to__Amino__Acid__CharacterProperty, belongs__to__Amino__Acid__Character.resource()));
		return belongs__to__Amino__Acid__Character;
	}
	
	public org.cdao.jastor.AminoAcidResidueCharacter setBelongs__to__Amino__Acid__Character(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		if (_model.contains(_resource,belongs__to__Amino__Acid__CharacterProperty)) {
			_model.removeAll(_resource,belongs__to__Amino__Acid__CharacterProperty,null);
		}
		org.cdao.jastor.AminoAcidResidueCharacter belongs__to__Amino__Acid__Character = org.cdao.jastor.CDAOFactory.getAminoAcidResidueCharacter(resource,_model);
		this.belongs__to__Amino__Acid__Character = belongs__to__Amino__Acid__Character;
		_model.add(_model.createStatement(_resource,belongs__to__Amino__Acid__CharacterProperty, belongs__to__Amino__Acid__Character.resource()));
		return belongs__to__Amino__Acid__Character;
	}
	...
	private void initHas__Amino__Acid__State_asAminoAcidResidue() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Amino_Acid_State properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.AminoAcidResidue.TYPE)) {
				org.cdao.jastor.AminoAcidResidue has__Amino__Acid__State = org.cdao.jastor.CDAOFactory.getAminoAcidResidue(resource,_model);
	...
	public void addHas__Amino__Acid__State(org.cdao.jastor.AminoAcidResidue has__Amino__Acid__State) throws JastorException {
	...
	public org.cdao.jastor.AminoAcidResidue addHas__Amino__Acid__State_asAminoAcidResidue() throws JastorException {
		org.cdao.jastor.AminoAcidResidue has__Amino__Acid__State = org.cdao.jastor.CDAOFactory.createAminoAcidResidue(_model.createResource(),_model);
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		this.has__Amino__Acid__State_asAminoAcidResidue.add(has__Amino__Acid__State);
		_model.add(_model.createStatement(_resource,has__Amino__Acid__StateProperty,has__Amino__Acid__State.resource()));
	...
	public org.cdao.jastor.AminoAcidResidue addHas__Amino__Acid__State_asAminoAcidResidue(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.AminoAcidResidue has__Amino__Acid__State = org.cdao.jastor.CDAOFactory.getAminoAcidResidue(resource,_model);
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		if (this.has__Amino__Acid__State_asAminoAcidResidue.contains(has__Amino__Acid__State))
	...
	public void removeHas__Amino__Acid__State(org.cdao.jastor.AminoAcidResidue has__Amino__Acid__State) throws JastorException {
		if (this.has__Amino__Acid__State_asAminoAcidResidue == null)
			initHas__Amino__Acid__State_asAminoAcidResidue();
		if (!this.has__Amino__Acid__State_asAminoAcidResidue.contains(has__Amino__Acid__State))
			return;
	...
	private void initHas__Amino__Acid__State_asGeneric__State() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://localhost/~vivek/cdao.owl#has_Amino_Acid_State properties in AminoAcidResidueStateDatum model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
				org.cdao.jastor.Generic__State has__Amino__Acid__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
	...
	public void addHas__Amino__Acid__State(org.cdao.jastor.Generic__State has__Amino__Acid__State) throws JastorException {
	...
	public org.cdao.jastor.Generic__State addHas__Amino__Acid__State_asGeneric__State() throws JastorException {
		org.cdao.jastor.Generic__State has__Amino__Acid__State = org.cdao.jastor.CDAOFactory.createGeneric__State(_model.createResource(),_model);
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		this.has__Amino__Acid__State_asGeneric__State.add(has__Amino__Acid__State);
		_model.add(_model.createStatement(_resource,has__Amino__Acid__StateProperty,has__Amino__Acid__State.resource()));
	...
	public org.cdao.jastor.Generic__State addHas__Amino__Acid__State_asGeneric__State(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		org.cdao.jastor.Generic__State has__Amino__Acid__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		if (this.has__Amino__Acid__State_asGeneric__State.contains(has__Amino__Acid__State))
	...
	public void removeHas__Amino__Acid__State(org.cdao.jastor.Generic__State has__Amino__Acid__State) throws JastorException {
		if (this.has__Amino__Acid__State_asGeneric__State == null)
			initHas__Amino__Acid__State_asGeneric__State();
		if (!this.has__Amino__Acid__State_asGeneric__State.contains(has__Amino__Acid__State))
			return;
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							...
							listener.has__CoordinateAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__TUProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.belongs__to__TUChanged(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__StateAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.belongs__to__CharacterChanged(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.homologous__toAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__AnnotationAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.belongs__toAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__ValueAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Support__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Support__ValueAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Float__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Float__ValueAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Int__Value.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Int__ValueAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Uncertainty__Factor.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__Precision.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__PrecisionAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__External__ReferenceAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.connects__toAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.hasAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.part__ofAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.precedesAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__to__Amino__Acid__CharacterProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.belongs__to__Amino__Acid__CharacterChanged(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Amino__Acid__StateProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (_model.contains(resource,RDF.type,org.cdao.jastor.AminoAcidResidue.TYPE)) {
					org.cdao.jastor.AminoAcidResidue _has__Amino__Acid__State_asAminoAcidResidue = null;
					try {
						_has__Amino__Acid__State_asAminoAcidResidue = org.cdao.jastor.CDAOFactory.getAminoAcidResidue(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Amino__Acid__State_asAminoAcidResidue == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asAminoAcidResidue.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asAminoAcidResidue);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
					org.cdao.jastor.Generic__State _has__Amino__Acid__State_asGeneric__State = null;
					try {
						_has__Amino__Acid__State_asGeneric__State = org.cdao.jastor.CDAOFactory.getGeneric__State(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__Amino__Acid__State_asGeneric__State == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asGeneric__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateAdded(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asGeneric__State);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(has__CoordinateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Coordinate.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__CoordinateRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Coordinate);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__StateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__StateRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__State);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(homologous__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomologous__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.homologous__toRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_homologous__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__AnnotationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Annotation.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__AnnotationRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Annotation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(belongs__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBelongs__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.belongs__toRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_belongs__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__ValueRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Support__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Support__ValueRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Float__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Float__ValueRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Int__ValueProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Int__ValueRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__Uncertainty__FactorProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__Uncertainty__FactorRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__PrecisionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__PrecisionRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,(java.lang.Float)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__External__ReferenceProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHas__External__Reference.iterator();iter.hasNext();){
						AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
						listener.has__External__ReferenceRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(connects__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForConnects__to.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.connects__toRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_connects__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.hasRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.part__ofRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(precedesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrecedes.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.precedesRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_precedes);
						}
					}
				}
				return;
				...
				if (_model.contains(resource,RDF.type,org.cdao.jastor.AminoAcidResidue.TYPE)) {
					...
					if (has__Amino__Acid__State_asAminoAcidResidue != null) {
						...
						for (int i=0;i<has__Amino__Acid__State_asAminoAcidResidue.size();i++) {
							org.cdao.jastor.AminoAcidResidue __item = (org.cdao.jastor.AminoAcidResidue) has__Amino__Acid__State_asAminoAcidResidue.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asAminoAcidResidue.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asAminoAcidResidue);
						}
					}
				}
				if (_model.contains(resource,RDF.type,org.cdao.jastor.Generic__State.TYPE)) {
					...
					if (has__Amino__Acid__State_asGeneric__State != null) {
						...
						for (int i=0;i<has__Amino__Acid__State_asGeneric__State.size();i++) {
							org.cdao.jastor.Generic__State __item = (org.cdao.jastor.Generic__State) has__Amino__Acid__State_asGeneric__State.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__Amino__Acid__State_asGeneric__State.iterator();iter.hasNext();){
							AminoAcidResidueStateDatumListener listener=(AminoAcidResidueStateDatumListener)iter.next();
							listener.has__Amino__Acid__StateRemoved(org.cdao.jastor.AminoAcidResidueStateDatumImpl.this,_has__Amino__Acid__State_asGeneric__State);
						}
					}
				}
				return;
