...
/**
 * Interface for MaximumLikelihoodMethod ontology class<br>
 ...
 * <br>
 */
public interface MaximumLikelihoodMethod extends org.cdao.jastor.TreeProcedure, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#MaximumLikelihoodMethod");
