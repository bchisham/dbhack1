...
/**
 * Interface for TreeProcedure ontology class<br>
 ...
 * 	description : Algorithm used to develop the tree <br>
 * <br>
 */
public interface TreeProcedure extends org.cdao.jastor.TreeAnnotation, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://localhost/~vivek/cdao.owl#TreeProcedure");
